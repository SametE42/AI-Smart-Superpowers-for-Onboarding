...
- `validate_repository.py` checks release-readiness invariants for Markdown structure, local links, mirrored AI language files, empty files, README coverage, language README completeness, optional template README coverage, old public repository references, common secret patterns and translation status markers.
