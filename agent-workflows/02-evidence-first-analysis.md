...
3. Inspect tests, scripts and representative source files for behavioral evidence.
4. Record direct evidence with file paths and short rationale.
5. Mark missing facts as `[UNKNOWN]`.
6. Mark inferred claims as `[ASSUMPTION: ...]`.
7. For large repositories, mark incomplete coverage as `[PARTIALLY REVIEWED: ...]`.
