...
4. Do not invent project facts; mark unknowns as `[UNKNOWN]` and assumptions as `[ASSUMPTION]`.
5. Do not document secrets, passwords, tokens, certificates, real user data or other sensitive data.
6. Human review is required before treating AI-generated documentation as reliable.
