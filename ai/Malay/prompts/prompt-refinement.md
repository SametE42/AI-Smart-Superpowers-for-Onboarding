...
> Fail sumber: ai/English/prompts/prompt-refinement.md
> Jika terdapat perbezaan, fail Inggeris menjadi rujukan utama.

Halaman ini menerangkan bagaimana `prompts/prompt-refinement.md` sesuai dalam AI Agent Operating Manual. Ia ditulis untuk manusia dan AI agents yang perlu merancang, mengesahkan atau mengulang kerja repository.
