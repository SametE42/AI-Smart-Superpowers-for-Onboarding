...
> Fail sumber: ai/English/prompts/documentation-update.md
> Jika terdapat perbezaan, fail Inggeris menjadi rujukan utama.

Halaman ini menerangkan bagaimana `prompts/documentation-update.md` sesuai dalam AI Agent Operating Manual. Ia ditulis untuk manusia dan AI agents yang perlu merancang, mengesahkan atau mengulang kerja repository.

## Skop praktikal

Gunakan halaman ini sebagai panduan operasi untuk tema `prompts`. Ia tidak menggantikan bukti repository atau arahan khusus projek.
