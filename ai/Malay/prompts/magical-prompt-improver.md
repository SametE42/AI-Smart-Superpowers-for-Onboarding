...
Halaman ini menerangkan bagaimana `prompts/magical-prompt-improver.md` sesuai dalam AI Agent Operating Manual. Ia ditulis untuk manusia dan AI agents yang perlu merancang, mengesahkan atau mengulang kerja repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Skop praktikal

Gunakan halaman ini sebagai panduan operasi untuk tema `prompt improvement`. Ia tidak menggantikan bukti repository atau arahan khusus projek.
