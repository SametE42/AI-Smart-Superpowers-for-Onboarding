...
> Fail sumber: ai/English/optimization/skill-optimization.md
> Jika terdapat perbezaan, fail Inggeris menjadi rujukan utama.

Halaman ini menerangkan bagaimana `optimization/skill-optimization.md` sesuai dalam AI Agent Operating Manual. Ia ditulis untuk manusia dan AI agents yang perlu merancang, mengesahkan atau mengulang kerja repository.
