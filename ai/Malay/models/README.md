...
> Fail sumber: ai/English/models/README.md
> Jika terdapat perbezaan, fail Inggeris menjadi rujukan utama.

Halaman ini menerangkan bagaimana `models/README.md` sesuai dalam AI Agent Operating Manual. Ia ditulis untuk manusia dan AI agents yang perlu merancang, mengesahkan atau mengulang kerja repository.
