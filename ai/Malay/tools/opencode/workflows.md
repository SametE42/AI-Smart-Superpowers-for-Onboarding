...
> Fail sumber: ai/English/tools/opencode/workflows.md
> Jika terdapat perbezaan, fail Inggeris menjadi rujukan utama.

Halaman ini menerangkan bagaimana `tools/opencode/workflows.md` sesuai dalam AI Agent Operating Manual. Ia ditulis untuk manusia dan AI agents yang perlu merancang, mengesahkan atau mengulang kerja repository.
