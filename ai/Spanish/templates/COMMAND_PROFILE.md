...
> Archivo fuente: ai/English/templates/COMMAND_PROFILE.md
> Si hay diferencias, el archivo en inglés tiene prioridad.

Esta página explica cómo `templates/COMMAND_PROFILE.md` encaja en el AI Agent Operating Manual. Está escrita para personas y agentes de IA que deben planificar, verificar o repetir trabajo de repositorio.
