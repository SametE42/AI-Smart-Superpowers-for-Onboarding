...
> Archivo fuente: ai/English/prompts/documentation-update.md
> Si hay diferencias, el archivo en inglés tiene prioridad.

Esta página explica cómo `prompts/documentation-update.md` encaja en el AI Agent Operating Manual. Está escrita para personas y agentes de IA que deben planificar, verificar o repetir trabajo de repositorio.

## Alcance práctico

Usa esta página como guía operativa para el tema `prompts`. No sustituye la evidencia del repositorio ni las instrucciones propias del proyecto.
