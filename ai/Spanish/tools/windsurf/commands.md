...
> Archivo fuente: ai/English/tools/windsurf/commands.md
> Si hay diferencias, el archivo en inglés tiene prioridad.

Esta página explica cómo `tools/windsurf/commands.md` encaja en el AI Agent Operating Manual. Está escrita para personas y agentes de IA que deben planificar, verificar o repetir trabajo de repositorio.
