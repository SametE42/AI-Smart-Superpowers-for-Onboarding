...
> Archivo fuente: ai/English/models/anthropic/commands.md
> Si hay diferencias, el archivo en inglés tiene prioridad.

Esta página explica cómo `models/anthropic/commands.md` encaja en el AI Agent Operating Manual. Está escrita para personas y agentes de IA que deben planificar, verificar o repetir trabajo de repositorio.
