...
> Archivo fuente: ai/English/examples/claude-code-workflow.md
> Si hay diferencias, el archivo en inglés tiene prioridad.

Esta página explica cómo `examples/claude-code-workflow.md` encaja en el AI Agent Operating Manual. Está escrita para personas y agentes de IA que deben planificar, verificar o repetir trabajo de repositorio.
