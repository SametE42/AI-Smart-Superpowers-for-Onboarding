...
Ova stranica objašnjava kako se `prompts/magical-prompt-improver.md` uklapa u AI Agent Operating Manual. Namenjena je ljudima i AI agentima koji treba da planiraju, provere ili ponove rad u repositoryju. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktični opseg

Koristi ovu stranicu kao operativni vodič za temu `prompt improvement`. Ne zamenjuje dokaze iz repositoryja niti projektne instrukcije.
