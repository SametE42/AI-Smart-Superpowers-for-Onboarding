...
Ova stranica objašnjava kako se `skills/self-evolving-skills.md` uklapa u AI Agent Operating Manual. Namenjena je ljudima i AI agentima koji treba da planiraju, provere ili ponove rad u repositoryju.

## Praktični opseg

Koristi ovu stranicu kao operativni vodič za temu `skills`. Ne zamenjuje dokaze iz repositoryja niti projektne instrukcije.
