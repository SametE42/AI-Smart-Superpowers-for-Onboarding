...
Ova stranica objašnjava kako se `memory/memory-consolidation.md` uklapa u AI Agent Operating Manual. Namenjena je ljudima i AI agentima koji treba da planiraju, provere ili ponove rad u repositoryju.

## Praktični opseg

Koristi ovu stranicu kao operativni vodič za temu `memory`. Ne zamenjuje dokaze iz repositoryja niti projektne instrukcije.
