...
> Izvorna datoteka: ai/English/agents/self-evolving-agents.md
> Ako postoje odstupanja, engleska datoteka ima prednost.

Ova stranica objašnjava kako se `agents/self-evolving-agents.md` uklapa u AI Agent Operating Manual. Namenjena je ljudima i AI agentima koji treba da planiraju, provere ili ponove rad u repositoryju.

## Praktični opseg

Koristi ovu stranicu kao operativni vodič za temu `agents`. Ne zamenjuje dokaze iz repositoryja niti projektne instrukcije.
