...
> উৎস ভাষা: ইংরেজি
> উৎস ফাইল: ai/English/templates/MODEL_PROFILE.md
> পার্থক্য থাকলে ইংরেজি ফাইল প্রাধান্য পাবে।

এই পৃষ্ঠা ব্যাখ্যা করে `templates/MODEL_PROFILE.md` কীভাবে AI Agent Operating Manual-এর মধ্যে ব্যবহৃত হয়। এটি repository কাজ পরিকল্পনা, যাচাই বা পুনরাবৃত্তি করতে হয় এমন মানুষ ও AI agents-এর জন্য লেখা।
