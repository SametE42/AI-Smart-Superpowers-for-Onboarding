...
> উৎস ভাষা: ইংরেজি
> উৎস ফাইল: ai/English/evals/evaluation-overview.md
> পার্থক্য থাকলে ইংরেজি ফাইল প্রাধান্য পাবে।

এই পৃষ্ঠা ব্যাখ্যা করে `evals/evaluation-overview.md` কীভাবে AI Agent Operating Manual-এর মধ্যে ব্যবহৃত হয়। এটি repository কাজ পরিকল্পনা, যাচাই বা পুনরাবৃত্তি করতে হয় এমন মানুষ ও AI agents-এর জন্য লেখা।

## ব্যবহারিক পরিসর

এই পৃষ্ঠাকে `evals` বিষয়ের কার্যকরী নির্দেশিকা হিসেবে ব্যবহার করুন। এটি repository প্রমাণ বা প্রকল্প-নির্দিষ্ট নির্দেশের বিকল্প নয়।
