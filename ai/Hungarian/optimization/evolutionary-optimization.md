...
> Forrásnyelv: angol
> Forrásfájl: ai/English/optimization/evolutionary-optimization.md
> Eltérés esetén az angol fájl az irányadó.

Ez az oldal elmagyarázza, hogyan illeszkedik a `optimization/evolutionary-optimization.md` az AI Agent Operating Manual rendszerébe. Olyan embereknek és AI-ügynököknek készült, akik repository-munkát terveznek, ellenőriznek vagy ismételnek.

## Gyakorlati hatókör

Használd ezt az oldalt operatív útmutatóként a `optimization` témához. Nem helyettesíti a repository-bizonyítékokat vagy a projekt saját utasításait.
