...
> Forrásnyelv: angol
> Forrásfájl: ai/English/commands/model-specific-notes.md
> Eltérés esetén az angol fájl az irányadó.

Ez az oldal elmagyarázza, hogyan illeszkedik a `commands/model-specific-notes.md` az AI Agent Operating Manual rendszerébe. Olyan embereknek és AI-ügynököknek készült, akik repository-munkát terveznek, ellenőriznek vagy ismételnek.

## Gyakorlati hatókör

Használd ezt az oldalt operatív útmutatóként a `commands` témához. Nem helyettesíti a repository-bizonyítékokat vagy a projekt saját utasításait.
