...
> Forrásnyelv: angol
> Forrásfájl: ai/English/templates/COMMAND_PROFILE.md
> Eltérés esetén az angol fájl az irányadó.

Ez az oldal elmagyarázza, hogyan illeszkedik a `templates/COMMAND_PROFILE.md` az AI Agent Operating Manual rendszerébe. Olyan embereknek és AI-ügynököknek készült, akik repository-munkát terveznek, ellenőriznek vagy ismételnek.
