...
> Forrásnyelv: angol
> Forrásfájl: ai/English/models/anthropic/config.md
> Eltérés esetén az angol fájl az irányadó.

Ez az oldal elmagyarázza, hogyan illeszkedik a `models/anthropic/config.md` az AI Agent Operating Manual rendszerébe. Olyan embereknek és AI-ügynököknek készült, akik repository-munkát terveznek, ellenőriznek vagy ismételnek.
