...
> Forrásnyelv: angol
> Forrásfájl: ai/English/prompts/magical-prompt-improver.md
> Eltérés esetén az angol fájl az irányadó.

Ez az oldal elmagyarázza, hogyan illeszkedik a `prompts/magical-prompt-improver.md` az AI Agent Operating Manual rendszerébe. Olyan embereknek és AI-ügynököknek készült, akik repository-munkát terveznek, ellenőriznek vagy ismételnek. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Gyakorlati hatókör

Használd ezt az oldalt operatív útmutatóként a `prompt improvement` témához. Nem helyettesíti a repository-bizonyítékokat vagy a projekt saját utasításait.
