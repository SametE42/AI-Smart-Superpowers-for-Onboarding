...
> Mənbə fayl: ai/English/examples/gepa-optimization-example.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `examples/gepa-optimization-example.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `examples` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
