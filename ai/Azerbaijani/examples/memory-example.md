...
> Mənbə fayl: ai/English/examples/memory-example.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `examples/memory-example.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
