...
> Mənbə fayl: ai/English/examples/skill-example.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `examples/skill-example.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
