...
> Mənbə fayl: ai/English/prompts/magical-prompt-improver.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `prompts/magical-prompt-improver.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktiki əhatə

Bu səhifəni `prompt improvement` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
