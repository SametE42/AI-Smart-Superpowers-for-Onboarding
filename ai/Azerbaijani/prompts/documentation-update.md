...
> Mənbə fayl: ai/English/prompts/documentation-update.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `prompts/documentation-update.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `prompts` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
