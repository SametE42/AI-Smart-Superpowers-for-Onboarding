...
> Mənbə fayl: ai/English/prompts/master-prompt.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `prompts/master-prompt.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
