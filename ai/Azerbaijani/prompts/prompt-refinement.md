...
> Mənbə fayl: ai/English/prompts/prompt-refinement.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `prompts/prompt-refinement.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
