...
> Mənbə fayl: ai/English/prompts/prompt-structure.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `prompts/prompt-structure.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
