...
> Mənbə fayl: ai/English/memory/hot-memory.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `memory/hot-memory.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
