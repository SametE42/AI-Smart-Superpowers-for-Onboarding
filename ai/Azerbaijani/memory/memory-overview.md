...
> Mənbə fayl: ai/English/memory/memory-overview.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `memory/memory-overview.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
