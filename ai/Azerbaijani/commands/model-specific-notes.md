...
> Mənbə fayl: ai/English/commands/model-specific-notes.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `commands/model-specific-notes.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `commands` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
