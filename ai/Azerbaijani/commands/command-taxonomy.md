...
> Mənbə fayl: ai/English/commands/command-taxonomy.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `commands/command-taxonomy.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
