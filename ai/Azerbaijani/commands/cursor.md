...
> Mənbə fayl: ai/English/commands/cursor.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `commands/cursor.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
