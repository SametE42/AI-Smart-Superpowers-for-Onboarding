...
> Mənbə fayl: ai/English/commands/gemini-cli.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `commands/gemini-cli.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
