...
> Mənbə fayl: ai/English/templates/MODEL_PROFILE.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `templates/MODEL_PROFILE.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
