...
> Mənbə fayl: ai/English/templates/WORKFLOW_TEMPLATE.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `templates/WORKFLOW_TEMPLATE.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `templates` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
