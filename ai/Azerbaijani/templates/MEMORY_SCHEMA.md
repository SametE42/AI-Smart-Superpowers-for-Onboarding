...
> Mənbə fayl: ai/English/templates/MEMORY_SCHEMA.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `templates/MEMORY_SCHEMA.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
