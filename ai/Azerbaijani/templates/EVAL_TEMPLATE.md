...
> Mənbə fayl: ai/English/templates/EVAL_TEMPLATE.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `templates/EVAL_TEMPLATE.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
