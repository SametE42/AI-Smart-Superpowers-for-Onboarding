...
> Mənbə fayl: ai/English/templates/OPTIMIZATION_RUN.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `templates/OPTIMIZATION_RUN.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
