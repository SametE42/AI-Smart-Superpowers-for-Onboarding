...
> Mənbə fayl: ai/English/providers/anthropic.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `providers/anthropic.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
