...
> Mənbə fayl: ai/English/providers/moonshot-kimi.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `providers/moonshot-kimi.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `providers` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
