...
> Mənbə fayl: ai/English/agents/tool-using-agents.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `agents/tool-using-agents.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
