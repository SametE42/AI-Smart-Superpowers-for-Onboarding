...
> Mənbə fayl: ai/English/agents/human-in-the-loop.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `agents/human-in-the-loop.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
