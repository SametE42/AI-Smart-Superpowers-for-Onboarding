...
> Mənbə fayl: ai/English/agents/autonomous-agents.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `agents/autonomous-agents.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
