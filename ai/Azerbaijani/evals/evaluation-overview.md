...
> Mənbə fayl: ai/English/evals/evaluation-overview.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `evals/evaluation-overview.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `evals` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
