...
> Mənbə fayl: ai/English/models/perplexity/evals.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `models/perplexity/evals.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
