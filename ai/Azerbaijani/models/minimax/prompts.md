...
> Mənbə fayl: ai/English/models/minimax/prompts.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `models/minimax/prompts.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
