...
> Mənbə fayl: ai/English/models/minimax/config.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `models/minimax/config.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
