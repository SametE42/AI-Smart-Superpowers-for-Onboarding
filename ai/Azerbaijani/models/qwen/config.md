...
> Mənbə fayl: ai/English/models/qwen/config.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `models/qwen/config.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
