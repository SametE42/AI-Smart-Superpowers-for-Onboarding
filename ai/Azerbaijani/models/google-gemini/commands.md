...
> Mənbə fayl: ai/English/models/google-gemini/commands.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `models/google-gemini/commands.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `models` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
