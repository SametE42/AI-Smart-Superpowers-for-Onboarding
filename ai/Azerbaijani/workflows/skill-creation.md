...
> Mənbə fayl: ai/English/workflows/skill-creation.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `workflows/skill-creation.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
