...
> Mənbə fayl: ai/English/workflows/model-comparison.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `workflows/model-comparison.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
