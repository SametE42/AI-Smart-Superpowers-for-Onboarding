...
> Mənbə fayl: ai/English/workflows/code-review.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `workflows/code-review.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
