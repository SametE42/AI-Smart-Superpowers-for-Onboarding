...
> Mənbə fayl: ai/English/workflows/documentation-audit.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `workflows/documentation-audit.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `workflows` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
