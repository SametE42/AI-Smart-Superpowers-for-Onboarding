...
> Mənbə fayl: ai/English/workflows/agent-optimization.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `workflows/agent-optimization.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
