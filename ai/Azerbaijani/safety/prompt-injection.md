...
> Mənbə fayl: ai/English/safety/prompt-injection.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `safety/prompt-injection.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `safety` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
