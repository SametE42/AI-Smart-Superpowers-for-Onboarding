...
> Mənbə fayl: ai/English/safety/tool-permissions.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `safety/tool-permissions.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
