...
> Mənbə fayl: ai/English/skills/self-evolving-skills.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `skills/self-evolving-skills.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `skills` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
