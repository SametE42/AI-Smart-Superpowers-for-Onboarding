...
> Mənbə fayl: ai/English/skills/skill-versioning.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `skills/skill-versioning.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
