...
> Mənbə fayl: ai/English/skills/skill-design.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `skills/skill-design.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
