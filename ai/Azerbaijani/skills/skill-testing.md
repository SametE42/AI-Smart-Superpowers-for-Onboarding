...
> Mənbə fayl: ai/English/skills/skill-testing.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `skills/skill-testing.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
