...
> Mənbə fayl: ai/English/tools/opencode/workflows.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `tools/opencode/workflows.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
