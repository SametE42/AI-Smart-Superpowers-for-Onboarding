...
> Mənbə fayl: ai/English/tools/claude-code/context-files.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `tools/claude-code/context-files.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `tools` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
