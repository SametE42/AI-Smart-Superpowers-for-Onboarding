...
> Mənbə fayl: ai/English/tools/aider/context-files.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `tools/aider/context-files.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
