...
> Mənbə fayl: ai/English/tools/windsurf/commands.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `tools/windsurf/commands.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
