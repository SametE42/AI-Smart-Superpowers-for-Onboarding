...
> Mənbə fayl: ai/English/optimization/evolutionary-optimization.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `optimization/evolutionary-optimization.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.

## Praktiki əhatə

Bu səhifəni `optimization` mövzusu üçün əməliyyat bələdçisi kimi istifadə et. Repository sübutlarını və layihə təlimatlarını əvəz etmir.
