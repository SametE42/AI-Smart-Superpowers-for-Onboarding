...
> Mənbə fayl: ai/English/optimization/rollout-evaluation.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `optimization/rollout-evaluation.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
