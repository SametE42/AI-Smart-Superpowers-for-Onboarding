...
> Mənbə fayl: ai/English/optimization/skill-optimization.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `optimization/skill-optimization.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
