...
> Mənbə fayl: ai/English/optimization/pareto-selection.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `optimization/pareto-selection.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
