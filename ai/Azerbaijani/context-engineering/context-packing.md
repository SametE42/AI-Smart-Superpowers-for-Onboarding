...
> Mənbə fayl: ai/English/context-engineering/context-packing.md
> Fərq olduqda İngilis faylı əsas götürülür.

Bu səhifə `context-engineering/context-packing.md` faylının AI Agent Operating Manual daxilində necə işlədiyini izah edir; repository işini planlayan, yoxlayan və ya təkrarlayan insanlar və AI agents üçündür.
