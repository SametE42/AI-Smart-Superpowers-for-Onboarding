...
> Plik źródłowy: ai/English/context-engineering/context-engineering-overview.md
> W przypadku rozbieżności plik angielski pozostaje źródłem rozstrzygającym.

Ta strona wyjaśnia, jak `context-engineering/context-engineering-overview.md` pasuje do AI Agent Operating Manual. Jest przeznaczona dla ludzi i agentów AI, którzy muszą planować, weryfikować lub powtarzać pracę w repozytorium.

## Zakres praktyczny

Używaj tej strony jako operacyjnej wskazówki dla tematu `context-engineering`. Nie zastępuje ona dowodów z repozytorium ani instrukcji specyficznych dla projektu.
