...
> Plik źródłowy: ai/English/prompts/magical-prompt-improver.md
> W przypadku rozbieżności plik angielski pozostaje źródłem rozstrzygającym.

Ta strona wyjaśnia, jak `prompts/magical-prompt-improver.md` pasuje do AI Agent Operating Manual. Jest przeznaczona dla ludzi i agentów AI, którzy muszą planować, weryfikować lub powtarzać pracę w repozytorium. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Zakres praktyczny

Używaj tej strony jako operacyjnej wskazówki dla tematu `prompt improvement`. Nie zastępuje ona dowodów z repozytorium ani instrukcji specyficznych dla projektu.
