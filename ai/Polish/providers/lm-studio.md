...
> Plik źródłowy: ai/English/providers/lm-studio.md
> W przypadku rozbieżności plik angielski pozostaje źródłem rozstrzygającym.

Ta strona wyjaśnia, jak `providers/lm-studio.md` pasuje do AI Agent Operating Manual. Jest przeznaczona dla ludzi i agentów AI, którzy muszą planować, weryfikować lub powtarzać pracę w repozytorium.
