...
> Plik źródłowy: ai/English/agents/researcher-writer-reviewer.md
> W przypadku rozbieżności plik angielski pozostaje źródłem rozstrzygającym.

Ta strona wyjaśnia, jak `agents/researcher-writer-reviewer.md` pasuje do AI Agent Operating Manual. Jest przeznaczona dla ludzi i agentów AI, którzy muszą planować, weryfikować lub powtarzać pracę w repozytorium.

## Zakres praktyczny

Używaj tej strony jako operacyjnej wskazówki dla tematu `agents`. Nie zastępuje ona dowodów z repozytorium ani instrukcji specyficznych dla projektu.
