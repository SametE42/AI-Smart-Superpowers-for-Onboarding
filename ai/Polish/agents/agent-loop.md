...
> Plik źródłowy: ai/English/agents/agent-loop.md
> W przypadku rozbieżności plik angielski pozostaje źródłem rozstrzygającym.

Ta strona wyjaśnia, jak `agents/agent-loop.md` pasuje do AI Agent Operating Manual. Jest przeznaczona dla ludzi i agentów AI, którzy muszą planować, weryfikować lub powtarzać pracę w repozytorium.
