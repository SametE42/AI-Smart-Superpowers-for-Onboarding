...
> Աղբյուր ֆայլ: ai/English/providers/ollama.md
> Տարբերությունների դեպքում առաջնային է անգլերեն ֆայլը։

Այս էջը բացատրում է, թե ինչպես է `providers/ollama.md`-ը տեղավորվում AI Agent Operating Manual-ում՝ մարդկանց և AI agents-ի համար, որոնք պլանավորում, ստուգում կամ կրկնում են repository աշխատանքը։
