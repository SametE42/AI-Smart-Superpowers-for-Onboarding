...
> Աղբյուր ֆայլ: ai/English/providers/moonshot-kimi.md
> Տարբերությունների դեպքում առաջնային է անգլերեն ֆայլը։

Այս էջը բացատրում է, թե ինչպես է `providers/moonshot-kimi.md`-ը տեղավորվում AI Agent Operating Manual-ում՝ մարդկանց և AI agents-ի համար, որոնք պլանավորում, ստուգում կամ կրկնում են repository աշխատանքը։

## Գործնական շրջանակ

Օգտագործեք այս էջը որպես `providers` թեմայի գործառնական ուղեցույց։ Այն չի փոխարինում repository ապացույցներին կամ նախագծի հրահանգներին։
