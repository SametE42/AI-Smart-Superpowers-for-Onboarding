...
> Աղբյուր ֆայլ: ai/English/optimization/dspy.md
> Տարբերությունների դեպքում առաջնային է անգլերեն ֆայլը։

Այս էջը բացատրում է, թե ինչպես է `optimization/dspy.md`-ը տեղավորվում AI Agent Operating Manual-ում՝ մարդկանց և AI agents-ի համար, որոնք պլանավորում, ստուգում կամ կրկնում են repository աշխատանքը։
