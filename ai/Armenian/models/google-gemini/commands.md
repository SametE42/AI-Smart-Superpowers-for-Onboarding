...
> Աղբյուր ֆայլ: ai/English/models/google-gemini/commands.md
> Տարբերությունների դեպքում առաջնային է անգլերեն ֆայլը։

Այս էջը բացատրում է, թե ինչպես է `models/google-gemini/commands.md`-ը տեղավորվում AI Agent Operating Manual-ում՝ մարդկանց և AI agents-ի համար, որոնք պլանավորում, ստուգում կամ կրկնում են repository աշխատանքը։

## Գործնական շրջանակ

Օգտագործեք այս էջը որպես `models` թեմայի գործառնական ուղեցույց։ Այն չի փոխարինում repository ապացույցներին կամ նախագծի հրահանգներին։
