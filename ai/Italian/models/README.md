...
> File sorgente: ai/English/models/README.md
> In caso di divergenze, il file inglese resta la fonte autorevole.

Questa pagina spiega come `models/README.md` si inserisce nell'AI Agent Operating Manual. È pensata per persone e agenti IA che devono pianificare, verificare o ripetere il lavoro sul repository.
