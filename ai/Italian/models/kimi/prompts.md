...
> File sorgente: ai/English/models/kimi/prompts.md
> In caso di divergenze, il file inglese resta la fonte autorevole.

Questa pagina spiega come `models/kimi/prompts.md` si inserisce nell'AI Agent Operating Manual. È pensata per persone e agenti IA che devono pianificare, verificare o ripetere il lavoro sul repository.
