...
> File sorgente: ai/English/tools/continue/context-files.md
> In caso di divergenze, il file inglese resta la fonte autorevole.

Questa pagina spiega come `tools/continue/context-files.md` si inserisce nell'AI Agent Operating Manual. È pensata per persone e agenti IA che devono pianificare, verificare o ripetere il lavoro sul repository.
