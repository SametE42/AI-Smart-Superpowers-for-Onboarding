...
> File sorgente: ai/English/providers/moonshot-kimi.md
> In caso di divergenze, il file inglese resta la fonte autorevole.

Questa pagina spiega come `providers/moonshot-kimi.md` si inserisce nell'AI Agent Operating Manual. È pensata per persone e agenti IA che devono pianificare, verificare o ripetere il lavoro sul repository.

## Ambito pratico

Usa questa pagina come riferimento operativo per il tema `providers`. Non sostituisce le prove del repository né le istruzioni specifiche del progetto.
