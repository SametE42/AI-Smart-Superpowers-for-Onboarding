...
> Lähtekeel: inglise
> Lähtefail: ai/English/optimization/evolutionary-optimization.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `optimization/evolutionary-optimization.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `optimization` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
