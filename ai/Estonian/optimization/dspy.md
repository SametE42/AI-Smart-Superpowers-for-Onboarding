...
> Lähtekeel: inglise
> Lähtefail: ai/English/optimization/dspy.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `optimization/dspy.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
