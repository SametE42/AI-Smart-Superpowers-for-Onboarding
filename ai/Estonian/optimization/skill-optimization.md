...
> Lähtekeel: inglise
> Lähtefail: ai/English/optimization/skill-optimization.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `optimization/skill-optimization.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
