...
> Lähtekeel: inglise
> Lähtefail: ai/English/optimization/pareto-selection.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `optimization/pareto-selection.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
