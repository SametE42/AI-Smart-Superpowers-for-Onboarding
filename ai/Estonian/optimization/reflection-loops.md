...
> Lähtekeel: inglise
> Lähtefail: ai/English/optimization/reflection-loops.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `optimization/reflection-loops.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
