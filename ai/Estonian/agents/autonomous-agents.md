...
> Lähtekeel: inglise
> Lähtefail: ai/English/agents/autonomous-agents.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `agents/autonomous-agents.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
