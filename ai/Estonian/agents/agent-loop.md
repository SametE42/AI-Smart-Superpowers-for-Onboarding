...
> Lähtekeel: inglise
> Lähtefail: ai/English/agents/agent-loop.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `agents/agent-loop.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
