...
> Lähtekeel: inglise
> Lähtefail: ai/English/agents/tool-using-agents.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `agents/tool-using-agents.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
