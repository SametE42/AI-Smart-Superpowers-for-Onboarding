...
> Lähtekeel: inglise
> Lähtefail: ai/English/agents/researcher-writer-reviewer.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `agents/researcher-writer-reviewer.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `agents` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
