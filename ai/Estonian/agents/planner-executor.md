...
> Lähtekeel: inglise
> Lähtefail: ai/English/agents/planner-executor.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `agents/planner-executor.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
