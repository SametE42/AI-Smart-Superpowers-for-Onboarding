...
> Lähtekeel: inglise
> Lähtefail: ai/English/memory/procedural-memory.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `memory/procedural-memory.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
