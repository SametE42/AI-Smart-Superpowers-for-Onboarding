...
> Lähtekeel: inglise
> Lähtefail: ai/English/memory/memory-overview.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `memory/memory-overview.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
