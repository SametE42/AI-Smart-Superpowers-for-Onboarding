...
> Lähtekeel: inglise
> Lähtefail: ai/English/memory/memory-consolidation.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `memory/memory-consolidation.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `memory` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
