...
> Lähtekeel: inglise
> Lähtefail: ai/English/providers/moonshot-kimi.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `providers/moonshot-kimi.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `providers` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
