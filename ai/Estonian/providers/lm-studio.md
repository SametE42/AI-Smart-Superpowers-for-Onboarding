...
> Lähtekeel: inglise
> Lähtefail: ai/English/providers/lm-studio.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `providers/lm-studio.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
