...
> Lähtekeel: inglise
> Lähtefail: ai/English/commands/custom-commands.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `commands/custom-commands.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
