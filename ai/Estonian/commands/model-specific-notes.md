...
> Lähtekeel: inglise
> Lähtefail: ai/English/commands/model-specific-notes.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `commands/model-specific-notes.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `commands` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
