...
> Lähtekeel: inglise
> Lähtefail: ai/English/models/openai/README.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `models/openai/README.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
