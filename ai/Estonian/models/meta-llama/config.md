...
> Lähtekeel: inglise
> Lähtefail: ai/English/models/meta-llama/config.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `models/meta-llama/config.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
