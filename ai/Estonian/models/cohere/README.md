...
> Lähtekeel: inglise
> Lähtefail: ai/English/models/cohere/README.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `models/cohere/README.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
