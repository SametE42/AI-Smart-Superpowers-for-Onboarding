...
> Lähtekeel: inglise
> Lähtefail: ai/English/models/google-gemini/prompts.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `models/google-gemini/prompts.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
