...
> Lähtekeel: inglise
> Lähtefail: ai/English/examples/skill-example.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `examples/skill-example.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
