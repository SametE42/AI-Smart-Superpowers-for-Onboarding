...
> Lähtekeel: inglise
> Lähtefail: ai/English/examples/gepa-optimization-example.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `examples/gepa-optimization-example.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `examples` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
