...
> Lähtekeel: inglise
> Lähtefail: ai/English/examples/claude-code-workflow.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `examples/claude-code-workflow.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
