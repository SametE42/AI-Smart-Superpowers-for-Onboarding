...
> Lähtekeel: inglise
> Lähtefail: ai/English/templates/MEMORY_SCHEMA.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `templates/MEMORY_SCHEMA.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
