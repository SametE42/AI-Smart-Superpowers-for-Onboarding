...
> Lähtekeel: inglise
> Lähtefail: ai/English/templates/WORKFLOW_TEMPLATE.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `templates/WORKFLOW_TEMPLATE.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `templates` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
