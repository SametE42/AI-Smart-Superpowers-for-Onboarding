...
> Lähtekeel: inglise
> Lähtefail: ai/English/templates/MODEL_PROFILE.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `templates/MODEL_PROFILE.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
