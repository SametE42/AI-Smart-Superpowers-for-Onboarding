...
> Lähtekeel: inglise
> Lähtefail: ai/English/prompts/master-prompt.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `prompts/master-prompt.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
