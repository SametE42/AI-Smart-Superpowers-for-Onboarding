...
> Lähtekeel: inglise
> Lähtefail: ai/English/prompts/magical-prompt-improver.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `prompts/magical-prompt-improver.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `prompt improvement` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
