...
> Lähtekeel: inglise
> Lähtefail: ai/English/prompts/security-review.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `prompts/security-review.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
