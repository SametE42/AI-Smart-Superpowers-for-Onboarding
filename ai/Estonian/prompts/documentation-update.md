...
> Lähtekeel: inglise
> Lähtefail: ai/English/prompts/documentation-update.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `prompts/documentation-update.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `prompts` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
