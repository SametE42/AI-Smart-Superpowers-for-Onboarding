...
> Lähtekeel: inglise
> Lähtefail: ai/English/prompts/accuracy-clause.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `prompts/accuracy-clause.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
