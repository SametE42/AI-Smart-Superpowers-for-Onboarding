...
> Lähtekeel: inglise
> Lähtefail: ai/English/safety/eval-safety.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `safety/eval-safety.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
