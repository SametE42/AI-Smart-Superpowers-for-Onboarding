...
> Lähtekeel: inglise
> Lähtefail: ai/English/safety/prompt-injection.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `safety/prompt-injection.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `safety` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
