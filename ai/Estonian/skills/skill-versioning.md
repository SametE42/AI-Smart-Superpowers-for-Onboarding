...
> Lähtekeel: inglise
> Lähtefail: ai/English/skills/skill-versioning.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `skills/skill-versioning.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
