...
> Lähtekeel: inglise
> Lähtefail: ai/English/skills/self-evolving-skills.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `skills/self-evolving-skills.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `skills` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
