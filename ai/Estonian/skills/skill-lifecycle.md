...
> Lähtekeel: inglise
> Lähtefail: ai/English/skills/skill-lifecycle.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `skills/skill-lifecycle.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
