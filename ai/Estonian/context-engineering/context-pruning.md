...
> Lähtekeel: inglise
> Lähtefail: ai/English/context-engineering/context-pruning.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `context-engineering/context-pruning.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
