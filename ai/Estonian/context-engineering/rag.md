...
> Lähtekeel: inglise
> Lähtefail: ai/English/context-engineering/rag.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `context-engineering/rag.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
