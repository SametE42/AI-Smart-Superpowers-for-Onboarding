...
> Lähtekeel: inglise
> Lähtefail: ai/English/context-engineering/context-engineering-overview.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `context-engineering/context-engineering-overview.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `context-engineering` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
