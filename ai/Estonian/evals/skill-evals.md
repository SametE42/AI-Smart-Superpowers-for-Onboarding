...
> Lähtekeel: inglise
> Lähtefail: ai/English/evals/skill-evals.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `evals/skill-evals.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
