...
> Lähtekeel: inglise
> Lähtefail: ai/English/evals/evaluation-overview.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `evals/evaluation-overview.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `evals` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
