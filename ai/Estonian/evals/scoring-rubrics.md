...
> Lähtekeel: inglise
> Lähtefail: ai/English/evals/scoring-rubrics.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `evals/scoring-rubrics.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
