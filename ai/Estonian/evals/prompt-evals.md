...
> Lähtekeel: inglise
> Lähtefail: ai/English/evals/prompt-evals.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `evals/prompt-evals.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
