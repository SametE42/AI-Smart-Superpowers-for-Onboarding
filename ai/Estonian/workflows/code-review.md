...
> Lähtekeel: inglise
> Lähtefail: ai/English/workflows/code-review.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `workflows/code-review.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
