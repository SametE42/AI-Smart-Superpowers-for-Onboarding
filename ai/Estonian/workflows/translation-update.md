...
> Lähtekeel: inglise
> Lähtefail: ai/English/workflows/translation-update.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `workflows/translation-update.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
