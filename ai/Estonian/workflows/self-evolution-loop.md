...
> Lähtekeel: inglise
> Lähtefail: ai/English/workflows/self-evolution-loop.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `workflows/self-evolution-loop.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `workflows` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
