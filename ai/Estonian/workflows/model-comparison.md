...
> Lähtekeel: inglise
> Lähtefail: ai/English/workflows/model-comparison.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `workflows/model-comparison.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
