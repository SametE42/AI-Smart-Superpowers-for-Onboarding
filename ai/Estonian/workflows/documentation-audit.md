...
> Lähtekeel: inglise
> Lähtefail: ai/English/workflows/documentation-audit.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `workflows/documentation-audit.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
