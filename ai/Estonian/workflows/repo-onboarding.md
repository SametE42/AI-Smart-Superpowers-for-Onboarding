...
> Lähtekeel: inglise
> Lähtefail: ai/English/workflows/repo-onboarding.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `workflows/repo-onboarding.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
