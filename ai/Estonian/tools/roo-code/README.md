...
> Lähtekeel: inglise
> Lähtefail: ai/English/tools/roo-code/README.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `tools/roo-code/README.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
