...
> Lähtekeel: inglise
> Lähtefail: ai/English/tools/claude-code/context-files.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `tools/claude-code/context-files.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.

## Praktiline ulatus

Kasuta seda lehte operatiivse juhisena teema `tools` jaoks. See ei asenda repository tõendeid ega projekti erijuhiseid.
