...
> Lähtekeel: inglise
> Lähtefail: ai/English/tools/claude-code/commands.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `tools/claude-code/commands.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
