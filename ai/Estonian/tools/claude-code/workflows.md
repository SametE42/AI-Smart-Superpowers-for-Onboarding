...
> Lähtekeel: inglise
> Lähtefail: ai/English/tools/claude-code/workflows.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `tools/claude-code/workflows.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
