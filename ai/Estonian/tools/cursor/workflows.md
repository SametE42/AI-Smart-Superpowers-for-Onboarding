...
> Lähtekeel: inglise
> Lähtefail: ai/English/tools/cursor/workflows.md
> Erinevuste korral on määrav ingliskeelne fail.

See leht selgitab, kuidas `tools/cursor/workflows.md` sobitub AI Agent Operating Manualiga. See on mõeldud inimestele ja AI-agentidele, kes peavad repository tööd planeerima, kontrollima või kordama.
