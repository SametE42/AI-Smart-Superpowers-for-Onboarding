...
> שפת מקור: אנגלית
> קובץ מקור: ai/English/optimization/evolutionary-optimization.md
> במקרה של סתירה, הקובץ באנגלית הוא הקובע.

דף זה מסביר כיצד `optimization/evolutionary-optimization.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository.

## היקף מעשי

השתמש בדף זה כהנחיה תפעולית לנושא `optimization`. הוא אינו מחליף ראיות מה-repository או הוראות ייחודיות לפרויקט.
