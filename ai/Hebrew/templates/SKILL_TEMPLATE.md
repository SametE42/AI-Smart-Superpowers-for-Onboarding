...
> שפת מקור: אנגלית
> קובץ מקור: ai/English/templates/SKILL_TEMPLATE.md
> במקרה של סתירה, הקובץ באנגלית הוא הקובע.

דף זה מסביר כיצד `templates/SKILL_TEMPLATE.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository.
