...
> שפת מקור: אנגלית
> קובץ מקור: ai/English/templates/WORKFLOW_TEMPLATE.md
> במקרה של סתירה, הקובץ באנגלית הוא הקובע.

דף זה מסביר כיצד `templates/WORKFLOW_TEMPLATE.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository.

## היקף מעשי

השתמש בדף זה כהנחיה תפעולית לנושא `templates`. הוא אינו מחליף ראיות מה-repository או הוראות ייחודיות לפרויקט.
