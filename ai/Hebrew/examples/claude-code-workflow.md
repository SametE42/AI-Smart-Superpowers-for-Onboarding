...
> שפת מקור: אנגלית
> קובץ מקור: ai/English/examples/claude-code-workflow.md
> במקרה של סתירה, הקובץ באנגלית הוא הקובע.

דף זה מסביר כיצד `examples/claude-code-workflow.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository.
