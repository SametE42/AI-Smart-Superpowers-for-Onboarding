...
דף זה מסביר כיצד `README.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository. This language folder contains the localized AI Agent Operating Manual and mirrors the English folder structure for onboarding, review, prompts, safety, tools, models and templates.

## English source of truth

במקרה של סתירה, הקובץ באנגלית הוא הקובע. The English source [`ai/English/README.md`](../English/README.md) remains authoritative, and localized files mirror the English structure.

## How to use this folder

השתמש בדף זה כהנחיה תפעולית לנושא `language folder`. הוא אינו מחליף ראיות מה-repository או הוראות ייחודיות לפרויקט. Use this folder to load the language-specific entrypoint before reading safety guidance, agent patterns, context engineering notes, prompt templates, tool guidance and reusable templates.
