...
> שפת מקור: אנגלית
> קובץ מקור: ai/English/agents/researcher-writer-reviewer.md
> במקרה של סתירה, הקובץ באנגלית הוא הקובע.

דף זה מסביר כיצד `agents/researcher-writer-reviewer.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository.
