...
> שפת מקור: אנגלית
> קובץ מקור: ai/English/memory/memory-consolidation.md
> במקרה של סתירה, הקובץ באנגלית הוא הקובע.

דף זה מסביר כיצד `memory/memory-consolidation.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository.

## היקף מעשי

השתמש בדף זה כהנחיה תפעולית לנושא `memory`. הוא אינו מחליף ראיות מה-repository או הוראות ייחודיות לפרויקט.
