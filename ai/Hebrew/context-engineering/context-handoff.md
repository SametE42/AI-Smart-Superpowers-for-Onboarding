...
> שפת מקור: אנגלית
> קובץ מקור: ai/English/context-engineering/context-handoff.md
> במקרה של סתירה, הקובץ באנגלית הוא הקובע.

דף זה מסביר כיצד `context-engineering/context-handoff.md` משתלב ב-AI Agent Operating Manual. הוא מיועד לאנשים ול-AI agents שצריכים לתכנן, לאמת או לחזור על עבודה ב-repository.
