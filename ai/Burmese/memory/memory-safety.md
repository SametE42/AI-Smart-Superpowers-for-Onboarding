...
> မူရင်းဖိုင်: ai/English/memory/memory-safety.md
> ကွာခြားချက်ရှိပါက အင်္ဂလိပ်ဖိုင်ကို အဓိကယူပါ။

ဤစာမျက်နှာသည် `memory/memory-safety.md` သည် AI Agent Operating Manual ထဲတွင် မည်သို့အသုံးဝင်သည်ကို ရှင်းပြသည်။ repository အလုပ်ကို စီစဉ်၊ စစ်ဆေး သို့မဟုတ် ထပ်လုပ်ရန် လိုအပ်သော လူများနှင့် AI agents အတွက်ဖြစ်သည်။
