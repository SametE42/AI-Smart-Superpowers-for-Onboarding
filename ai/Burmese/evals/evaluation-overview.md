...
> မူရင်းဖိုင်: ai/English/evals/evaluation-overview.md
> ကွာခြားချက်ရှိပါက အင်္ဂလိပ်ဖိုင်ကို အဓိကယူပါ။

ဤစာမျက်နှာသည် `evals/evaluation-overview.md` သည် AI Agent Operating Manual ထဲတွင် မည်သို့အသုံးဝင်သည်ကို ရှင်းပြသည်။ repository အလုပ်ကို စီစဉ်၊ စစ်ဆေး သို့မဟုတ် ထပ်လုပ်ရန် လိုအပ်သော လူများနှင့် AI agents အတွက်ဖြစ်သည်။

## လက်တွေ့အသုံးချ အတိုင်းအတာ

ဤစာမျက်နှာကို `evals` အတွက် လုပ်ငန်းလမ်းညွှန်အဖြစ် အသုံးပြုပါ။ repository အထောက်အထား သို့မဟုတ် project-specific instructions ကို မအစားထိုးပါ။
