...
> Šaltinio failas: ai/English/prompts/magical-prompt-improver.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `prompts/magical-prompt-improver.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `prompt improvement`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
