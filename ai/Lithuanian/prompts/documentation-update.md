...
> Šaltinio failas: ai/English/prompts/documentation-update.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `prompts/documentation-update.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `prompts`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
