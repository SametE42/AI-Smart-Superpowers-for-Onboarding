...
> Šaltinio failas: ai/English/skills/self-evolving-skills.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `skills/self-evolving-skills.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `skills`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
