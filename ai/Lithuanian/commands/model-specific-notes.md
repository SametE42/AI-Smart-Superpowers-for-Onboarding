...
> Šaltinio failas: ai/English/commands/model-specific-notes.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `commands/model-specific-notes.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `commands`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
