...
> Šaltinio failas: ai/English/examples/gepa-optimization-example.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `examples/gepa-optimization-example.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `examples`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
