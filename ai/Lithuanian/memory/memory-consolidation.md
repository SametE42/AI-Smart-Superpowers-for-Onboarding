...
> Šaltinio failas: ai/English/memory/memory-consolidation.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `memory/memory-consolidation.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `memory`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
