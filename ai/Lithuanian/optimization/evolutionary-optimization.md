...
> Šaltinio failas: ai/English/optimization/evolutionary-optimization.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `optimization/evolutionary-optimization.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `optimization`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
