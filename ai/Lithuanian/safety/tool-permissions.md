...
> Šaltinio failas: ai/English/safety/tool-permissions.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `safety/tool-permissions.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `safety`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
