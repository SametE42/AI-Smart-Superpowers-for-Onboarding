...
> Šaltinio failas: ai/English/workflows/documentation-audit.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `workflows/documentation-audit.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `workflows`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
