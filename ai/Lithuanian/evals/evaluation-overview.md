...
> Šaltinio failas: ai/English/evals/evaluation-overview.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `evals/evaluation-overview.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `evals`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
