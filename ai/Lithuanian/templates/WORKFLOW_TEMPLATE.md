...
> Šaltinio failas: ai/English/templates/WORKFLOW_TEMPLATE.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `templates/WORKFLOW_TEMPLATE.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `templates`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
