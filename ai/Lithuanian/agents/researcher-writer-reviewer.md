...
> Šaltinio failas: ai/English/agents/researcher-writer-reviewer.md
> Jei yra neatitikimų, pirmenybė teikiama angliškam failui.

Šis puslapis paaiškina, kaip `agents/researcher-writer-reviewer.md` dera su AI Agent Operating Manual. Jis skirtas žmonėms ir AI agentams, kuriems reikia planuoti, tikrinti arba kartoti darbą repository.

## Praktinė apimtis

Naudok šį puslapį kaip operacinę gairę temai `agents`. Jis nepakeičia repository įrodymų ar projekto instrukcijų.
