...
This language folder contains the canonical English AI Manual for AI Smart Superpowers for Onboarding. It gives humans and AI coding agents a stable language-specific entrypoint before repository planning, coding, testing or review begins.
...
Start here when auditing the manual structure, checking localization alignment or loading reusable guidance for prompts, safety, tools, models, workflows and templates.
