...
This page explains how `memory/memory-safety.md` fits into the AI Agent Operating Manual. Use it when an agent or maintainer needs repeatable guidance for this topic without loading the entire repository.
...
Promote only reviewed, reusable and non-sensitive facts into durable memory.
