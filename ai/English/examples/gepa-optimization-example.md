...
Practical examples for Codex, Claude Code, Gemini CLI, skills, memory and GEPA.

## Purpose

This file gives users a structured, practical reference for `examples/gepa-optimization-example.md`.
