...
This page explains how `workflows/translation-update.md` fits into the AI Agent Operating Manual. Use it when an agent or maintainer needs repeatable guidance for this topic without loading the entire repository.
...
Update English first, mirror paths, preserve technical tokens and mark AI-translated pages with the quality-pass status.
