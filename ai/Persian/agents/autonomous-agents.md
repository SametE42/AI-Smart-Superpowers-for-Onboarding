...
> زبان مبدأ: انگلیسی
> فایل مبدأ: ai/English/agents/autonomous-agents.md
> در صورت اختلاف، فایل انگلیسی مرجع اصلی است.

این صفحه توضیح می‌دهد که `agents/autonomous-agents.md` چگونه در AI Agent Operating Manual قرار می‌گیرد. برای انسان‌ها و AI agents نوشته شده که باید کار repository را برنامه‌ریزی، راستی‌آزمایی یا تکرار کنند.
