...
> زبان مبدأ: انگلیسی
> فایل مبدأ: ai/English/safety/prompt-injection.md
> در صورت اختلاف، فایل انگلیسی مرجع اصلی است.

این صفحه توضیح می‌دهد که `safety/prompt-injection.md` چگونه در AI Agent Operating Manual قرار می‌گیرد. برای انسان‌ها و AI agents نوشته شده که باید کار repository را برنامه‌ریزی، راستی‌آزمایی یا تکرار کنند.

## دامنه عملی

از این صفحه به عنوان راهنمای عملیاتی برای موضوع `safety` استفاده کنید. جایگزین شواهد repository یا دستورهای اختصاصی پروژه نیست.
