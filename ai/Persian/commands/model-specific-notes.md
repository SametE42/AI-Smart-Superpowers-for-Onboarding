...
> زبان مبدأ: انگلیسی
> فایل مبدأ: ai/English/commands/model-specific-notes.md
> در صورت اختلاف، فایل انگلیسی مرجع اصلی است.

این صفحه توضیح می‌دهد که `commands/model-specific-notes.md` چگونه در AI Agent Operating Manual قرار می‌گیرد. برای انسان‌ها و AI agents نوشته شده که باید کار repository را برنامه‌ریزی، راستی‌آزمایی یا تکرار کنند.

## دامنه عملی

از این صفحه به عنوان راهنمای عملیاتی برای موضوع `commands` استفاده کنید. جایگزین شواهد repository یا دستورهای اختصاصی پروژه نیست.
