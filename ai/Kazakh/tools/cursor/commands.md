...
> Бастапқы файл: ai/English/tools/cursor/commands.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `tools/cursor/commands.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
