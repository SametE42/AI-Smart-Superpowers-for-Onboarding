...
> Бастапқы файл: ai/English/tools/opencode/context-files.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `tools/opencode/context-files.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
