...
> Бастапқы файл: ai/English/tools/claude-code/context-files.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `tools/claude-code/context-files.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.

## Практикалық ауқым

Бұл бетті `tools` тақырыбына операциялық нұсқаулық ретінде қолданыңыз. Ол repository дәлелдерін немесе жоба нұсқауларын алмастырмайды.
