...
> Бастапқы файл: ai/English/tools/gemini-cli/README.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `tools/gemini-cli/README.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
