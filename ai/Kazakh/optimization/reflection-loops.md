...
> Бастапқы файл: ai/English/optimization/reflection-loops.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `optimization/reflection-loops.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
