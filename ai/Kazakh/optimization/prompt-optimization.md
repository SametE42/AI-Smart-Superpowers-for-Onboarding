...
> Бастапқы файл: ai/English/optimization/prompt-optimization.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `optimization/prompt-optimization.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
