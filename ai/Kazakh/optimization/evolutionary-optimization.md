...
> Бастапқы файл: ai/English/optimization/evolutionary-optimization.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `optimization/evolutionary-optimization.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.

## Практикалық ауқым

Бұл бетті `optimization` тақырыбына операциялық нұсқаулық ретінде қолданыңыз. Ол repository дәлелдерін немесе жоба нұсқауларын алмастырмайды.
