...
> Бастапқы файл: ai/English/optimization/gepa.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `optimization/gepa.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
