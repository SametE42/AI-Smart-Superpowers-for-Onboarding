...
> Бастапқы файл: ai/English/safety/tool-permissions.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `safety/tool-permissions.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
