...
> Бастапқы файл: ai/English/models/perplexity/README.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `models/perplexity/README.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
