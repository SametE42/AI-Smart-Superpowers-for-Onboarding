...
> Бастапқы файл: ai/English/templates/MODEL_PROFILE.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `templates/MODEL_PROFILE.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
