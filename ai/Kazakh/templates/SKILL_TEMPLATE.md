...
> Бастапқы файл: ai/English/templates/SKILL_TEMPLATE.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `templates/SKILL_TEMPLATE.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
