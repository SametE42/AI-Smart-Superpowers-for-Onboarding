...
> Бастапқы файл: ai/English/templates/EVAL_TEMPLATE.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `templates/EVAL_TEMPLATE.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
