...
> Бастапқы файл: ai/English/templates/AGENT_PROFILE.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `templates/AGENT_PROFILE.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
