...
> Бастапқы файл: ai/English/memory/memory-overview.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `memory/memory-overview.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
