...
> Бастапқы файл: ai/English/memory/procedural-memory.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `memory/procedural-memory.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
