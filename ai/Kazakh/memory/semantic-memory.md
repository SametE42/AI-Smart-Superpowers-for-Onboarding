...
> Бастапқы файл: ai/English/memory/semantic-memory.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `memory/semantic-memory.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
