...
> Бастапқы файл: ai/English/memory/memory-consolidation.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `memory/memory-consolidation.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.

## Практикалық ауқым

Бұл бетті `memory` тақырыбына операциялық нұсқаулық ретінде қолданыңыз. Ол repository дәлелдерін немесе жоба нұсқауларын алмастырмайды.
