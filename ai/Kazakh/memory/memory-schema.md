...
> Бастапқы файл: ai/English/memory/memory-schema.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `memory/memory-schema.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
