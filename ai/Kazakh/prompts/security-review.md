...
> Бастапқы файл: ai/English/prompts/security-review.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `prompts/security-review.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
