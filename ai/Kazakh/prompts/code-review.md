...
> Бастапқы файл: ai/English/prompts/code-review.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `prompts/code-review.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
