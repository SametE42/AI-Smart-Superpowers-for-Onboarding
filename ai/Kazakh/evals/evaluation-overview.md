...
> Бастапқы файл: ai/English/evals/evaluation-overview.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `evals/evaluation-overview.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.

## Практикалық ауқым

Бұл бетті `evals` тақырыбына операциялық нұсқаулық ретінде қолданыңыз. Ол repository дәлелдерін немесе жоба нұсқауларын алмастырмайды.
