...
> Бастапқы файл: ai/English/evals/benchmark-template.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `evals/benchmark-template.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
