...
> Бастапқы файл: ai/English/evals/tool-use-evals.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `evals/tool-use-evals.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
