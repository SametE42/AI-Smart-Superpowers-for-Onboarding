...
> Бастапқы файл: ai/English/agents/researcher-writer-reviewer.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `agents/researcher-writer-reviewer.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.

## Практикалық ауқым

Бұл бетті `agents` тақырыбына операциялық нұсқаулық ретінде қолданыңыз. Ол repository дәлелдерін немесе жоба нұсқауларын алмастырмайды.
