...
> Бастапқы файл: ai/English/agents/planner-executor.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `agents/planner-executor.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
