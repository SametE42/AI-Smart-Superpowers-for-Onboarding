...
> Бастапқы файл: ai/English/agents/human-in-the-loop.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `agents/human-in-the-loop.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
