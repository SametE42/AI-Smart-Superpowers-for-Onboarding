...
> Бастапқы файл: ai/English/agents/coding-agents.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `agents/coding-agents.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
