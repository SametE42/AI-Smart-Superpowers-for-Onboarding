...
> Бастапқы файл: ai/English/context-engineering/context-windows.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `context-engineering/context-windows.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
