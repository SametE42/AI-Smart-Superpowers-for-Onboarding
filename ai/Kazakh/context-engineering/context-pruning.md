...
> Бастапқы файл: ai/English/context-engineering/context-pruning.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `context-engineering/context-pruning.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
