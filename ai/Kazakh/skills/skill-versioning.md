...
> Бастапқы файл: ai/English/skills/skill-versioning.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `skills/skill-versioning.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
