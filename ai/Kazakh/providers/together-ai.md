...
> Бастапқы файл: ai/English/providers/together-ai.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `providers/together-ai.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
