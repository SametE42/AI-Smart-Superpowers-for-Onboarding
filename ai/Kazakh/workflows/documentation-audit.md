...
> Бастапқы файл: ai/English/workflows/documentation-audit.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `workflows/documentation-audit.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
