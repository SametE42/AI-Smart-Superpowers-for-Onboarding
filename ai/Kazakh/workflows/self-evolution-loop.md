...
> Бастапқы файл: ai/English/workflows/self-evolution-loop.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `workflows/self-evolution-loop.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.

## Практикалық ауқым

Бұл бетті `workflows` тақырыбына операциялық нұсқаулық ретінде қолданыңыз. Ол repository дәлелдерін немесе жоба нұсқауларын алмастырмайды.
