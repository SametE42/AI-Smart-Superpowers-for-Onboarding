...
> Бастапқы файл: ai/English/workflows/agent-optimization.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `workflows/agent-optimization.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
