...
> Бастапқы файл: ai/English/commands/codex.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `commands/codex.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
