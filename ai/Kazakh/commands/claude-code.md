...
> Бастапқы файл: ai/English/commands/claude-code.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `commands/claude-code.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
