...
> Бастапқы файл: ai/English/commands/cursor.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `commands/cursor.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
