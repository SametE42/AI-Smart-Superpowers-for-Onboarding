...
> Бастапқы файл: ai/English/examples/claude-code-workflow.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `examples/claude-code-workflow.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
