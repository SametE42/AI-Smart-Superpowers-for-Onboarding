...
> Бастапқы файл: ai/English/examples/skill-example.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `examples/skill-example.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.
