...
> Бастапқы файл: ai/English/examples/gepa-optimization-example.md
> Айырмашылық болса, ағылшын файлы басым.

Бұл бет `examples/gepa-optimization-example.md` AI Agent Operating Manual ішінде қалай қолданылатынын түсіндіреді; repository жұмысын жоспарлайтын, тексеретін немесе қайталайтын адамдар мен AI agents үшін.

## Практикалық ауқым

Бұл бетті `examples` тақырыбына операциялық нұсқаулық ретінде қолданыңыз. Ол repository дәлелдерін немесе жоба нұсқауларын алмастырмайды.
