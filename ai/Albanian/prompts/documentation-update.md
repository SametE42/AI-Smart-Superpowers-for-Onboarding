...
> Skedari burim: ai/English/prompts/documentation-update.md
> Në rast mospërputhjesh, skedari anglisht ka përparësi.

Kjo faqe shpjegon si `prompts/documentation-update.md` përshtatet në AI Agent Operating Manual. Është shkruar për njerëz dhe agjentë AI që duhet të planifikojnë, verifikojnë ose përsërisin punë në repository.

## Fusha praktike

Përdore këtë faqe si udhëzim operacional për temën `prompts`. Nuk zëvendëson provat e repository-t ose udhëzimet specifike të projektit.
