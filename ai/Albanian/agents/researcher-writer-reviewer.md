...
> Skedari burim: ai/English/agents/researcher-writer-reviewer.md
> Në rast mospërputhjesh, skedari anglisht ka përparësi.

Kjo faqe shpjegon si `agents/researcher-writer-reviewer.md` përshtatet në AI Agent Operating Manual. Është shkruar për njerëz dhe agjentë AI që duhet të planifikojnë, verifikojnë ose përsërisin punë në repository.

## Fusha praktike

Përdore këtë faqe si udhëzim operacional për temën `agents`. Nuk zëvendëson provat e repository-t ose udhëzimet specifike të projektit.
