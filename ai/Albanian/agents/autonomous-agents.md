...
> Skedari burim: ai/English/agents/autonomous-agents.md
> Në rast mospërputhjesh, skedari anglisht ka përparësi.

Kjo faqe shpjegon si `agents/autonomous-agents.md` përshtatet në AI Agent Operating Manual. Është shkruar për njerëz dhe agjentë AI që duhet të planifikojnë, verifikojnë ose përsërisin punë në repository.
