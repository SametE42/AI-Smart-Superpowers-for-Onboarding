...
> Skedari burim: ai/English/models/meta-llama/config.md
> Në rast mospërputhjesh, skedari anglisht ka përparësi.

Kjo faqe shpjegon si `models/meta-llama/config.md` përshtatet në AI Agent Operating Manual. Është shkruar për njerëz dhe agjentë AI që duhet të planifikojnë, verifikojnë ose përsërisin punë në repository.
