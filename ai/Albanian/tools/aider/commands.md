...
> Skedari burim: ai/English/tools/aider/commands.md
> Në rast mospërputhjesh, skedari anglisht ka përparësi.

Kjo faqe shpjegon si `tools/aider/commands.md` përshtatet në AI Agent Operating Manual. Është shkruar për njerëz dhe agjentë AI që duhet të planifikojnë, verifikojnë ose përsërisin punë në repository.
