...
> Skedari burim: ai/English/memory/memory-consolidation.md
> Në rast mospërputhjesh, skedari anglisht ka përparësi.

Kjo faqe shpjegon si `memory/memory-consolidation.md` përshtatet në AI Agent Operating Manual. Është shkruar për njerëz dhe agjentë AI që duhet të planifikojnë, verifikojnë ose përsërisin punë në repository.

## Fusha praktike

Përdore këtë faqe si udhëzim operacional për temën `memory`. Nuk zëvendëson provat e repository-t ose udhëzimet specifike të projektit.
