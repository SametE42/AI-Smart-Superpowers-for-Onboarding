...
> Skedari burim: ai/English/skills/self-evolving-skills.md
> Në rast mospërputhjesh, skedari anglisht ka përparësi.

Kjo faqe shpjegon si `skills/self-evolving-skills.md` përshtatet në AI Agent Operating Manual. Është shkruar për njerëz dhe agjentë AI që duhet të planifikojnë, verifikojnë ose përsërisin punë në repository.

## Fusha praktike

Përdore këtë faqe si udhëzim operacional për temën `skills`. Nuk zëvendëson provat e repository-t ose udhëzimet specifike të projektit.
