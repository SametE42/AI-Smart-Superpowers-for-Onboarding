...
Denne siden forklarer hvordan `optimization/evolutionary-optimization.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `optimization`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
