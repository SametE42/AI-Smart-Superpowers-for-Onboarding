...
Denne siden forklarer hvordan `optimization/rollout-evaluation.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.
