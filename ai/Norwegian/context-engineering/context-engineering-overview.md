...
Denne siden forklarer hvordan `context-engineering/context-engineering-overview.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `context-engineering`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
