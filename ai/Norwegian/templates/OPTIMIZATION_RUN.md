...
Denne siden forklarer hvordan `templates/OPTIMIZATION_RUN.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.
