...
Denne siden forklarer hvordan `templates/EVAL_TEMPLATE.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.
