...
Denne siden forklarer hvordan `prompts/magical-prompt-improver.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `prompt improvement`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
