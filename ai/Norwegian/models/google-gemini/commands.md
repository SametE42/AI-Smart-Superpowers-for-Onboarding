...
> Kildespråk: engelsk
> Kildefil: ai/English/models/google-gemini/commands.md
> Ved avvik gjelder den engelske filen.

Denne siden forklarer hvordan `models/google-gemini/commands.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `models`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
