...
> Kildespråk: engelsk
> Kildefil: ai/English/models/xiaomi-mimo/prompts.md
> Ved avvik gjelder den engelske filen.

Denne siden forklarer hvordan `models/xiaomi-mimo/prompts.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.
