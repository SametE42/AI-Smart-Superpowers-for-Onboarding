...
Denne siden forklarer hvordan `skills/self-evolving-skills.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `skills`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
