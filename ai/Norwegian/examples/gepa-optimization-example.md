...
Denne siden forklarer hvordan `examples/gepa-optimization-example.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `examples`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
