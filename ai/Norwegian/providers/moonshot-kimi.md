...
Denne siden forklarer hvordan `providers/moonshot-kimi.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `providers`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
