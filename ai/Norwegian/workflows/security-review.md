...
> Kildespråk: engelsk
> Kildefil: ai/English/workflows/security-review.md
> Ved avvik gjelder den engelske filen.

Denne siden forklarer hvordan `workflows/security-review.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.
