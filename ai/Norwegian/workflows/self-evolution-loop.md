...
> Kildespråk: engelsk
> Kildefil: ai/English/workflows/self-evolution-loop.md
> Ved avvik gjelder den engelske filen.

Denne siden forklarer hvordan `workflows/self-evolution-loop.md` passer inn i AI Agent Operating Manual. Den er skrevet for mennesker og AI-agenter som må planlegge, verifisere eller gjenta repositoryarbeid.

## Praktisk omfang

Bruk siden som operativ veiledning for temaet `workflows`. Den erstatter ikke repositorybevis eller prosjektspesifikke instruksjoner.
