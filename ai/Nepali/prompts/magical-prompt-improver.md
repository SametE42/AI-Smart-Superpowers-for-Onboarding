...
यो पृष्ठले `prompts/magical-prompt-improver.md` AI Agent Operating Manual मा कसरी मिल्छ भनेर बताउँछ; repository काम योजना, प्रमाणीकरण वा दोहोर्‍याउने मानिस र AI agents का लागि। Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## व्यावहारिक दायरा

यो पृष्ठलाई `prompt improvement` का लागि सञ्चालन मार्गदर्शकको रूपमा प्रयोग गर्नुहोस्। यसले repository प्रमाण वा परियोजना निर्देशन प्रतिस्थापन गर्दैन।
