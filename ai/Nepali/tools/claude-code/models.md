...
> स्रोत भाषा: अंग्रेजी
> स्रोत फाइल: ai/English/tools/claude-code/models.md
> फरक भएमा अंग्रेजी फाइललाई प्राथमिकता दिइन्छ।

यो पृष्ठले `tools/claude-code/models.md` AI Agent Operating Manual मा कसरी मिल्छ भनेर बताउँछ; repository काम योजना, प्रमाणीकरण वा दोहोर्‍याउने मानिस र AI agents का लागि।
