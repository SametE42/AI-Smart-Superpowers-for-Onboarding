...
> સ્ત્રોત ફાઇલ: ai/English/evals/tool-use-evals.md
> ફરક હોય તો અંગ્રેજી ફાઇલ પ્રાથમિક રહેશે.

આ પૃષ્ઠ સમજાવે છે કે `evals/tool-use-evals.md` AI Agent Operating Manual માં કેવી રીતે ફિટ થાય છે, repository કામની યોજના, ચકાસણી અથવા પુનરાવર્તન કરનારા લોકો અને AI agents માટે.
