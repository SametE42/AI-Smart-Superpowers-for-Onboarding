...
> ភាសាប្រភព៖ អង់គ្លេស
> ឯកសារប្រភព: ai/English/optimization/evolutionary-optimization.md
> បើមានភាពខុសគ្នា ឯកសារអង់គ្លេសមានអាទិភាព។

ទំព័រនេះពន្យល់ថា `optimization/evolutionary-optimization.md` សមនឹង AI Agent Operating Manual ដូចម្តេច សម្រាប់មនុស្ស និង AI agents ដែលត្រូវរៀបចំ ផ្ទៀងផ្ទាត់ ឬធ្វើឡើងវិញនូវការងារ repository។

## វិសាលភាពអនុវត្ត

ប្រើទំព័រនេះជាមគ្គុទ្ទេសក៍ប្រតិបត្តិការសម្រាប់ `optimization`។ វាមិនជំនួសភស្តុតាង repository ឬសេចក្តីណែនាំគម្រោងទេ។
