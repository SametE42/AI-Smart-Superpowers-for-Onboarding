...
> ភាសាប្រភព៖ អង់គ្លេស
> ឯកសារប្រភព: ai/English/models/google-gemini/prompts.md
> បើមានភាពខុសគ្នា ឯកសារអង់គ្លេសមានអាទិភាព។

ទំព័រនេះពន្យល់ថា `models/google-gemini/prompts.md` សមនឹង AI Agent Operating Manual ដូចម្តេច សម្រាប់មនុស្ស និង AI agents ដែលត្រូវរៀបចំ ផ្ទៀងផ្ទាត់ ឬធ្វើឡើងវិញនូវការងារ repository។
