...
Boggan wuxuu sharxayaa sida `models/meta-llama/config.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository.
