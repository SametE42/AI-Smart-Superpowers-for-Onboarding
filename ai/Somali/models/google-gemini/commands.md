...
> Faylka asalka: ai/English/models/google-gemini/commands.md
> Haddii kala duwanaansho jirto, faylka Ingiriisiga ayaa mudnaanta leh.

Boggan wuxuu sharxayaa sida `models/google-gemini/commands.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository.

## Baaxadda waxqabadka

U isticmaal boggan hagitaan hawlgal oo loogu talagalay `models`. Ma beddelayo caddaynta repository ama tilmaamaha mashruuca.
