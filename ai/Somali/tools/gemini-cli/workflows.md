...
> Faylka asalka: ai/English/tools/gemini-cli/workflows.md
> Haddii kala duwanaansho jirto, faylka Ingiriisiga ayaa mudnaanta leh.

Boggan wuxuu sharxayaa sida `tools/gemini-cli/workflows.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository.
