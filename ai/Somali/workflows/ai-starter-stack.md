...
> Faylka asalka: ai/English/workflows/ai-starter-stack.md
> Haddii kala duwanaansho jirto, faylka Ingiriisiga ayaa mudnaanta leh.

Boggan wuxuu sharxayaa sida `workflows/ai-starter-stack.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository.
