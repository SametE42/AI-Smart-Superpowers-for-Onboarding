...
Boggan wuxuu sharxayaa sida `README.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository.

## Baaxadda waxqabadka

U isticmaal boggan hagitaan hawlgal oo loogu talagalay `README.md`. Ma beddelayo caddaynta repository ama tilmaamaha mashruuca.
