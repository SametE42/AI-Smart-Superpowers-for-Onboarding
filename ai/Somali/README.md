...
> Faylka asalka: ai/English/README.md
> Haddii kala duwanaansho jirto, faylka Ingiriisiga ayaa mudnaanta leh.

## Purpose of this language folder

Boggan wuxuu sharxayaa sida `README.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository. This language folder contains the localized AI Agent Operating Manual and mirrors the English folder structure for onboarding, review, prompts, safety, tools, models and templates.

## English source of truth

Haddii kala duwanaansho jirto, faylka Ingiriisiga ayaa mudnaanta leh. The English source [`ai/English/README.md`](../English/README.md) remains authoritative, and localized files mirror the English structure.

## How to use this folder

U isticmaal boggan hagitaan hawlgal oo loogu talagalay `language folder`. Ma beddelayo caddaynta repository ama tilmaamaha mashruuca. Use this folder to load the language-specific entrypoint before reading safety guidance, agent patterns, context engineering notes, prompt templates, tool guidance and reusable templates.
