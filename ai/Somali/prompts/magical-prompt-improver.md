...
> Faylka asalka: ai/English/prompts/magical-prompt-improver.md
> Haddii kala duwanaansho jirto, faylka Ingiriisiga ayaa mudnaanta leh.

Boggan wuxuu sharxayaa sida `prompts/magical-prompt-improver.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Baaxadda waxqabadka

U isticmaal boggan hagitaan hawlgal oo loogu talagalay `prompt improvement`. Ma beddelayo caddaynta repository ama tilmaamaha mashruuca.
