...
> Faylka asalka: ai/English/prompts/documentation-update.md
> Haddii kala duwanaansho jirto, faylka Ingiriisiga ayaa mudnaanta leh.

Boggan wuxuu sharxayaa sida `prompts/documentation-update.md` ugu habboon yahay AI Agent Operating Manual, dadka iyo AI agents ee qorsheeya, xaqiijiya ama ku celiya shaqada repository.

## Baaxadda waxqabadka

U isticmaal boggan hagitaan hawlgal oo loogu talagalay `prompts`. Ma beddelayo caddaynta repository ama tilmaamaha mashruuca.
