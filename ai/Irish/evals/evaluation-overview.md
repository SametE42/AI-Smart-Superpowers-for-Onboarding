...
> Comhad foinse: ai/English/evals/evaluation-overview.md
> Má tá difríochtaí ann, tá an comhad Béarla i réim.

Míníonn an leathanach seo conas a oireann `evals/evaluation-overview.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh.

## Raon praiticiúil

Úsáid an leathanach seo mar threoir oibríochtúil don ábhar `evals`. Ní chuireann sé fianaise repository ná treoracha tionscadail in ionad.
