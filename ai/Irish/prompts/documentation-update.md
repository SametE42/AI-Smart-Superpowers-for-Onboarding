...
> Comhad foinse: ai/English/prompts/documentation-update.md
> Má tá difríochtaí ann, tá an comhad Béarla i réim.

Míníonn an leathanach seo conas a oireann `prompts/documentation-update.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh.

## Raon praiticiúil

Úsáid an leathanach seo mar threoir oibríochtúil don ábhar `prompts`. Ní chuireann sé fianaise repository ná treoracha tionscadail in ionad.
