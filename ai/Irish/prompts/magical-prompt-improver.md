...
> Comhad foinse: ai/English/prompts/magical-prompt-improver.md
> Má tá difríochtaí ann, tá an comhad Béarla i réim.

Míníonn an leathanach seo conas a oireann `prompts/magical-prompt-improver.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Raon praiticiúil

Úsáid an leathanach seo mar threoir oibríochtúil don ábhar `prompt improvement`. Ní chuireann sé fianaise repository ná treoracha tionscadail in ionad.
