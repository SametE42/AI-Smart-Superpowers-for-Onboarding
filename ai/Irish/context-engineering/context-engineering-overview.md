...
> Comhad foinse: ai/English/context-engineering/context-engineering-overview.md
> Má tá difríochtaí ann, tá an comhad Béarla i réim.

Míníonn an leathanach seo conas a oireann `context-engineering/context-engineering-overview.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh.

## Raon praiticiúil

Úsáid an leathanach seo mar threoir oibríochtúil don ábhar `context-engineering`. Ní chuireann sé fianaise repository ná treoracha tionscadail in ionad.
