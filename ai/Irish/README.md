...
Míníonn an leathanach seo conas a oireann `README.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh. This language folder contains the localized AI Agent Operating Manual and mirrors the English folder structure for onboarding, review, prompts, safety, tools, models and templates.

## English source of truth

Má tá difríochtaí ann, tá an comhad Béarla i réim. The English source [`ai/English/README.md`](../English/README.md) remains authoritative, and localized files mirror the English structure.

## How to use this folder

Úsáid an leathanach seo mar threoir oibríochtúil don ábhar `language folder`. Ní chuireann sé fianaise repository ná treoracha tionscadail in ionad. Use this folder to load the language-specific entrypoint before reading safety guidance, agent patterns, context engineering notes, prompt templates, tool guidance and reusable templates.
