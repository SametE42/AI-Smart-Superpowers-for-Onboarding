...
> Comhad foinse: ai/English/memory/memory-consolidation.md
> Má tá difríochtaí ann, tá an comhad Béarla i réim.

Míníonn an leathanach seo conas a oireann `memory/memory-consolidation.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh.

## Raon praiticiúil

Úsáid an leathanach seo mar threoir oibríochtúil don ábhar `memory`. Ní chuireann sé fianaise repository ná treoracha tionscadail in ionad.
