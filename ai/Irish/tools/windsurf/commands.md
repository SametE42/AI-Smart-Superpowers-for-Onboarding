...
> Comhad foinse: ai/English/tools/windsurf/commands.md
> Má tá difríochtaí ann, tá an comhad Béarla i réim.

Míníonn an leathanach seo conas a oireann `tools/windsurf/commands.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh.
