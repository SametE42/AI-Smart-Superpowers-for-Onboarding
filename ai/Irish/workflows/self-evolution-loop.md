...
> Comhad foinse: ai/English/workflows/self-evolution-loop.md
> Má tá difríochtaí ann, tá an comhad Béarla i réim.

Míníonn an leathanach seo conas a oireann `workflows/self-evolution-loop.md` don AI Agent Operating Manual do dhaoine agus AI agents a chaithfidh obair repository a phleanáil, a fhíorú nó a athdhéanamh.

## Raon praiticiúil

Úsáid an leathanach seo mar threoir oibríochtúil don ábhar `workflows`. Ní chuireann sé fianaise repository ná treoracha tionscadail in ionad.
