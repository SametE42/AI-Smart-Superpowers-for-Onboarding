...
> Avota valoda: angļu
> Avota fails: ai/English/templates/WORKFLOW_TEMPLATE.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `templates/WORKFLOW_TEMPLATE.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `templates`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
