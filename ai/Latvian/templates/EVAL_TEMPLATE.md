...
> Avota valoda: angļu
> Avota fails: ai/English/templates/EVAL_TEMPLATE.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `templates/EVAL_TEMPLATE.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
