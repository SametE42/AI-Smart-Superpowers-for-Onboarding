...
> Avota valoda: angļu
> Avota fails: ai/English/templates/MODEL_PROFILE.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `templates/MODEL_PROFILE.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
