...
> Avota valoda: angļu
> Avota fails: ai/English/skills/self-evolving-skills.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `skills/self-evolving-skills.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `skills`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
