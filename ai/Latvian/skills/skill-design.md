...
> Avota valoda: angļu
> Avota fails: ai/English/skills/skill-design.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `skills/skill-design.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
