...
> Avota valoda: angļu
> Avota fails: ai/English/skills/skill-registry.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `skills/skill-registry.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
