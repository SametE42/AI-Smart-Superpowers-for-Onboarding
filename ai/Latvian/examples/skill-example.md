...
> Avota valoda: angļu
> Avota fails: ai/English/examples/skill-example.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `examples/skill-example.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
