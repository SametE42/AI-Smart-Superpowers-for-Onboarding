...
> Avota valoda: angļu
> Avota fails: ai/English/examples/claude-code-workflow.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `examples/claude-code-workflow.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
