...
> Avota valoda: angļu
> Avota fails: ai/English/examples/gemini-cli-workflow.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `examples/gemini-cli-workflow.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
