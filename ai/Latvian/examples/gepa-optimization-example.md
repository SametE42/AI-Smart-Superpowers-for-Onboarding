...
> Avota valoda: angļu
> Avota fails: ai/English/examples/gepa-optimization-example.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `examples/gepa-optimization-example.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `examples`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
