...
> Avota valoda: angļu
> Avota fails: ai/English/examples/memory-example.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `examples/memory-example.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
