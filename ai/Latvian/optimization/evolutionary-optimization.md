...
> Avota valoda: angļu
> Avota fails: ai/English/optimization/evolutionary-optimization.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `optimization/evolutionary-optimization.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `optimization`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
