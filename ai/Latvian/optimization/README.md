...
> Avota valoda: angļu
> Avota fails: ai/English/optimization/README.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `optimization/README.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
