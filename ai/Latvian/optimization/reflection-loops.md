...
> Avota valoda: angļu
> Avota fails: ai/English/optimization/reflection-loops.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `optimization/reflection-loops.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
