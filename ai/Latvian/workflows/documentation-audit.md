...
> Avota valoda: angļu
> Avota fails: ai/English/workflows/documentation-audit.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `workflows/documentation-audit.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `workflows`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
