...
> Avota valoda: angļu
> Avota fails: ai/English/workflows/skill-creation.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `workflows/skill-creation.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
