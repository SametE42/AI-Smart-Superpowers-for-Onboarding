...
> Avota valoda: angļu
> Avota fails: ai/English/tools/claude-code/context-files.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `tools/claude-code/context-files.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `tools`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
