...
> Avota valoda: angļu
> Avota fails: ai/English/tools/opencode/README.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `tools/opencode/README.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
