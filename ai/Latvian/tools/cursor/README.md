...
> Avota valoda: angļu
> Avota fails: ai/English/tools/cursor/README.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `tools/cursor/README.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
