...
> Avota valoda: angļu
> Avota fails: ai/English/tools/continue/context-files.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `tools/continue/context-files.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
