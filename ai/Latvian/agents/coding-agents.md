...
> Avota valoda: angļu
> Avota fails: ai/English/agents/coding-agents.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `agents/coding-agents.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
