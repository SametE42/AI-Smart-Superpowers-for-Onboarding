...
> Avota valoda: angļu
> Avota fails: ai/English/agents/researcher-writer-reviewer.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `agents/researcher-writer-reviewer.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `agents`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
