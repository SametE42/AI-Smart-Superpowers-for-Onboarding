...
> Avota valoda: angļu
> Avota fails: ai/English/agents/human-in-the-loop.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `agents/human-in-the-loop.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
