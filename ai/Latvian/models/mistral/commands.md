...
> Avota valoda: angļu
> Avota fails: ai/English/models/mistral/commands.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `models/mistral/commands.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
