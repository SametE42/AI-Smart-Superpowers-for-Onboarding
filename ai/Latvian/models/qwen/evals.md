...
> Avota valoda: angļu
> Avota fails: ai/English/models/qwen/evals.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `models/qwen/evals.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
