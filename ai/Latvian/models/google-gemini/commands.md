...
> Avota valoda: angļu
> Avota fails: ai/English/models/google-gemini/commands.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `models/google-gemini/commands.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `models`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
