...
> Avota valoda: angļu
> Avota fails: ai/English/models/anthropic/prompts.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `models/anthropic/prompts.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
