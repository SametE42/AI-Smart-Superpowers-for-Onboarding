...
> Avota valoda: angļu
> Avota fails: ai/English/safety/tool-permissions.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `safety/tool-permissions.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `safety`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
