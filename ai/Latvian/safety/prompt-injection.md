...
> Avota valoda: angļu
> Avota fails: ai/English/safety/prompt-injection.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `safety/prompt-injection.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
