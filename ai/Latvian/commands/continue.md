...
> Avota valoda: angļu
> Avota fails: ai/English/commands/continue.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `commands/continue.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
