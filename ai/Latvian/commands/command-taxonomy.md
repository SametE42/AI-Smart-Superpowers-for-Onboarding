...
> Avota valoda: angļu
> Avota fails: ai/English/commands/command-taxonomy.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `commands/command-taxonomy.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
