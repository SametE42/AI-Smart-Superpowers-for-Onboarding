...
> Avota valoda: angļu
> Avota fails: ai/English/commands/gemini-cli.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `commands/gemini-cli.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
