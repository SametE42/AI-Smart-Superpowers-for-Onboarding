...
> Avota valoda: angļu
> Avota fails: ai/English/commands/model-specific-notes.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `commands/model-specific-notes.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `commands`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
