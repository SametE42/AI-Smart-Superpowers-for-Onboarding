...
> Avota valoda: angļu
> Avota fails: ai/English/prompts/magical-prompt-improver.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `prompts/magical-prompt-improver.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `prompt improvement`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
