...
> Avota valoda: angļu
> Avota fails: ai/English/prompts/code-review.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `prompts/code-review.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
