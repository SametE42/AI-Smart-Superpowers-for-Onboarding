...
> Avota valoda: angļu
> Avota fails: ai/English/prompts/prompt-structure.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `prompts/prompt-structure.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
