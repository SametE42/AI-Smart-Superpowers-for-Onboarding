...
> Avota valoda: angļu
> Avota fails: ai/English/prompts/security-review.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `prompts/security-review.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
