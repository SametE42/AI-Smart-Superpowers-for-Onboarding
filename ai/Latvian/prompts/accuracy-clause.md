...
> Avota valoda: angļu
> Avota fails: ai/English/prompts/accuracy-clause.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `prompts/accuracy-clause.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
