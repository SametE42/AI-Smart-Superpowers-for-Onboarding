...
> Avota valoda: angļu
> Avota fails: ai/English/context-engineering/context-engineering-overview.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `context-engineering/context-engineering-overview.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `context-engineering`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
