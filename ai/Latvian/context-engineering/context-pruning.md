...
> Avota valoda: angļu
> Avota fails: ai/English/context-engineering/context-pruning.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `context-engineering/context-pruning.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
