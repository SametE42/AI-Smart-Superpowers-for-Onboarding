...
> Avota valoda: angļu
> Avota fails: ai/English/context-engineering/context-packing.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `context-engineering/context-packing.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
