...
> Avota valoda: angļu
> Avota fails: ai/English/memory/memory-consolidation.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `memory/memory-consolidation.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `memory`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
