...
> Avota valoda: angļu
> Avota fails: ai/English/memory/memory-schema.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `memory/memory-schema.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
