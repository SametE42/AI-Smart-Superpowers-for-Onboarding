...
> Avota valoda: angļu
> Avota fails: ai/English/memory/three-tier-memory.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `memory/three-tier-memory.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
