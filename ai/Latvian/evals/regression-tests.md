...
> Avota valoda: angļu
> Avota fails: ai/English/evals/regression-tests.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `evals/regression-tests.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
