...
> Avota valoda: angļu
> Avota fails: ai/English/evals/scoring-rubrics.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `evals/scoring-rubrics.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
