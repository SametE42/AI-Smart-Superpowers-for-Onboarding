...
> Avota valoda: angļu
> Avota fails: ai/English/providers/deepseek.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `providers/deepseek.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.
