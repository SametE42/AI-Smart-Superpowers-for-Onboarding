...
> Avota valoda: angļu
> Avota fails: ai/English/providers/moonshot-kimi.md
> Atšķirību gadījumā noteicošais ir angļu fails.

Šī lapa skaidro, kā `providers/moonshot-kimi.md` iekļaujas AI Agent Operating Manual. Tā ir rakstīta cilvēkiem un AI aģentiem, kuriem jāplāno, jāpārbauda vai jāatkārto darbs repository.

## Praktiskais tvērums

Izmanto šo lapu kā operatīvu vadlīniju tēmai `providers`. Tā neaizstāj repository pierādījumus vai projekta specifiskās instrukcijas.
