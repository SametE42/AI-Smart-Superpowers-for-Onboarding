...
> Αρχείο πηγής: ai/English/providers/lm-studio.md
> Σε περίπτωση απόκλισης, υπερισχύει το αγγλικό αρχείο.

Αυτή η σελίδα εξηγεί πώς το `providers/lm-studio.md` εντάσσεται στο AI Agent Operating Manual. Προορίζεται για ανθρώπους και AI agents που πρέπει να σχεδιάσουν, να επαληθεύσουν ή να επαναλάβουν εργασία στο repository.
