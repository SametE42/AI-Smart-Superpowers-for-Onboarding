...
> Αρχείο πηγής: ai/English/skills/self-evolving-skills.md
> Σε περίπτωση απόκλισης, υπερισχύει το αγγλικό αρχείο.

Αυτή η σελίδα εξηγεί πώς το `skills/self-evolving-skills.md` εντάσσεται στο AI Agent Operating Manual. Προορίζεται για ανθρώπους και AI agents που πρέπει να σχεδιάσουν, να επαληθεύσουν ή να επαναλάβουν εργασία στο repository.

## Πρακτικό πεδίο

Χρησιμοποίησε αυτή τη σελίδα ως λειτουργικό οδηγό για το θέμα `skills`. Δεν αντικαθιστά τα στοιχεία του repository ούτε τις οδηγίες του έργου.
