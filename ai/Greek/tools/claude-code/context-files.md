...
> Αρχείο πηγής: ai/English/tools/claude-code/context-files.md
> Σε περίπτωση απόκλισης, υπερισχύει το αγγλικό αρχείο.

Αυτή η σελίδα εξηγεί πώς το `tools/claude-code/context-files.md` εντάσσεται στο AI Agent Operating Manual. Προορίζεται για ανθρώπους και AI agents που πρέπει να σχεδιάσουν, να επαληθεύσουν ή να επαναλάβουν εργασία στο repository.

## Πρακτικό πεδίο

Χρησιμοποίησε αυτή τη σελίδα ως λειτουργικό οδηγό για το θέμα `tools`. Δεν αντικαθιστά τα στοιχεία του repository ούτε τις οδηγίες του έργου.
