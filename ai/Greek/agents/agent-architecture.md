...
> Αρχείο πηγής: ai/English/agents/agent-architecture.md
> Σε περίπτωση απόκλισης, υπερισχύει το αγγλικό αρχείο.

Αυτή η σελίδα εξηγεί πώς το `agents/agent-architecture.md` εντάσσεται στο AI Agent Operating Manual. Προορίζεται για ανθρώπους και AI agents που πρέπει να σχεδιάσουν, να επαληθεύσουν ή να επαναλάβουν εργασία στο repository.
