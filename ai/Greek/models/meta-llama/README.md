...
> Αρχείο πηγής: ai/English/models/meta-llama/README.md
> Σε περίπτωση απόκλισης, υπερισχύει το αγγλικό αρχείο.

Αυτή η σελίδα εξηγεί πώς το `models/meta-llama/README.md` εντάσσεται στο AI Agent Operating Manual. Προορίζεται για ανθρώπους και AI agents που πρέπει να σχεδιάσουν, να επαληθεύσουν ή να επαναλάβουν εργασία στο repository.
