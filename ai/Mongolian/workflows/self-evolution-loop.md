...
> Эх хэл: Англи
> Эх файл: ai/English/workflows/self-evolution-loop.md
> Зөрүү гарвал англи файл давамгайлна.

Энэ хуудас `workflows/self-evolution-loop.md` AI Agent Operating Manual-д хэрхэн нийцэж байгааг тайлбарлана; repository ажлыг төлөвлөх, шалгах эсвэл давтах хүмүүс болон AI agents-д зориулагдсан.

## Практик хүрээ

Энэ хуудсыг `workflows` сэдвийн үйл ажиллагааны заавар болгон ашигла. Repository нотолгоо эсвэл төслийн зааврыг орлохгүй.
