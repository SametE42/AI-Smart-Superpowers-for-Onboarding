...
> Эх хэл: Англи
> Эх файл: ai/English/prompts/magical-prompt-improver.md
> Зөрүү гарвал англи файл давамгайлна.

Энэ хуудас `prompts/magical-prompt-improver.md` AI Agent Operating Manual-д хэрхэн нийцэж байгааг тайлбарлана; repository ажлыг төлөвлөх, шалгах эсвэл давтах хүмүүс болон AI agents-д зориулагдсан. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Практик хүрээ

Энэ хуудсыг `prompt improvement` сэдвийн үйл ажиллагааны заавар болгон ашигла. Repository нотолгоо эсвэл төслийн зааврыг орлохгүй.
