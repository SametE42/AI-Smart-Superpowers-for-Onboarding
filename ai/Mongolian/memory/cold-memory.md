...
> Эх хэл: Англи
> Эх файл: ai/English/memory/cold-memory.md
> Зөрүү гарвал англи файл давамгайлна.

Энэ хуудас `memory/cold-memory.md` AI Agent Operating Manual-д хэрхэн нийцэж байгааг тайлбарлана; repository ажлыг төлөвлөх, шалгах эсвэл давтах хүмүүс болон AI agents-д зориулагдсан.
