...
> Эх хэл: Англи
> Эх файл: ai/English/commands/model-specific-notes.md
> Зөрүү гарвал англи файл давамгайлна.

Энэ хуудас `commands/model-specific-notes.md` AI Agent Operating Manual-д хэрхэн нийцэж байгааг тайлбарлана; repository ажлыг төлөвлөх, шалгах эсвэл давтах хүмүүс болон AI agents-д зориулагдсан.

## Практик хүрээ

Энэ хуудсыг `commands` сэдвийн үйл ажиллагааны заавар болгон ашигла. Repository нотолгоо эсвэл төслийн зааврыг орлохгүй.
