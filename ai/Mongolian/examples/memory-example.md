...
> Эх хэл: Англи
> Эх файл: ai/English/examples/memory-example.md
> Зөрүү гарвал англи файл давамгайлна.

Энэ хуудас `examples/memory-example.md` AI Agent Operating Manual-д хэрхэн нийцэж байгааг тайлбарлана; repository ажлыг төлөвлөх, шалгах эсвэл давтах хүмүүс болон AI agents-д зориулагдсан.
