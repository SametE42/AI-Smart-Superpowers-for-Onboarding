...
> Эх хэл: Англи
> Эх файл: ai/English/models/cohere/config.md
> Зөрүү гарвал англи файл давамгайлна.

Энэ хуудас `models/cohere/config.md` AI Agent Operating Manual-д хэрхэн нийцэж байгааг тайлбарлана; repository ажлыг төлөвлөх, шалгах эсвэл давтах хүмүүс болон AI agents-д зориулагдсан.
