...
> Zdrojový soubor: ai/English/prompts/magical-prompt-improver.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `prompts/magical-prompt-improver.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `prompt improvement`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
