...
> Zdrojový soubor: ai/English/prompts/prompt-structure.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `prompts/prompt-structure.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
