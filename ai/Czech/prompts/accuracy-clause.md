...
> Zdrojový soubor: ai/English/prompts/accuracy-clause.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `prompts/accuracy-clause.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
