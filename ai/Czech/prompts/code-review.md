...
> Zdrojový soubor: ai/English/prompts/code-review.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `prompts/code-review.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
