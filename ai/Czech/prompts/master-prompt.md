...
> Zdrojový soubor: ai/English/prompts/master-prompt.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `prompts/master-prompt.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
