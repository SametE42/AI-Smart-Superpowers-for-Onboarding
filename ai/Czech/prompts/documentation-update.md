...
> Zdrojový soubor: ai/English/prompts/documentation-update.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `prompts/documentation-update.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `prompts`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
