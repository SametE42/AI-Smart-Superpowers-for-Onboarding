...
> Zdrojový soubor: ai/English/prompts/README.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `prompts/README.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
