...
> Zdrojový soubor: ai/English/skills/skill-registry.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `skills/skill-registry.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
