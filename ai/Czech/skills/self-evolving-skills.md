...
> Zdrojový soubor: ai/English/skills/self-evolving-skills.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `skills/self-evolving-skills.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `skills`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
