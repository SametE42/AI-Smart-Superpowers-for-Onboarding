...
> Zdrojový soubor: ai/English/context-engineering/context-windows.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `context-engineering/context-windows.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
