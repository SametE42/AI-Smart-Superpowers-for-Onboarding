...
> Zdrojový soubor: ai/English/context-engineering/context-engineering-overview.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `context-engineering/context-engineering-overview.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `context-engineering`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
