...
> Zdrojový soubor: ai/English/safety/privacy.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `safety/privacy.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
