...
> Zdrojový soubor: ai/English/safety/tool-permissions.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `safety/tool-permissions.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
