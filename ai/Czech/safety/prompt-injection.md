...
> Zdrojový soubor: ai/English/safety/prompt-injection.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `safety/prompt-injection.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `safety`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
