...
> Zdrojový soubor: ai/English/examples/skill-example.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `examples/skill-example.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
