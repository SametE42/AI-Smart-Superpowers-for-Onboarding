...
> Zdrojový soubor: ai/English/examples/gepa-optimization-example.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `examples/gepa-optimization-example.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `examples`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
