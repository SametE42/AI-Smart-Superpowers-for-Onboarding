...
> Zdrojový soubor: ai/English/examples/memory-example.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `examples/memory-example.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
