...
> Zdrojový soubor: ai/English/optimization/prompt-optimization.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `optimization/prompt-optimization.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
