...
> Zdrojový soubor: ai/English/optimization/evolutionary-optimization.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `optimization/evolutionary-optimization.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `optimization`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
