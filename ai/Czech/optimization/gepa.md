...
> Zdrojový soubor: ai/English/optimization/gepa.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `optimization/gepa.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
