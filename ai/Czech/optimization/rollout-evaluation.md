...
> Zdrojový soubor: ai/English/optimization/rollout-evaluation.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `optimization/rollout-evaluation.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
