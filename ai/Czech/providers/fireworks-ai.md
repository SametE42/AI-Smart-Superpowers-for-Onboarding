...
> Zdrojový soubor: ai/English/providers/fireworks-ai.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `providers/fireworks-ai.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
