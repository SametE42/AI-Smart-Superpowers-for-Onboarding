...
> Zdrojový soubor: ai/English/providers/moonshot-kimi.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `providers/moonshot-kimi.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `providers`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
