...
> Zdrojový soubor: ai/English/providers/together-ai.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `providers/together-ai.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
