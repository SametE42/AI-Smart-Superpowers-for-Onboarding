...
> Zdrojový soubor: ai/English/templates/SKILL_TEMPLATE.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `templates/SKILL_TEMPLATE.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
