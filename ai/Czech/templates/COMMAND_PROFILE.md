...
> Zdrojový soubor: ai/English/templates/COMMAND_PROFILE.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `templates/COMMAND_PROFILE.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
