...
> Zdrojový soubor: ai/English/templates/WORKFLOW_TEMPLATE.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `templates/WORKFLOW_TEMPLATE.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `templates`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
