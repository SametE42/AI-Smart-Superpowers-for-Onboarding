...
> Zdrojový soubor: ai/English/templates/MEMORY_SCHEMA.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `templates/MEMORY_SCHEMA.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
