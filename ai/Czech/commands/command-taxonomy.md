...
> Zdrojový soubor: ai/English/commands/command-taxonomy.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `commands/command-taxonomy.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
