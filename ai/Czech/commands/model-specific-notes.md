...
> Zdrojový soubor: ai/English/commands/model-specific-notes.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `commands/model-specific-notes.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `commands`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
