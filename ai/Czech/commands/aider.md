...
> Zdrojový soubor: ai/English/commands/aider.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `commands/aider.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
