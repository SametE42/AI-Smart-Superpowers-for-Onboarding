...
> Zdrojový soubor: ai/English/models/mistral/prompts.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `models/mistral/prompts.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
