...
> Zdrojový soubor: ai/English/models/perplexity/README.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `models/perplexity/README.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
