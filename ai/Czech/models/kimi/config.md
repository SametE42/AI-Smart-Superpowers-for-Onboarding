...
> Zdrojový soubor: ai/English/models/kimi/config.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `models/kimi/config.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
