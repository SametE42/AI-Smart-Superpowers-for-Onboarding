...
> Zdrojový soubor: ai/English/models/openrouter/evals.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `models/openrouter/evals.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
