...
> Zdrojový soubor: ai/English/evals/regression-tests.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `evals/regression-tests.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
