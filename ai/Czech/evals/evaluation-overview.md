...
> Zdrojový soubor: ai/English/evals/evaluation-overview.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `evals/evaluation-overview.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `evals`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
