...
> Zdrojový soubor: ai/English/evals/benchmark-template.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `evals/benchmark-template.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
