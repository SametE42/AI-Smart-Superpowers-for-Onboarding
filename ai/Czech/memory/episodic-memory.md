...
> Zdrojový soubor: ai/English/memory/episodic-memory.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `memory/episodic-memory.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
