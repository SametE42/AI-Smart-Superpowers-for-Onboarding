...
> Zdrojový soubor: ai/English/memory/memory-pruning.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `memory/memory-pruning.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
