...
> Zdrojový soubor: ai/English/memory/memory-consolidation.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `memory/memory-consolidation.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `memory`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
