...
> Zdrojový soubor: ai/English/workflows/ai-starter-stack.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `workflows/ai-starter-stack.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
