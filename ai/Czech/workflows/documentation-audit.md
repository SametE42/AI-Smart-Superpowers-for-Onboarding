...
> Zdrojový soubor: ai/English/workflows/documentation-audit.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `workflows/documentation-audit.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `workflows`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
