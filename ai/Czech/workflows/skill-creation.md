...
> Zdrojový soubor: ai/English/workflows/skill-creation.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `workflows/skill-creation.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
