...
> Zdrojový soubor: ai/English/tools/aider/context-files.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `tools/aider/context-files.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
