...
> Zdrojový soubor: ai/English/tools/claude-code/context-files.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `tools/claude-code/context-files.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `tools`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
