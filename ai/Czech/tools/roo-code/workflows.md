...
> Zdrojový soubor: ai/English/tools/roo-code/workflows.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `tools/roo-code/workflows.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
