...
> Zdrojový soubor: ai/English/tools/continue/commands.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `tools/continue/commands.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
