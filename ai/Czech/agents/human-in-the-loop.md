...
> Zdrojový soubor: ai/English/agents/human-in-the-loop.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `agents/human-in-the-loop.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
