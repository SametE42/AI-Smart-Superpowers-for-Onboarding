...
> Zdrojový soubor: ai/English/agents/README.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `agents/README.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
