...
> Zdrojový soubor: ai/English/agents/coding-agents.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `agents/coding-agents.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.
