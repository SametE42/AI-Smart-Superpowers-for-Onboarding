...
> Zdrojový soubor: ai/English/agents/researcher-writer-reviewer.md
> Při rozporu má přednost anglický soubor.

Tato stránka vysvětluje, jak `agents/researcher-writer-reviewer.md` zapadá do AI Agent Operating Manual. Je určena lidem a AI agentům, kteří potřebují plánovat, ověřovat nebo opakovat práci v repozitáři.

## Praktický rozsah

Použijte tuto stránku jako provozní vodítko pro téma `agents`. Nenahrazuje důkazy z repozitáře ani projektové instrukce.
