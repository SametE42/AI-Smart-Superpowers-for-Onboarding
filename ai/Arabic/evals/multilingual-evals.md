...
> ملف المصدر: ai/English/evals/multilingual-evals.md
> عند وجود تعارض، يكون الملف الإنجليزي هو المرجع.

تشرح هذه الصفحة كيف يندرج `evals/multilingual-evals.md` ضمن AI Agent Operating Manual. وهي موجهة إلى الأشخاص ووكلاء الذكاء الاصطناعي الذين يحتاجون إلى تخطيط عمل المستودع أو التحقق منه أو تكراره.
