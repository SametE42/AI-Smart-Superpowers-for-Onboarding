...
> ملف المصدر: ai/English/tools/codex/models.md
> عند وجود تعارض، يكون الملف الإنجليزي هو المرجع.

تشرح هذه الصفحة كيف يندرج `tools/codex/models.md` ضمن AI Agent Operating Manual. وهي موجهة إلى الأشخاص ووكلاء الذكاء الاصطناعي الذين يحتاجون إلى تخطيط عمل المستودع أو التحقق منه أو تكراره.
