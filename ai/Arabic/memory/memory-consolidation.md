...
> ملف المصدر: ai/English/memory/memory-consolidation.md
> عند وجود تعارض، يكون الملف الإنجليزي هو المرجع.

تشرح هذه الصفحة كيف يندرج `memory/memory-consolidation.md` ضمن AI Agent Operating Manual. وهي موجهة إلى الأشخاص ووكلاء الذكاء الاصطناعي الذين يحتاجون إلى تخطيط عمل المستودع أو التحقق منه أو تكراره.

## النطاق العملي

استخدم هذه الصفحة كإرشاد تشغيلي لموضوع `memory`. لا تحل محل أدلة المستودع أو تعليمات المشروع الخاصة.
