...
हे पृष्ठ `tools/codex/commands.md` AI Agent Operating Manual मध्ये कसे बसते ते सांगते; repository कामाचे नियोजन, पडताळणी किंवा पुनरावृत्ती करणाऱ्या लोकांसाठी आणि AI agents साठी.
