...
> Fichier source: ai/English/models/anthropic/README.md
> En cas de divergence, le fichier anglais fait autorité.

Cette page explique comment `models/anthropic/README.md` s'inscrit dans l'AI Agent Operating Manual. Elle s'adresse aux personnes et aux agents d'IA qui doivent planifier, vérifier ou répéter un travail de dépôt.
