...
> Fichier source: ai/English/context-engineering/repository-context.md
> En cas de divergence, le fichier anglais fait autorité.

Cette page explique comment `context-engineering/repository-context.md` s'inscrit dans l'AI Agent Operating Manual. Elle s'adresse aux personnes et aux agents d'IA qui doivent planifier, vérifier ou répéter un travail de dépôt.
