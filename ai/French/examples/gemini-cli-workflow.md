...
> Fichier source: ai/English/examples/gemini-cli-workflow.md
> En cas de divergence, le fichier anglais fait autorité.

Cette page explique comment `examples/gemini-cli-workflow.md` s'inscrit dans l'AI Agent Operating Manual. Elle s'adresse aux personnes et aux agents d'IA qui doivent planifier, vérifier ou répéter un travail de dépôt.
