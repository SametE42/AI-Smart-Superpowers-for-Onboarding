...
> Fichier source: ai/English/workflows/self-evolution-loop.md
> En cas de divergence, le fichier anglais fait autorité.

Cette page explique comment `workflows/self-evolution-loop.md` s'inscrit dans l'AI Agent Operating Manual. Elle s'adresse aux personnes et aux agents d'IA qui doivent planifier, vérifier ou répéter un travail de dépôt.

## Portée pratique

Utilise cette page comme repère opérationnel pour le thème `workflows`. Elle ne remplace pas les preuves du dépôt ni les consignes propres au projet.
