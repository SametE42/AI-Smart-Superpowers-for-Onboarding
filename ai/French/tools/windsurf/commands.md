...
> Fichier source: ai/English/tools/windsurf/commands.md
> En cas de divergence, le fichier anglais fait autorité.

Cette page explique comment `tools/windsurf/commands.md` s'inscrit dans l'AI Agent Operating Manual. Elle s'adresse aux personnes et aux agents d'IA qui doivent planifier, vérifier ou répéter un travail de dépôt.
