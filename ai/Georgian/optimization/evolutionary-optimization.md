...
> წყარო ენა: ინგლისური
> წყარო ფაილი: ai/English/optimization/evolutionary-optimization.md
> განსხვავების შემთხვევაში უპირატესობა აქვს ინგლისურ ფაილს.

ეს გვერდი განმარტავს, როგორ ჯდება `optimization/evolutionary-optimization.md` AI Agent Operating Manual-ში ადამიანებისა და AI agents-ისთვის, რომლებიც repository სამუშაოს გეგმავენ, ამოწმებენ ან იმეორებენ.

## პრაქტიკული ფარგლები

გამოიყენე ეს გვერდი `optimization` თემის ოპერაციულ გზამკვლევად. ის არ ცვლის repository მტკიცებულებებს ან პროექტის ინსტრუქციებს.
