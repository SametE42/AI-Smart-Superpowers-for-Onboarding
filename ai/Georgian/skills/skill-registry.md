...
> წყარო ენა: ინგლისური
> წყარო ფაილი: ai/English/skills/skill-registry.md
> განსხვავების შემთხვევაში უპირატესობა აქვს ინგლისურ ფაილს.

ეს გვერდი განმარტავს, როგორ ჯდება `skills/skill-registry.md` AI Agent Operating Manual-ში ადამიანებისა და AI agents-ისთვის, რომლებიც repository სამუშაოს გეგმავენ, ამოწმებენ ან იმეორებენ.
