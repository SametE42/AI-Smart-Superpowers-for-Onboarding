...
> წყარო ენა: ინგლისური
> წყარო ფაილი: ai/English/models/anthropic/config.md
> განსხვავების შემთხვევაში უპირატესობა აქვს ინგლისურ ფაილს.

ეს გვერდი განმარტავს, როგორ ჯდება `models/anthropic/config.md` AI Agent Operating Manual-ში ადამიანებისა და AI agents-ისთვის, რომლებიც repository სამუშაოს გეგმავენ, ამოწმებენ ან იმეორებენ.
