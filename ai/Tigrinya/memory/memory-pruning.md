...
> ቋንቋ ምንጪ፡ እንግሊዝኛ
> ፋይል ምንጪ: ai/English/memory/memory-pruning.md
> ፍልልይ እንተሃልዩ ፋይል እንግሊዝኛ ይቕድም።

እዚ ገጽ `memory/memory-pruning.md` ኣብ AI Agent Operating Manual ብኸመይ ከምዝኣቱ ይገልጽ፣ ንሰባትን AI agentsን repository ስራሕ ዝውጥኑ፣ ዝምርምሩ ወይ ዝደግሙ።
