...
> ቋንቋ ምንጪ፡ እንግሊዝኛ
> ፋይል ምንጪ: ai/English/templates/WORKFLOW_TEMPLATE.md
> ፍልልይ እንተሃልዩ ፋይል እንግሊዝኛ ይቕድም።

እዚ ገጽ `templates/WORKFLOW_TEMPLATE.md` ኣብ AI Agent Operating Manual ብኸመይ ከምዝኣቱ ይገልጽ፣ ንሰባትን AI agentsን repository ስራሕ ዝውጥኑ፣ ዝምርምሩ ወይ ዝደግሙ።

## ተግባራዊ ወሰን

እዚ ገጽ ን `templates` ከም መምርሒ ስራሕ ተጠቐም። መርትዖ repository ወይ መምርሒ ፕሮጀክት ኣይትክእልን።
