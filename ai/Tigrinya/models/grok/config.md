...
> ቋንቋ ምንጪ፡ እንግሊዝኛ
> ፋይል ምንጪ: ai/English/models/grok/config.md
> ፍልልይ እንተሃልዩ ፋይል እንግሊዝኛ ይቕድም።

እዚ ገጽ `models/grok/config.md` ኣብ AI Agent Operating Manual ብኸመይ ከምዝኣቱ ይገልጽ፣ ንሰባትን AI agentsን repository ስራሕ ዝውጥኑ፣ ዝምርምሩ ወይ ዝደግሙ።
