...
> ቋንቋ ምንጪ፡ እንግሊዝኛ
> ፋይል ምንጪ: ai/English/commands/model-specific-notes.md
> ፍልልይ እንተሃልዩ ፋይል እንግሊዝኛ ይቕድም።

እዚ ገጽ `commands/model-specific-notes.md` ኣብ AI Agent Operating Manual ብኸመይ ከምዝኣቱ ይገልጽ፣ ንሰባትን AI agentsን repository ስራሕ ዝውጥኑ፣ ዝምርምሩ ወይ ዝደግሙ።

## ተግባራዊ ወሰን

እዚ ገጽ ን `commands` ከም መምርሒ ስራሕ ተጠቐም። መርትዖ repository ወይ መምርሒ ፕሮጀክት ኣይትክእልን።
