...
> ቋንቋ ምንጪ፡ እንግሊዝኛ
> ፋይል ምንጪ: ai/English/tools/claude-code/context-files.md
> ፍልልይ እንተሃልዩ ፋይል እንግሊዝኛ ይቕድም።

እዚ ገጽ `tools/claude-code/context-files.md` ኣብ AI Agent Operating Manual ብኸመይ ከምዝኣቱ ይገልጽ፣ ንሰባትን AI agentsን repository ስራሕ ዝውጥኑ፣ ዝምርምሩ ወይ ዝደግሙ።

## ተግባራዊ ወሰን

እዚ ገጽ ን `tools` ከም መምርሒ ስራሕ ተጠቐም። መርትዖ repository ወይ መምርሒ ፕሮጀክት ኣይትክእልን።
