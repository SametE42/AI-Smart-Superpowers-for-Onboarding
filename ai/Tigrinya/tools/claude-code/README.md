...
> ቋንቋ ምንጪ፡ እንግሊዝኛ
> ፋይል ምንጪ: ai/English/tools/claude-code/README.md
> ፍልልይ እንተሃልዩ ፋይል እንግሊዝኛ ይቕድም።

እዚ ገጽ `tools/claude-code/README.md` ኣብ AI Agent Operating Manual ብኸመይ ከምዝኣቱ ይገልጽ፣ ንሰባትን AI agentsን repository ስራሕ ዝውጥኑ፣ ዝምርምሩ ወይ ዝደግሙ።
