...
> ቋንቋ ምንጪ፡ እንግሊዝኛ
> ፋይል ምንጪ: ai/English/tools/opencode/commands.md
> ፍልልይ እንተሃልዩ ፋይል እንግሊዝኛ ይቕድም።

እዚ ገጽ `tools/opencode/commands.md` ኣብ AI Agent Operating Manual ብኸመይ ከምዝኣቱ ይገልጽ፣ ንሰባትን AI agentsን repository ስራሕ ዝውጥኑ፣ ዝምርምሩ ወይ ዝደግሙ።
