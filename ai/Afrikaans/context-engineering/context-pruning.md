...
> Brontaal: Engels
> Bronlêer: ai/English/context-engineering/context-pruning.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `context-engineering/context-pruning.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
