...
> Brontaal: Engels
> Bronlêer: ai/English/memory/three-tier-memory.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `memory/three-tier-memory.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
