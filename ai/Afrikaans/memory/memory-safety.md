...
> Brontaal: Engels
> Bronlêer: ai/English/memory/memory-safety.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `memory/memory-safety.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
