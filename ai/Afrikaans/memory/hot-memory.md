...
> Brontaal: Engels
> Bronlêer: ai/English/memory/hot-memory.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `memory/hot-memory.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
