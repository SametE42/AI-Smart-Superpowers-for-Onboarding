...
> Brontaal: Engels
> Bronlêer: ai/English/commands/gemini-cli.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `commands/gemini-cli.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
