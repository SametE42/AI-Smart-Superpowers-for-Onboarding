...
> Brontaal: Engels
> Bronlêer: ai/English/evals/benchmark-template.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `evals/benchmark-template.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
