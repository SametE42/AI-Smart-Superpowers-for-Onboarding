...
> Brontaal: Engels
> Bronlêer: ai/English/evals/scoring-rubrics.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `evals/scoring-rubrics.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
