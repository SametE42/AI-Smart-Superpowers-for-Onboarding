...
> Brontaal: Engels
> Bronlêer: ai/English/workflows/ai-starter-stack.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `workflows/ai-starter-stack.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
