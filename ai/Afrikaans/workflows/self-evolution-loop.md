...
> Brontaal: Engels
> Bronlêer: ai/English/workflows/self-evolution-loop.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `workflows/self-evolution-loop.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
