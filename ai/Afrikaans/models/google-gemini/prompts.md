...
> Brontaal: Engels
> Bronlêer: ai/English/models/google-gemini/prompts.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `models/google-gemini/prompts.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
