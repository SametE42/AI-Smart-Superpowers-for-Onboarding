...
> Brontaal: Engels
> Bronlêer: ai/English/models/google-gemini/commands.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `models/google-gemini/commands.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.

## Praktiese omvang

Gebruik hierdie bladsy as operasionele leiding vir `models`. Dit vervang nie repository-bewyse of projekspesifieke instruksies nie.
