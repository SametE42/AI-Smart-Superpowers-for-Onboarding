...
> Brontaal: Engels
> Bronlêer: ai/English/tools/claude-code/context-files.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `tools/claude-code/context-files.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.

## Praktiese omvang

Gebruik hierdie bladsy as operasionele leiding vir `tools`. Dit vervang nie repository-bewyse of projekspesifieke instruksies nie.
