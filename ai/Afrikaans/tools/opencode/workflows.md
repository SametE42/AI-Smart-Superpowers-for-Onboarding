...
> Brontaal: Engels
> Bronlêer: ai/English/tools/opencode/workflows.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `tools/opencode/workflows.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
