...
> Brontaal: Engels
> Bronlêer: ai/English/tools/continue/context-files.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `tools/continue/context-files.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
