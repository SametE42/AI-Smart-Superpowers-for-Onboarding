...
> Brontaal: Engels
> Bronlêer: ai/English/tools/roo-code/context-files.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `tools/roo-code/context-files.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
