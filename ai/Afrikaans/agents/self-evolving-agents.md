...
> Brontaal: Engels
> Bronlêer: ai/English/agents/self-evolving-agents.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `agents/self-evolving-agents.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
