...
> Brontaal: Engels
> Bronlêer: ai/English/agents/tool-using-agents.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `agents/tool-using-agents.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
