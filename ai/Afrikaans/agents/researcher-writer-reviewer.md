...
> Brontaal: Engels
> Bronlêer: ai/English/agents/researcher-writer-reviewer.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `agents/researcher-writer-reviewer.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.

## Praktiese omvang

Gebruik hierdie bladsy as operasionele leiding vir `agents`. Dit vervang nie repository-bewyse of projekspesifieke instruksies nie.
