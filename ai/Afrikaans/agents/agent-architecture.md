...
> Brontaal: Engels
> Bronlêer: ai/English/agents/agent-architecture.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `agents/agent-architecture.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
