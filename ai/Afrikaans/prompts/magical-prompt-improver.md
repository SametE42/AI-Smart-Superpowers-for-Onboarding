...
> Brontaal: Engels
> Bronlêer: ai/English/prompts/magical-prompt-improver.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `prompts/magical-prompt-improver.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktiese omvang

Gebruik hierdie bladsy as operasionele leiding vir `prompt improvement`. Dit vervang nie repository-bewyse of projekspesifieke instruksies nie.
