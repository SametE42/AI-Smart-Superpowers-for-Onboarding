...
> Brontaal: Engels
> Bronlêer: ai/English/prompts/accuracy-clause.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `prompts/accuracy-clause.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
