...
> Brontaal: Engels
> Bronlêer: ai/English/prompts/documentation-update.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `prompts/documentation-update.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.

## Praktiese omvang

Gebruik hierdie bladsy as operasionele leiding vir `prompts`. Dit vervang nie repository-bewyse of projekspesifieke instruksies nie.
