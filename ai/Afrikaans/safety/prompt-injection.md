...
> Brontaal: Engels
> Bronlêer: ai/English/safety/prompt-injection.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `safety/prompt-injection.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
