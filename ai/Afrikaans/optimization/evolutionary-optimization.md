...
> Brontaal: Engels
> Bronlêer: ai/English/optimization/evolutionary-optimization.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `optimization/evolutionary-optimization.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.

## Praktiese omvang

Gebruik hierdie bladsy as operasionele leiding vir `optimization`. Dit vervang nie repository-bewyse of projekspesifieke instruksies nie.
