...
> Brontaal: Engels
> Bronlêer: ai/English/optimization/textgrad.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `optimization/textgrad.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
