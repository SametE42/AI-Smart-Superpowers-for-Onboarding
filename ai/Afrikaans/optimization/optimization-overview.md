...
> Brontaal: Engels
> Bronlêer: ai/English/optimization/optimization-overview.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `optimization/optimization-overview.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
