...
> Brontaal: Engels
> Bronlêer: ai/English/templates/EVAL_TEMPLATE.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `templates/EVAL_TEMPLATE.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
