...
> Brontaal: Engels
> Bronlêer: ai/English/examples/claude-code-workflow.md
> By verskille bly die Engelse lêer gesaghebbend.

Hierdie bladsy verduidelik hoe `examples/claude-code-workflow.md` in die AI Agent Operating Manual pas vir mense en AI agents wat repository-werk moet beplan, verifieer of herhaal.
