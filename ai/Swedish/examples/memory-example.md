...
> Källspråk: engelska
> Källfil: ai/English/examples/memory-example.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `examples/memory-example.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
