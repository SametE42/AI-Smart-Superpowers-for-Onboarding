...
> Källspråk: engelska
> Källfil: ai/English/examples/gepa-optimization-example.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `examples/gepa-optimization-example.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `examples`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
