...
> Källspråk: engelska
> Källfil: ai/English/skills/self-evolving-skills.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `skills/self-evolving-skills.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `skills`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
