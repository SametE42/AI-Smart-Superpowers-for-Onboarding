...
Den här sidan förklarar hur `README.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `README.md`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
