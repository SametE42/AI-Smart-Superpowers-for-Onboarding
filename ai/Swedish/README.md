...
> Källspråk: engelska
> Källfil: ai/English/README.md
> Vid avvikelser gäller den engelska filen.

## Purpose of this language folder

Den här sidan förklarar hur `README.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete. This language folder contains the localized AI Agent Operating Manual and mirrors the English folder structure for onboarding, review, prompts, safety, tools, models and templates.

## English source of truth

Vid avvikelser gäller den engelska filen. The English source [`ai/English/README.md`](../English/README.md) remains authoritative, and localized files mirror the English structure.

## How to use this folder

Använd sidan som operativ vägledning för temat `language folder`. Den ersätter inte repositorybevis eller projektspecifika instruktioner. Use this folder to load the language-specific entrypoint before reading safety guidance, agent patterns, context engineering notes, prompt templates, tool guidance and reusable templates.
