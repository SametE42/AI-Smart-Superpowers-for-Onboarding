...
> Källspråk: engelska
> Källfil: ai/English/context-engineering/context-windows.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `context-engineering/context-windows.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
