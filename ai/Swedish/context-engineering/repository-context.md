...
> Källspråk: engelska
> Källfil: ai/English/context-engineering/repository-context.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `context-engineering/repository-context.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `context-engineering`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
