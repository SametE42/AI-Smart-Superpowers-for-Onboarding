...
> Källspråk: engelska
> Källfil: ai/English/context-engineering/context-handoff.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `context-engineering/context-handoff.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
