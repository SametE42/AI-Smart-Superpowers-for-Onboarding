...
> Källspråk: engelska
> Källfil: ai/English/optimization/prompt-optimization.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `optimization/prompt-optimization.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
