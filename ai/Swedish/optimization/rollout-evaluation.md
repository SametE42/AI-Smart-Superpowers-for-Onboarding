...
> Källspråk: engelska
> Källfil: ai/English/optimization/rollout-evaluation.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `optimization/rollout-evaluation.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
