...
> Källspråk: engelska
> Källfil: ai/English/optimization/evolutionary-optimization.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `optimization/evolutionary-optimization.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `optimization`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
