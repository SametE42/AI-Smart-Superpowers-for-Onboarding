...
> Källspråk: engelska
> Källfil: ai/English/safety/eval-safety.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `safety/eval-safety.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
