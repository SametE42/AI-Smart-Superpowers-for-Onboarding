...
> Källspråk: engelska
> Källfil: ai/English/evals/skill-evals.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `evals/skill-evals.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
