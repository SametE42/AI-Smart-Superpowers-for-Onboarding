...
> Källspråk: engelska
> Källfil: ai/English/evals/multilingual-evals.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `evals/multilingual-evals.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
