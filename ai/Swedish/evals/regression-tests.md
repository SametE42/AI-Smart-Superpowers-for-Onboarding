...
> Källspråk: engelska
> Källfil: ai/English/evals/regression-tests.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `evals/regression-tests.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
