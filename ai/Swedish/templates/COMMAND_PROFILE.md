...
> Källspråk: engelska
> Källfil: ai/English/templates/COMMAND_PROFILE.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `templates/COMMAND_PROFILE.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
