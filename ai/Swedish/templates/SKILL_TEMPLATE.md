...
> Källspråk: engelska
> Källfil: ai/English/templates/SKILL_TEMPLATE.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `templates/SKILL_TEMPLATE.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
