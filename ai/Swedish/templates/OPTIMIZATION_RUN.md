...
> Källspråk: engelska
> Källfil: ai/English/templates/OPTIMIZATION_RUN.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `templates/OPTIMIZATION_RUN.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
