...
> Källspråk: engelska
> Källfil: ai/English/agents/tool-using-agents.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `agents/tool-using-agents.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
