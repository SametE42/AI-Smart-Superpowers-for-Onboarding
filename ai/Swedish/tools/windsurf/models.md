...
> Källspråk: engelska
> Källfil: ai/English/tools/windsurf/models.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `tools/windsurf/models.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
