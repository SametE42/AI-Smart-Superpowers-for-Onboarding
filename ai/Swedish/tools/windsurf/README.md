...
> Källspråk: engelska
> Källfil: ai/English/tools/windsurf/README.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `tools/windsurf/README.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
