...
> Källspråk: engelska
> Källfil: ai/English/providers/xai-grok.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `providers/xai-grok.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
