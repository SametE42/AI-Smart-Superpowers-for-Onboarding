...
> Källspråk: engelska
> Källfil: ai/English/providers/fireworks-ai.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `providers/fireworks-ai.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
