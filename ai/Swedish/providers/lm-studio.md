...
> Källspråk: engelska
> Källfil: ai/English/providers/lm-studio.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `providers/lm-studio.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
