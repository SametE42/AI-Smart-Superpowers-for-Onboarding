...
> Källspråk: engelska
> Källfil: ai/English/commands/gemini-cli.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `commands/gemini-cli.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
