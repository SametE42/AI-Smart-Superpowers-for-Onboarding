...
> Källspråk: engelska
> Källfil: ai/English/models/google-gemini/commands.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `models/google-gemini/commands.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `models`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
