...
> Källspråk: engelska
> Källfil: ai/English/models/minimax/config.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `models/minimax/config.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
