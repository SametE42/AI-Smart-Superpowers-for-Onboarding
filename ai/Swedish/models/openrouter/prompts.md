...
> Källspråk: engelska
> Källfil: ai/English/models/openrouter/prompts.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `models/openrouter/prompts.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
