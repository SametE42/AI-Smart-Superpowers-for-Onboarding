...
> Källspråk: engelska
> Källfil: ai/English/memory/memory-safety.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `memory/memory-safety.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
