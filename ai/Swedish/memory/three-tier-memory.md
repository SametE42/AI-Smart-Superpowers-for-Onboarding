...
> Källspråk: engelska
> Källfil: ai/English/memory/three-tier-memory.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `memory/three-tier-memory.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
