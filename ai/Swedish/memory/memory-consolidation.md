...
> Källspråk: engelska
> Källfil: ai/English/memory/memory-consolidation.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `memory/memory-consolidation.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `memory`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
