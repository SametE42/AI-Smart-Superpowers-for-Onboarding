...
> Källspråk: engelska
> Källfil: ai/English/prompts/prompt-refinement.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `prompts/prompt-refinement.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
