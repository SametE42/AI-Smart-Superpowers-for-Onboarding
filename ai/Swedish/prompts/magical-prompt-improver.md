...
> Källspråk: engelska
> Källfil: ai/English/prompts/magical-prompt-improver.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `prompts/magical-prompt-improver.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktisk omfattning

Använd sidan som operativ vägledning för temat `prompt improvement`. Den ersätter inte repositorybevis eller projektspecifika instruktioner.
