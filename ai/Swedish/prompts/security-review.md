...
> Källspråk: engelska
> Källfil: ai/English/prompts/security-review.md
> Vid avvikelser gäller den engelska filen.

Den här sidan förklarar hur `prompts/security-review.md` passar in i AI Agent Operating Manual. Den är skriven för människor och AI-agenter som behöver planera, verifiera eller upprepa repositoryarbete.
