...
> स्रोत फ़ाइल: ai/English/models/qwen/config.md
> अंतर होने पर अंग्रेज़ी फ़ाइल प्राथमिक मानी जाएगी।

यह पृष्ठ बताता है कि `models/qwen/config.md` AI Agent Operating Manual में कैसे फिट होता है। यह उन लोगों और AI agents के लिए है जिन्हें repository कार्य की योजना, जाँच या पुनरावृत्ति करनी होती है।
