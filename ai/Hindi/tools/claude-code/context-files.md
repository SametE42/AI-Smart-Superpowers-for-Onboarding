...
> स्रोत फ़ाइल: ai/English/tools/claude-code/context-files.md
> अंतर होने पर अंग्रेज़ी फ़ाइल प्राथमिक मानी जाएगी।

यह पृष्ठ बताता है कि `tools/claude-code/context-files.md` AI Agent Operating Manual में कैसे फिट होता है। यह उन लोगों और AI agents के लिए है जिन्हें repository कार्य की योजना, जाँच या पुनरावृत्ति करनी होती है।

## व्यावहारिक दायरा

इस पृष्ठ को `tools` विषय के लिए संचालन मार्गदर्शिका के रूप में उपयोग करें। यह repository प्रमाण या परियोजना-विशिष्ट निर्देशों का विकल्प नहीं है।
