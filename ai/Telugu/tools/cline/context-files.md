...
> మూల భాష: ఆంగ్లం
> మూల ఫైల్: ai/English/tools/cline/context-files.md
> తేడా ఉంటే ఆంగ్ల ఫైల్‌కే ప్రాధాన్యం.

ఈ పేజీ `tools/cline/context-files.md` AI Agent Operating Manual లో ఎలా సరిపోతుందో వివరిస్తుంది; repository పనిని ప్రణాళిక చేయడం, ధృవీకరించడం లేదా పునరావృతం చేయడం అవసరమైన మనుషులు మరియు AI agents కోసం.
