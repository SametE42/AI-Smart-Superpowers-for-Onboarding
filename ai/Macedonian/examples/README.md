...
> Изворна датотека: ai/English/examples/README.md
> При разлики, англиската датотека има предност.

Оваа страница објаснува како `examples/README.md` се вклопува во AI Agent Operating Manual. Наменета е за луѓе и AI агенти кои треба да планираат, проверуваат или повторуваат работа во repository.
