...
> Изворна датотека: ai/English/models/qwen/config.md
> При разлики, англиската датотека има предност.

Оваа страница објаснува како `models/qwen/config.md` се вклопува во AI Agent Operating Manual. Наменета е за луѓе и AI агенти кои треба да планираат, проверуваат или повторуваат работа во repository.
