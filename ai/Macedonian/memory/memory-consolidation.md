...
> Изворна датотека: ai/English/memory/memory-consolidation.md
> При разлики, англиската датотека има предност.

Оваа страница објаснува како `memory/memory-consolidation.md` се вклопува во AI Agent Operating Manual. Наменета е за луѓе и AI агенти кои треба да планираат, проверуваат или повторуваат работа во repository.

## Практичен опсег

Користи ја оваа страница како оперативен водич за темата `memory`. Таа не ги заменува доказите од repository или проектните инструкции.
