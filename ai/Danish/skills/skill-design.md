...
> Kildesprog: engelsk
> Kildefil: ai/English/skills/skill-design.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `skills/skill-design.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
