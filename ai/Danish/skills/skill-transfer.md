...
> Kildesprog: engelsk
> Kildefil: ai/English/skills/skill-transfer.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `skills/skill-transfer.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
