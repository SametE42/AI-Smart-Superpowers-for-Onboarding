...
> Kildesprog: engelsk
> Kildefil: ai/English/agents/human-in-the-loop.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `agents/human-in-the-loop.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
