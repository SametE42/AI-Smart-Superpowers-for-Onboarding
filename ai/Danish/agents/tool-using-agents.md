...
> Kildesprog: engelsk
> Kildefil: ai/English/agents/tool-using-agents.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `agents/tool-using-agents.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
