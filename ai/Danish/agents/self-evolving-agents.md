...
> Kildesprog: engelsk
> Kildefil: ai/English/agents/self-evolving-agents.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `agents/self-evolving-agents.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
