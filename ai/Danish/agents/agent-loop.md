...
> Kildesprog: engelsk
> Kildefil: ai/English/agents/agent-loop.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `agents/agent-loop.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
