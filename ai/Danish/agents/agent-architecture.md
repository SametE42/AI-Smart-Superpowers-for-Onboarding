...
> Kildesprog: engelsk
> Kildefil: ai/English/agents/agent-architecture.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `agents/agent-architecture.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
