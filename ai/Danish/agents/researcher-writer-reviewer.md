...
> Kildesprog: engelsk
> Kildefil: ai/English/agents/researcher-writer-reviewer.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `agents/researcher-writer-reviewer.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `agents`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
