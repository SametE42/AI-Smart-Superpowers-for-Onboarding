...
> Kildesprog: engelsk
> Kildefil: ai/English/commands/command-taxonomy.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `commands/command-taxonomy.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
