...
> Kildesprog: engelsk
> Kildefil: ai/English/optimization/optimization-overview.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `optimization/optimization-overview.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
