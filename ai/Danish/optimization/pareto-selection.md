...
> Kildesprog: engelsk
> Kildefil: ai/English/optimization/pareto-selection.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `optimization/pareto-selection.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
