...
> Kildesprog: engelsk
> Kildefil: ai/English/optimization/prompt-optimization.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `optimization/prompt-optimization.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
