...
> Kildesprog: engelsk
> Kildefil: ai/English/optimization/evolutionary-optimization.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `optimization/evolutionary-optimization.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `optimization`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
