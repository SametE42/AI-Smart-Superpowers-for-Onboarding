...
> Kildesprog: engelsk
> Kildefil: ai/English/providers/README.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `providers/README.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
