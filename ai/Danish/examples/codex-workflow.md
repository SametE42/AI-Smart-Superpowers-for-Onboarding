...
> Kildesprog: engelsk
> Kildefil: ai/English/examples/codex-workflow.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `examples/codex-workflow.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
