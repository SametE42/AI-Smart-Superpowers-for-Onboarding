...
> Kildesprog: engelsk
> Kildefil: ai/English/tools/cline/context-files.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `tools/cline/context-files.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
