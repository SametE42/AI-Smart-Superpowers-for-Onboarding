...
> Kildesprog: engelsk
> Kildefil: ai/English/tools/codex/workflows.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `tools/codex/workflows.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
