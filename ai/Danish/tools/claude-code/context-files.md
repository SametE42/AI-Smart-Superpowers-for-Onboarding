...
> Kildesprog: engelsk
> Kildefil: ai/English/tools/claude-code/context-files.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `tools/claude-code/context-files.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `tools`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
