...
> Kildesprog: engelsk
> Kildefil: ai/English/templates/README.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `templates/README.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
