...
> Kildesprog: engelsk
> Kildefil: ai/English/templates/OPTIMIZATION_RUN.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `templates/OPTIMIZATION_RUN.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
