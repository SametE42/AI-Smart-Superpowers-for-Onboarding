...
> Kildesprog: engelsk
> Kildefil: ai/English/templates/WORKFLOW_TEMPLATE.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `templates/WORKFLOW_TEMPLATE.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `templates`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
