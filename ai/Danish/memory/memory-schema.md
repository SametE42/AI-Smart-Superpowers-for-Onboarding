...
> Kildesprog: engelsk
> Kildefil: ai/English/memory/memory-schema.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `memory/memory-schema.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
