...
> Kildesprog: engelsk
> Kildefil: ai/English/memory/memory-consolidation.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `memory/memory-consolidation.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `memory`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
