...
> Kildesprog: engelsk
> Kildefil: ai/English/memory/memory-pruning.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `memory/memory-pruning.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
