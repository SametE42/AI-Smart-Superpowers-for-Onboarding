...
> Kildesprog: engelsk
> Kildefil: ai/English/context-engineering/context-engineering-overview.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `context-engineering/context-engineering-overview.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `context-engineering`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
