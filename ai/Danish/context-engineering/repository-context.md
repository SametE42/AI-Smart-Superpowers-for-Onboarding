...
> Kildesprog: engelsk
> Kildefil: ai/English/context-engineering/repository-context.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `context-engineering/repository-context.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
