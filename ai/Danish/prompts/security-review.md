...
> Kildesprog: engelsk
> Kildefil: ai/English/prompts/security-review.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `prompts/security-review.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
