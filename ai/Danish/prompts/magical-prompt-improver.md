...
> Kildesprog: engelsk
> Kildefil: ai/English/prompts/magical-prompt-improver.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `prompts/magical-prompt-improver.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktisk omfang

Brug siden som operationel vejledning for temaet `prompt improvement`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
