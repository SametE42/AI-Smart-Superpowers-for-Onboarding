...
> Kildesprog: engelsk
> Kildefil: ai/English/prompts/documentation-update.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `prompts/documentation-update.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `prompts`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
