...
> Kildesprog: engelsk
> Kildefil: ai/English/safety/tool-permissions.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `safety/tool-permissions.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
