...
> Kildesprog: engelsk
> Kildefil: ai/English/safety/prompt-injection.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `safety/prompt-injection.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.

## Praktisk omfang

Brug siden som operationel vejledning for temaet `safety`. Den erstatter ikke repository-evidens eller projektspecifikke instruktioner.
