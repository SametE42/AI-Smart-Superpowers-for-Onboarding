...
> Kildesprog: engelsk
> Kildefil: ai/English/safety/human-approval.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `safety/human-approval.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
