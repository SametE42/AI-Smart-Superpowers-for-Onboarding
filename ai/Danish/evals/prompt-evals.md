...
> Kildesprog: engelsk
> Kildefil: ai/English/evals/prompt-evals.md
> Ved afvigelser er den engelske fil gældende.

Denne side forklarer, hvordan `evals/prompt-evals.md` passer ind i AI Agent Operating Manual. Den er skrevet til mennesker og AI-agenter, der skal planlægge, verificere eller gentage repository-arbejde.
