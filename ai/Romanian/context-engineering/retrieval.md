...
> Limba sursă: engleză
> Fișier sursă: ai/English/context-engineering/retrieval.md
> În caz de diferențe, fișierul în engleză rămâne autoritatea.

Această pagină explică modul în care `context-engineering/retrieval.md` se încadrează în AI Agent Operating Manual. Este scrisă pentru oameni și agenți AI care trebuie să planifice, să verifice sau să repete lucru în repository.
