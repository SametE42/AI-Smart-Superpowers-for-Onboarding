...
> Limba sursă: engleză
> Fișier sursă: ai/English/tools/gemini-cli/README.md
> În caz de diferențe, fișierul în engleză rămâne autoritatea.

Această pagină explică modul în care `tools/gemini-cli/README.md` se încadrează în AI Agent Operating Manual. Este scrisă pentru oameni și agenți AI care trebuie să planifice, să verifice sau să repete lucru în repository.
