...
> Limba sursă: engleză
> Fișier sursă: ai/English/prompts/magical-prompt-improver.md
> În caz de diferențe, fișierul în engleză rămâne autoritatea.

Această pagină explică modul în care `prompts/magical-prompt-improver.md` se încadrează în AI Agent Operating Manual. Este scrisă pentru oameni și agenți AI care trebuie să planifice, să verifice sau să repete lucru în repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Domeniu practic

Folosește această pagină ca ghid operațional pentru tema `prompt improvement`. Nu înlocuiește dovezile din repository sau instrucțiunile specifice proiectului.
