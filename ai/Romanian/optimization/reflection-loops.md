...
> Limba sursă: engleză
> Fișier sursă: ai/English/optimization/reflection-loops.md
> În caz de diferențe, fișierul în engleză rămâne autoritatea.

Această pagină explică modul în care `optimization/reflection-loops.md` se încadrează în AI Agent Operating Manual. Este scrisă pentru oameni și agenți AI care trebuie să planifice, să verifice sau să repete lucru în repository.
