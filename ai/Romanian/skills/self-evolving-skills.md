...
> Limba sursă: engleză
> Fișier sursă: ai/English/skills/self-evolving-skills.md
> În caz de diferențe, fișierul în engleză rămâne autoritatea.

Această pagină explică modul în care `skills/self-evolving-skills.md` se încadrează în AI Agent Operating Manual. Este scrisă pentru oameni și agenți AI care trebuie să planifice, să verifice sau să repete lucru în repository.

## Domeniu practic

Folosește această pagină ca ghid operațional pentru tema `skills`. Nu înlocuiește dovezile din repository sau instrucțiunile specifice proiectului.
