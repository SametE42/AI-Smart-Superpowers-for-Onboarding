...
> Limba sursă: engleză
> Fișier sursă: ai/English/providers/moonshot-kimi.md
> În caz de diferențe, fișierul în engleză rămâne autoritatea.

Această pagină explică modul în care `providers/moonshot-kimi.md` se încadrează în AI Agent Operating Manual. Este scrisă pentru oameni și agenți AI care trebuie să planifice, să verifice sau să repete lucru în repository.

## Domeniu practic

Folosește această pagină ca ghid operațional pentru tema `providers`. Nu înlocuiește dovezile din repository sau instrucțiunile specifice proiectului.
