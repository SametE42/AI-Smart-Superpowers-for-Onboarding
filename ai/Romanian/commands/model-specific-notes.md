...
> Limba sursă: engleză
> Fișier sursă: ai/English/commands/model-specific-notes.md
> În caz de diferențe, fișierul în engleză rămâne autoritatea.

Această pagină explică modul în care `commands/model-specific-notes.md` se încadrează în AI Agent Operating Manual. Este scrisă pentru oameni și agenți AI care trebuie să planifice, să verifice sau să repete lucru în repository.

## Domeniu practic

Folosește această pagină ca ghid operațional pentru tema `commands`. Nu înlocuiește dovezile din repository sau instrucțiunile specifice proiectului.
