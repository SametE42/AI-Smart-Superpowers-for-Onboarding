...
Reusable capabilities that can be selected, tested, versioned and improved.

## Zweck

This file gives users a structured, practical reference for `skills/skill-versioning.md`.
