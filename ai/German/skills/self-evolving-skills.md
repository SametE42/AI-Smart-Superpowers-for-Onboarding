...
> Source file: ai/English/skills/self-evolving-skills.md
> Bei Abweichungen ist die englische Datei maßgeblich.

Wiederverwendbare Skills, die begrenzte und testbare Workflows für KI-Agenten definieren.

## Praktischer Scope

Diese Seite beschreibt, wie `skills/self-evolving-skills.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
