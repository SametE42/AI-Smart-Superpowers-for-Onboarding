...
> Source file: ai/English/skills/skill-selection.md
...
Diese Seite beschreibt, wie `skills/skill-selection.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
