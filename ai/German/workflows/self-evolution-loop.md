...
> Source file: ai/English/workflows/self-evolution-loop.md
...
Diese Seite beschreibt, wie `workflows/self-evolution-loop.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
