...
> Source file: ai/English/workflows/agent-optimization.md
...
Diese Seite beschreibt, wie `workflows/agent-optimization.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
