...
> Source file: ai/English/workflows/documentation-audit.md
...
Diese Seite beschreibt, wie `workflows/documentation-audit.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
...
Prüfe, ob Dokumentation aktuell, verlinkt, abgegrenzt und durch Repository-Evidenz belegt ist.
