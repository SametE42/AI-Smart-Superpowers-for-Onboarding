...
> Source file: ai/English/workflows/memory-update.md
...
Diese Seite beschreibt, wie `workflows/memory-update.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
