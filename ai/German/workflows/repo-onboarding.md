...
> Source file: ai/English/workflows/repo-onboarding.md
...
Diese Seite beschreibt, wie `workflows/repo-onboarding.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
...
Führe vom Repository-Scan zu evidenzbasierter KI-Dokumentation, ohne fehlende Fakten zu erfinden.
