...
> Source file: ai/English/workflows/model-comparison.md
...
Diese Seite beschreibt, wie `workflows/model-comparison.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
