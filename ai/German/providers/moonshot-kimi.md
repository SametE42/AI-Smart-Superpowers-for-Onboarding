...
> Source file: ai/English/providers/moonshot-kimi.md
> Bei Abweichungen ist die englische Datei maßgeblich.

Provider-spezifische Hinweise zu APIs, Hosting-Modellen und Kompatibilitätsgrenzen.

## Praktischer Scope

Diese Seite beschreibt, wie `providers/moonshot-kimi.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
