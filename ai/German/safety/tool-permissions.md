...
> Source file: ai/English/safety/tool-permissions.md
...
Diese Seite beschreibt, wie `safety/tool-permissions.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
