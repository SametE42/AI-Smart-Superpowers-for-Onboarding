...
> Source file: ai/English/safety/memory-safety.md
...
Diese Seite beschreibt, wie `safety/memory-safety.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
...
Übernimm nur geprüfte, wiederverwendbare und nicht-sensitive Fakten in dauerhafte Memory.
