...
> Source file: ai/English/optimization/optimization-overview.md
...
Diese Seite beschreibt, wie `optimization/optimization-overview.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
