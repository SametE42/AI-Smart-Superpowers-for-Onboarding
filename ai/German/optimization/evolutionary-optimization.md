...
Prompt, skill and agent optimization including GEPA, DSPy and TextGrad.

## Zweck

This file gives users a structured, practical reference for `optimization/evolutionary-optimization.md`.
