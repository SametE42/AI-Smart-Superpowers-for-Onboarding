...
> Source file: ai/English/models/meta-llama/config.md
...
Diese Seite beschreibt, wie `models/meta-llama/config.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
