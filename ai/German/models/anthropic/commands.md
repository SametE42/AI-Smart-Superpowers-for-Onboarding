...
> Source file: ai/English/models/anthropic/commands.md
...
Diese Seite beschreibt, wie `models/anthropic/commands.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
