...
> Source file: ai/English/models/google-gemini/config.md
...
Diese Seite beschreibt, wie `models/google-gemini/config.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
