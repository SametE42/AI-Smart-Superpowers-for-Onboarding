...
> Source file: ai/English/models/openai/prompts.md
...
Diese Seite beschreibt, wie `models/openai/prompts.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
