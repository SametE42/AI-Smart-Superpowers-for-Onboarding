...
> Source file: ai/English/examples/memory-example.md
...
Diese Seite beschreibt, wie `examples/memory-example.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
