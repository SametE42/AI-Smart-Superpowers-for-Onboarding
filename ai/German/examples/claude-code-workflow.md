...
> Source file: ai/English/examples/claude-code-workflow.md
...
Diese Seite beschreibt, wie `examples/claude-code-workflow.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
