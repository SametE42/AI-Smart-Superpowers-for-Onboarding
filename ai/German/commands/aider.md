...
> Source file: ai/English/commands/aider.md
...
Diese Seite beschreibt, wie `commands/aider.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
