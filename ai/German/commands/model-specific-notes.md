# Model Specific Hinweise

Command systems, slash commands, file references and custom workflow commands.

## Zweck

This file gives users a structured, practical reference for `commands/model-specific-notes.md`.
