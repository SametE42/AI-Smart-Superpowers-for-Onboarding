...
> Source file: ai/English/commands/model-specific-notes.md
...
Diese Seite beschreibt, wie `commands/model-specific-notes.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
