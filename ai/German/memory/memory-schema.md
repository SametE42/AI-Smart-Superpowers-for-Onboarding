...
> Source file: ai/English/memory/memory-schema.md
...
Diese Seite beschreibt, wie `memory/memory-schema.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
