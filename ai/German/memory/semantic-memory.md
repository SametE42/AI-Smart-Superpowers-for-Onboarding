...
> Source file: ai/English/memory/semantic-memory.md
...
Diese Seite beschreibt, wie `memory/semantic-memory.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
