...
> Source file: ai/English/memory/episodic-memory.md
...
Diese Seite beschreibt, wie `memory/episodic-memory.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
