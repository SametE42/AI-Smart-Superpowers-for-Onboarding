...
Agent tools and coding environments that execute commands, edit files and manage context.

## Zweck

This file gives users a structured, practical reference for `tools/README.md`.
