...
> Source file: ai/English/tools/aider/context-files.md
...
Diese Seite beschreibt, wie `tools/aider/context-files.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
