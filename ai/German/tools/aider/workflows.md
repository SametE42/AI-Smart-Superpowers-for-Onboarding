...
> Source file: ai/English/tools/aider/workflows.md
...
Diese Seite beschreibt, wie `tools/aider/workflows.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
