...
> Source file: ai/English/tools/opencode/models.md
...
Diese Seite beschreibt, wie `tools/opencode/models.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
