...
> Source file: ai/English/prompts/documentation-update.md
> Bei Abweichungen ist die englische Datei maßgeblich.

Prompt-Design, Verfeinerung und Review-Muster für repository-bewusste KI-Arbeit.

## Praktischer Scope

Diese Seite beschreibt, wie `prompts/documentation-update.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
