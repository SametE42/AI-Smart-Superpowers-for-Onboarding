...
> Source file: ai/English/agents/self-evolving-agents.md
...
Diese Seite beschreibt, wie `agents/self-evolving-agents.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
