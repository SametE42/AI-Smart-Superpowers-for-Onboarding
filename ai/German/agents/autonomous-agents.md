...
> Source file: ai/English/agents/autonomous-agents.md
...
Diese Seite beschreibt, wie `agents/autonomous-agents.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
...
Nutze Autonomie nur innerhalb geprüfter Berechtigungen, klarer Stop-Bedingungen und sichtbarer Verifikation.
