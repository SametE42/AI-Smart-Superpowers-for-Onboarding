...
> Source file: ai/English/agents/researcher-writer-reviewer.md
...
Diese Seite beschreibt, wie `agents/researcher-writer-reviewer.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
