...
> Source file: ai/English/agents/planner-executor.md
...
Diese Seite beschreibt, wie `agents/planner-executor.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
