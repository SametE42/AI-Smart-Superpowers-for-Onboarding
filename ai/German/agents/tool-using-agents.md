...
> Source file: ai/English/agents/tool-using-agents.md
...
Diese Seite beschreibt, wie `agents/tool-using-agents.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
