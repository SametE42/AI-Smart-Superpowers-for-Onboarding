...
How to package files, retrieval, instructions and working memory for agents.

## Zweck

This file gives users a structured, practical reference for `context-engineering/context-engineering-overview.md`.
