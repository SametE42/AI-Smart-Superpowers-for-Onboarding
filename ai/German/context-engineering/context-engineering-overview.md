...
> Source file: ai/English/context-engineering/context-engineering-overview.md
> Bei Abweichungen ist die englische Datei maßgeblich.

Wie Repository-Kontext, Retrieval, Memory und Arbeitsanweisungen für Agenten gepackt werden.

## Praktischer Scope

Diese Seite beschreibt, wie `context-engineering/context-engineering-overview.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
...
Packe zuerst den kleinsten nützlichen Kontext und lade tiefere Evidenz nur bei Bedarf nach.
