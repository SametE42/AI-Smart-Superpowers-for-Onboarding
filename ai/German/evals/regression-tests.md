...
> Source file: ai/English/evals/regression-tests.md
...
Diese Seite beschreibt, wie `evals/regression-tests.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
