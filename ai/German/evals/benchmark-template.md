...
> Source file: ai/English/evals/benchmark-template.md
...
Diese Seite beschreibt, wie `evals/benchmark-template.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
