...
> Source file: ai/English/evals/tool-use-evals.md
...
Diese Seite beschreibt, wie `evals/tool-use-evals.md` im AI Agent Operating Manual genutzt wird. Sie ist für Menschen und KI-Agenten geschrieben, die Repository-Arbeit planen, prüfen oder wiederholen müssen.
