...
> Kaynak dosya: ai/English/optimization/skill-optimization.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `optimization/skill-optimization.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
