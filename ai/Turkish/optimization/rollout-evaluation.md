...
> Kaynak dosya: ai/English/optimization/rollout-evaluation.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `optimization/rollout-evaluation.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
