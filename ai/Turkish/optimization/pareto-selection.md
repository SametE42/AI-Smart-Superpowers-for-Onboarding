...
> Kaynak dosya: ai/English/optimization/pareto-selection.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `optimization/pareto-selection.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
