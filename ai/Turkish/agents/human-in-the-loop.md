...
> Kaynak dosya: ai/English/agents/human-in-the-loop.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `agents/human-in-the-loop.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
