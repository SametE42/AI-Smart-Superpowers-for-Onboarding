...
> Kaynak dosya: ai/English/models/grok/config.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `models/grok/config.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
