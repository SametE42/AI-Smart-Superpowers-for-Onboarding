...
> Kaynak dosya: ai/English/templates/OPTIMIZATION_RUN.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `templates/OPTIMIZATION_RUN.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
