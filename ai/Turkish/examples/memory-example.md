...
> Kaynak dosya: ai/English/examples/memory-example.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `examples/memory-example.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
