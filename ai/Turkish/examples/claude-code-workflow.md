...
> Kaynak dosya: ai/English/examples/claude-code-workflow.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `examples/claude-code-workflow.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
