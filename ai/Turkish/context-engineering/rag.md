...
> Kaynak dosya: ai/English/context-engineering/rag.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `context-engineering/rag.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
