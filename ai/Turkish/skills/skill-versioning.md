...
> Kaynak dosya: ai/English/skills/skill-versioning.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `skills/skill-versioning.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
