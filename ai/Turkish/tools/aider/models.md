...
> Kaynak dosya: ai/English/tools/aider/models.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `tools/aider/models.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
