...
> Kaynak dosya: ai/English/commands/slash-commands.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `commands/slash-commands.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
