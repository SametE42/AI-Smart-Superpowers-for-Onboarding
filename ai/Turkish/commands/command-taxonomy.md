...
> Kaynak dosya: ai/English/commands/command-taxonomy.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `commands/command-taxonomy.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
