...
> Kaynak dosya: ai/English/providers/fireworks-ai.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `providers/fireworks-ai.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
