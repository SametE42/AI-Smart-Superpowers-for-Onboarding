...
> Kaynak dosya: ai/English/providers/ollama.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `providers/ollama.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
