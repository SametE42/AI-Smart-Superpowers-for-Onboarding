...
> Kaynak dosya: ai/English/prompts/code-review.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `prompts/code-review.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
