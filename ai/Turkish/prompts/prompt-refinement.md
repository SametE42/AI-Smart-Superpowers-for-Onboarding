...
> Kaynak dosya: ai/English/prompts/prompt-refinement.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `prompts/prompt-refinement.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
