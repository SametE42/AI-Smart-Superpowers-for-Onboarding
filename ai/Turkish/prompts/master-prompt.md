...
> Kaynak dosya: ai/English/prompts/master-prompt.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `prompts/master-prompt.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
