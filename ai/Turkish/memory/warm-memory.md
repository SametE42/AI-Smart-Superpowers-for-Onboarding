...
> Kaynak dosya: ai/English/memory/warm-memory.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `memory/warm-memory.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
