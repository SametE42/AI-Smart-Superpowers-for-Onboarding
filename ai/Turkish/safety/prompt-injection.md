...
> Kaynak dosya: ai/English/safety/prompt-injection.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `safety/prompt-injection.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
