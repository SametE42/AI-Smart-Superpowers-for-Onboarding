...
> Kaynak dosya: ai/English/workflows/repo-onboarding.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `workflows/repo-onboarding.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
