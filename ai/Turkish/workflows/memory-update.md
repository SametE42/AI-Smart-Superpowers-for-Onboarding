...
> Kaynak dosya: ai/English/workflows/memory-update.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `workflows/memory-update.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
