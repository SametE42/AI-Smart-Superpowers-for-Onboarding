...
> Kaynak dosya: ai/English/workflows/ai-starter-stack.md
> Tutarsızlık olduğunda İngilizce dosya esas alınır.

Bu sayfa `workflows/ai-starter-stack.md` dosyasının AI Agent Operating Manual içinde nasıl kullanıldığını açıklar. Depo çalışmasını planlaması, doğrulaması veya tekrarlaması gereken insanlar ve yapay zeka ajanları için yazılmıştır.
