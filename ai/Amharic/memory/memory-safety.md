...
> ምንጭ ቋንቋ፡ እንግሊዝኛ
> ምንጭ ፋይል: ai/English/memory/memory-safety.md
> ልዩነት ካለ የእንግሊዝኛው ፋይል ቅድሚያ ይኖረዋል።

ይህ ገጽ `memory/memory-safety.md` በ AI Agent Operating Manual ውስጥ እንዴት እንደሚገባ ይገልጻል፣ ለ repository ሥራ የሚያቅዱ፣ የሚያረጋግጡ ወይም የሚደግሙ ሰዎች እና AI agents።
