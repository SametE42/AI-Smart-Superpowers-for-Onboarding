...
> ምንጭ ቋንቋ፡ እንግሊዝኛ
> ምንጭ ፋይል: ai/English/commands/model-specific-notes.md
> ልዩነት ካለ የእንግሊዝኛው ፋይል ቅድሚያ ይኖረዋል።

ይህ ገጽ `commands/model-specific-notes.md` በ AI Agent Operating Manual ውስጥ እንዴት እንደሚገባ ይገልጻል፣ ለ repository ሥራ የሚያቅዱ፣ የሚያረጋግጡ ወይም የሚደግሙ ሰዎች እና AI agents።

## ተግባራዊ ክልል

ይህን ገጽ ለ `commands` እንደ የሥራ መመሪያ ይጠቀሙ። የ repository ማስረጃን ወይም የፕሮጀክት መመሪያን አይተካም።
