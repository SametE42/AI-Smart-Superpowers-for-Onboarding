...
> ምንጭ ቋንቋ፡ እንግሊዝኛ
> ምንጭ ፋይል: ai/English/commands/slash-commands.md
> ልዩነት ካለ የእንግሊዝኛው ፋይል ቅድሚያ ይኖረዋል።

ይህ ገጽ `commands/slash-commands.md` በ AI Agent Operating Manual ውስጥ እንዴት እንደሚገባ ይገልጻል፣ ለ repository ሥራ የሚያቅዱ፣ የሚያረጋግጡ ወይም የሚደግሙ ሰዎች እና AI agents።
