...
> ምንጭ ቋንቋ፡ እንግሊዝኛ
> ምንጭ ፋይል: ai/English/models/mistral/config.md
> ልዩነት ካለ የእንግሊዝኛው ፋይል ቅድሚያ ይኖረዋል።

ይህ ገጽ `models/mistral/config.md` በ AI Agent Operating Manual ውስጥ እንዴት እንደሚገባ ይገልጻል፣ ለ repository ሥራ የሚያቅዱ፣ የሚያረጋግጡ ወይም የሚደግሙ ሰዎች እና AI agents።
