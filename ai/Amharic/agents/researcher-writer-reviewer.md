...
> ምንጭ ቋንቋ፡ እንግሊዝኛ
> ምንጭ ፋይል: ai/English/agents/researcher-writer-reviewer.md
> ልዩነት ካለ የእንግሊዝኛው ፋይል ቅድሚያ ይኖረዋል።

ይህ ገጽ `agents/researcher-writer-reviewer.md` በ AI Agent Operating Manual ውስጥ እንዴት እንደሚገባ ይገልጻል፣ ለ repository ሥራ የሚያቅዱ፣ የሚያረጋግጡ ወይም የሚደግሙ ሰዎች እና AI agents።

## ተግባራዊ ክልል

ይህን ገጽ ለ `agents` እንደ የሥራ መመሪያ ይጠቀሙ። የ repository ማስረጃን ወይም የፕሮጀክት መመሪያን አይተካም።
