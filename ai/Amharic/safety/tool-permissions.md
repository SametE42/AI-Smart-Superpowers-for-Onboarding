...
> ምንጭ ቋንቋ፡ እንግሊዝኛ
> ምንጭ ፋይል: ai/English/safety/tool-permissions.md
> ልዩነት ካለ የእንግሊዝኛው ፋይል ቅድሚያ ይኖረዋል።

ይህ ገጽ `safety/tool-permissions.md` በ AI Agent Operating Manual ውስጥ እንዴት እንደሚገባ ይገልጻል፣ ለ repository ሥራ የሚያቅዱ፣ የሚያረጋግጡ ወይም የሚደግሙ ሰዎች እና AI agents።

## ተግባራዊ ክልል

ይህን ገጽ ለ `safety` እንደ የሥራ መመሪያ ይጠቀሙ። የ repository ማስረጃን ወይም የፕሮጀክት መመሪያን አይተካም።
