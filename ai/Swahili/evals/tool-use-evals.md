...
> Faili chanzo: ai/English/evals/tool-use-evals.md
> Kukiwa na tofauti, faili la Kiingereza lina kipaumbele.

Ukurasa huu unaeleza jinsi `evals/tool-use-evals.md` inavyoingia kwenye AI Agent Operating Manual. Umeandikwa kwa watu na AI agents wanaohitaji kupanga, kuthibitisha au kurudia kazi ya repository.
