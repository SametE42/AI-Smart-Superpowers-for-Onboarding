...
> Faili chanzo: ai/English/context-engineering/context-engineering-overview.md
> Kukiwa na tofauti, faili la Kiingereza lina kipaumbele.

Ukurasa huu unaeleza jinsi `context-engineering/context-engineering-overview.md` inavyoingia kwenye AI Agent Operating Manual. Umeandikwa kwa watu na AI agents wanaohitaji kupanga, kuthibitisha au kurudia kazi ya repository.

## Wigo wa vitendo

Tumia ukurasa huu kama mwongozo wa uendeshaji kwa mada `context-engineering`. Hauondoi ushahidi wa repository au maagizo maalum ya mradi.
