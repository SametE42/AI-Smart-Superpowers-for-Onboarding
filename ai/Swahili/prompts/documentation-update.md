...
> Faili chanzo: ai/English/prompts/documentation-update.md
> Kukiwa na tofauti, faili la Kiingereza lina kipaumbele.

Ukurasa huu unaeleza jinsi `prompts/documentation-update.md` inavyoingia kwenye AI Agent Operating Manual. Umeandikwa kwa watu na AI agents wanaohitaji kupanga, kuthibitisha au kurudia kazi ya repository.

## Wigo wa vitendo

Tumia ukurasa huu kama mwongozo wa uendeshaji kwa mada `prompts`. Hauondoi ushahidi wa repository au maagizo maalum ya mradi.
