...
> Faili chanzo: ai/English/models/deepseek/config.md
> Kukiwa na tofauti, faili la Kiingereza lina kipaumbele.

Ukurasa huu unaeleza jinsi `models/deepseek/config.md` inavyoingia kwenye AI Agent Operating Manual. Umeandikwa kwa watu na AI agents wanaohitaji kupanga, kuthibitisha au kurudia kazi ya repository.
