...
> Faili chanzo: ai/English/memory/procedural-memory.md
> Kukiwa na tofauti, faili la Kiingereza lina kipaumbele.

Ukurasa huu unaeleza jinsi `memory/procedural-memory.md` inavyoingia kwenye AI Agent Operating Manual. Umeandikwa kwa watu na AI agents wanaohitaji kupanga, kuthibitisha au kurudia kazi ya repository.
