...
> Fayil na tushe: ai/English/prompts/magical-prompt-improver.md
> Idan akwai bambanci, fayil din Turanci ne zai fi karfi.

Wannan shafi yana bayyana yadda `prompts/magical-prompt-improver.md` yake shiga cikin AI Agent Operating Manual. An rubuta shi ga mutane da AI agents da suke bukatar tsara, tabbatarwa ko maimaita aikin repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Iyakar aiki

Yi amfani da wannan shafi a matsayin jagorar aiki ga batun `prompt improvement`. Ba ya maye gurbin shaidar repository ko umarnin musamman na aikin.
