...
> Fayil na tushe: ai/English/evals/evaluation-overview.md
> Idan akwai bambanci, fayil din Turanci ne zai fi karfi.

Wannan shafi yana bayyana yadda `evals/evaluation-overview.md` yake shiga cikin AI Agent Operating Manual. An rubuta shi ga mutane da AI agents da suke bukatar tsara, tabbatarwa ko maimaita aikin repository.

## Iyakar aiki

Yi amfani da wannan shafi a matsayin jagorar aiki ga batun `evals`. Ba ya maye gurbin shaidar repository ko umarnin musamman na aikin.
