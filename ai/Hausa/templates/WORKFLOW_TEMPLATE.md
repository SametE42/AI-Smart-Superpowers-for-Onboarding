...
> Fayil na tushe: ai/English/templates/WORKFLOW_TEMPLATE.md
> Idan akwai bambanci, fayil din Turanci ne zai fi karfi.

Wannan shafi yana bayyana yadda `templates/WORKFLOW_TEMPLATE.md` yake shiga cikin AI Agent Operating Manual. An rubuta shi ga mutane da AI agents da suke bukatar tsara, tabbatarwa ko maimaita aikin repository.

## Iyakar aiki

Yi amfani da wannan shafi a matsayin jagorar aiki ga batun `templates`. Ba ya maye gurbin shaidar repository ko umarnin musamman na aikin.
