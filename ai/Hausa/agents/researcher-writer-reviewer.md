...
> Fayil na tushe: ai/English/agents/researcher-writer-reviewer.md
> Idan akwai bambanci, fayil din Turanci ne zai fi karfi.

Wannan shafi yana bayyana yadda `agents/researcher-writer-reviewer.md` yake shiga cikin AI Agent Operating Manual. An rubuta shi ga mutane da AI agents da suke bukatar tsara, tabbatarwa ko maimaita aikin repository.

## Iyakar aiki

Yi amfani da wannan shafi a matsayin jagorar aiki ga batun `agents`. Ba ya maye gurbin shaidar repository ko umarnin musamman na aikin.
