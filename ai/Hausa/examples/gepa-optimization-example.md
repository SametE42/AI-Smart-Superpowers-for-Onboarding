...
> Fayil na tushe: ai/English/examples/gepa-optimization-example.md
> Idan akwai bambanci, fayil din Turanci ne zai fi karfi.

Wannan shafi yana bayyana yadda `examples/gepa-optimization-example.md` yake shiga cikin AI Agent Operating Manual. An rubuta shi ga mutane da AI agents da suke bukatar tsara, tabbatarwa ko maimaita aikin repository.

## Iyakar aiki

Yi amfani da wannan shafi a matsayin jagorar aiki ga batun `examples`. Ba ya maye gurbin shaidar repository ko umarnin musamman na aikin.
