...
> Fayil na tushe: ai/English/tools/claude-code/README.md
> Idan akwai bambanci, fayil din Turanci ne zai fi karfi.

Wannan shafi yana bayyana yadda `tools/claude-code/README.md` yake shiga cikin AI Agent Operating Manual. An rubuta shi ga mutane da AI agents da suke bukatar tsara, tabbatarwa ko maimaita aikin repository.
