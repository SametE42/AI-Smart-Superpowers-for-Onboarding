...
> Fayil na tushe: ai/English/optimization/evolutionary-optimization.md
> Idan akwai bambanci, fayil din Turanci ne zai fi karfi.

Wannan shafi yana bayyana yadda `optimization/evolutionary-optimization.md` yake shiga cikin AI Agent Operating Manual. An rubuta shi ga mutane da AI agents da suke bukatar tsara, tabbatarwa ko maimaita aikin repository.

## Iyakar aiki

Yi amfani da wannan shafi a matsayin jagorar aiki ga batun `optimization`. Ba ya maye gurbin shaidar repository ko umarnin musamman na aikin.
