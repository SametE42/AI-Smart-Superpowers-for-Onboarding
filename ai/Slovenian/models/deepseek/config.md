...
Ta stran pojasnjuje, kako se `models/deepseek/config.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.
