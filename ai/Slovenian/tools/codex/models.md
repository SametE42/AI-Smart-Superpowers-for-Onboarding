...
Ta stran pojasnjuje, kako se `tools/codex/models.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.
