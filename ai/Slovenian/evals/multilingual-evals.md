...
Ta stran pojasnjuje, kako se `evals/multilingual-evals.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.
