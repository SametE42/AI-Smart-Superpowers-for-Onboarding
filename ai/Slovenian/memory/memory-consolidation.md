...
Ta stran pojasnjuje, kako se `memory/memory-consolidation.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.

## Praktični obseg

Uporabi to stran kot operativno vodilo za temo `memory`. Ne nadomešča dokazov iz repositoryja ali projektnih navodil.
