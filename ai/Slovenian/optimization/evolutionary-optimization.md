...
Ta stran pojasnjuje, kako se `optimization/evolutionary-optimization.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.

## Praktični obseg

Uporabi to stran kot operativno vodilo za temo `optimization`. Ne nadomešča dokazov iz repositoryja ali projektnih navodil.
