...
Ta stran pojasnjuje, kako se `providers/moonshot-kimi.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.

## Praktični obseg

Uporabi to stran kot operativno vodilo za temo `providers`. Ne nadomešča dokazov iz repositoryja ali projektnih navodil.
