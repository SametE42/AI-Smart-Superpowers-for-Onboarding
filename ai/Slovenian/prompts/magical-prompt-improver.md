...
> Izvorna datoteka: ai/English/prompts/magical-prompt-improver.md
> V primeru odstopanj ima prednost angleška datoteka.

Ta stran pojasnjuje, kako se `prompts/magical-prompt-improver.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktični obseg

Uporabi to stran kot operativno vodilo za temo `prompt improvement`. Ne nadomešča dokazov iz repositoryja ali projektnih navodil.
