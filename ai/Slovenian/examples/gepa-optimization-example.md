...
Ta stran pojasnjuje, kako se `examples/gepa-optimization-example.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.

## Praktični obseg

Uporabi to stran kot operativno vodilo za temo `examples`. Ne nadomešča dokazov iz repositoryja ali projektnih navodil.
