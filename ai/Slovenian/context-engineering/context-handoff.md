...
Ta stran pojasnjuje, kako se `context-engineering/context-handoff.md` prilega AI Agent Operating Manual. Namenjena je ljudem in AI agentom, ki morajo načrtovati, preverjati ali ponavljati delo v repositoryju.
