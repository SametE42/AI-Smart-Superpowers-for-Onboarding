...
> ਸਰੋਤ ਭਾਸ਼ਾ: ਅੰਗਰੇਜ਼ੀ
> ਸਰੋਤ ਫਾਈਲ: ai/English/commands/model-specific-notes.md
> ਫਰਕ ਹੋਣ ਤੇ ਅੰਗਰੇਜ਼ੀ ਫਾਈਲ ਪਹਿਲਾਂ ਮੰਨੀ ਜਾਵੇਗੀ।

ਇਹ ਪੰਨਾ ਦੱਸਦਾ ਹੈ ਕਿ `commands/model-specific-notes.md` AI Agent Operating Manual ਵਿੱਚ ਕਿਵੇਂ ਫਿੱਟ ਹੁੰਦਾ ਹੈ; repository ਕੰਮ ਦੀ ਯੋਜਨਾ, ਜਾਂਚ ਜਾਂ ਦੁਹਰਾਈ ਕਰਨ ਵਾਲੇ ਲੋਕਾਂ ਅਤੇ AI agents ਲਈ।

## ਵਿਹਾਰਕ ਦਾਇਰਾ

ਇਸ ਪੰਨੇ ਨੂੰ `commands` ਲਈ ਕਾਰਜਕਾਰੀ ਮਾਰਗਦਰਸ਼ਨ ਵਜੋਂ ਵਰਤੋ। ਇਹ repository ਸਬੂਤ ਜਾਂ ਪ੍ਰੋਜੈਕਟ ਹਦਾਇਤਾਂ ਦੀ ਥਾਂ ਨਹੀਂ ਲੈਂਦਾ।
