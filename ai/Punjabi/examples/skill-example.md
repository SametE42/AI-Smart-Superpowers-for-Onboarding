...
> ਸਰੋਤ ਭਾਸ਼ਾ: ਅੰਗਰੇਜ਼ੀ
> ਸਰੋਤ ਫਾਈਲ: ai/English/examples/skill-example.md
> ਫਰਕ ਹੋਣ ਤੇ ਅੰਗਰੇਜ਼ੀ ਫਾਈਲ ਪਹਿਲਾਂ ਮੰਨੀ ਜਾਵੇਗੀ।

ਇਹ ਪੰਨਾ ਦੱਸਦਾ ਹੈ ਕਿ `examples/skill-example.md` AI Agent Operating Manual ਵਿੱਚ ਕਿਵੇਂ ਫਿੱਟ ਹੁੰਦਾ ਹੈ; repository ਕੰਮ ਦੀ ਯੋਜਨਾ, ਜਾਂਚ ਜਾਂ ਦੁਹਰਾਈ ਕਰਨ ਵਾਲੇ ਲੋਕਾਂ ਅਤੇ AI agents ਲਈ।
