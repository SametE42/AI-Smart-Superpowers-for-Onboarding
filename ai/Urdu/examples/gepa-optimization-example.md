...
> ماخذ زبان: انگریزی
> ماخذ فائل: ai/English/examples/gepa-optimization-example.md
> اختلاف کی صورت میں انگریزی فائل کو ترجیح حاصل ہوگی۔

یہ صفحہ بتاتا ہے کہ `examples/gepa-optimization-example.md` AI Agent Operating Manual میں کیسے استعمال ہوتا ہے۔ یہ ان انسانوں اور AI agents کے لیے ہے جنہیں repository کام کی منصوبہ بندی، تصدیق یا تکرار کرنی ہوتی ہے۔

## عملی دائرہ

اس صفحے کو `examples` موضوع کے لیے عملی رہنما کے طور پر استعمال کریں۔ یہ repository شواہد یا منصوبے کی مخصوص ہدایات کا بدل نہیں۔
