...
> ماخذ زبان: انگریزی
> ماخذ فائل: ai/English/prompts/magical-prompt-improver.md
> اختلاف کی صورت میں انگریزی فائل کو ترجیح حاصل ہوگی۔

یہ صفحہ بتاتا ہے کہ `prompts/magical-prompt-improver.md` AI Agent Operating Manual میں کیسے استعمال ہوتا ہے۔ یہ ان انسانوں اور AI agents کے لیے ہے جنہیں repository کام کی منصوبہ بندی، تصدیق یا تکرار کرنی ہوتی ہے۔ Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## عملی دائرہ

اس صفحے کو `prompt improvement` موضوع کے لیے عملی رہنما کے طور پر استعمال کریں۔ یہ repository شواہد یا منصوبے کی مخصوص ہدایات کا بدل نہیں۔
