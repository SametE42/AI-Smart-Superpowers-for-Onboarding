...
> ماخذ زبان: انگریزی
> ماخذ فائل: ai/English/memory/memory-overview.md
> اختلاف کی صورت میں انگریزی فائل کو ترجیح حاصل ہوگی۔

یہ صفحہ بتاتا ہے کہ `memory/memory-overview.md` AI Agent Operating Manual میں کیسے استعمال ہوتا ہے۔ یہ ان انسانوں اور AI agents کے لیے ہے جنہیں repository کام کی منصوبہ بندی، تصدیق یا تکرار کرنی ہوتی ہے۔
