...
> ماخذ زبان: انگریزی
> ماخذ فائل: ai/English/memory/memory-consolidation.md
> اختلاف کی صورت میں انگریزی فائل کو ترجیح حاصل ہوگی۔

یہ صفحہ بتاتا ہے کہ `memory/memory-consolidation.md` AI Agent Operating Manual میں کیسے استعمال ہوتا ہے۔ یہ ان انسانوں اور AI agents کے لیے ہے جنہیں repository کام کی منصوبہ بندی، تصدیق یا تکرار کرنی ہوتی ہے۔

## عملی دائرہ

اس صفحے کو `memory` موضوع کے لیے عملی رہنما کے طور پر استعمال کریں۔ یہ repository شواہد یا منصوبے کی مخصوص ہدایات کا بدل نہیں۔
