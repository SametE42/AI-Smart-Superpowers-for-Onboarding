...
> Tệp nguồn: ai/English/providers/ollama.md
> Nếu có khác biệt, tệp tiếng Anh là nguồn ưu tiên.

Trang này giải thích cách `providers/ollama.md` phù hợp với AI Agent Operating Manual. Nó dành cho con người và AI agents cần lập kế hoạch, xác minh hoặc lặp lại công việc repository.
