...
> Tệp nguồn: ai/English/memory/memory-consolidation.md
> Nếu có khác biệt, tệp tiếng Anh là nguồn ưu tiên.

Trang này giải thích cách `memory/memory-consolidation.md` phù hợp với AI Agent Operating Manual. Nó dành cho con người và AI agents cần lập kế hoạch, xác minh hoặc lặp lại công việc repository.

## Phạm vi thực tế

Dùng trang này như hướng dẫn vận hành cho chủ đề `memory`. Nó không thay thế bằng chứng repository hoặc hướng dẫn riêng của dự án.
