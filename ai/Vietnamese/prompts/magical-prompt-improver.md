...
> Tệp nguồn: ai/English/prompts/magical-prompt-improver.md
> Nếu có khác biệt, tệp tiếng Anh là nguồn ưu tiên.

Trang này giải thích cách `prompts/magical-prompt-improver.md` phù hợp với AI Agent Operating Manual. Nó dành cho con người và AI agents cần lập kế hoạch, xác minh hoặc lặp lại công việc repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Phạm vi thực tế

Dùng trang này như hướng dẫn vận hành cho chủ đề `prompt improvement`. Nó không thay thế bằng chứng repository hoặc hướng dẫn riêng của dự án.
