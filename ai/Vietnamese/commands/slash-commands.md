...
> Tệp nguồn: ai/English/commands/slash-commands.md
> Nếu có khác biệt, tệp tiếng Anh là nguồn ưu tiên.

Trang này giải thích cách `commands/slash-commands.md` phù hợp với AI Agent Operating Manual. Nó dành cho con người và AI agents cần lập kế hoạch, xác minh hoặc lặp lại công việc repository.
