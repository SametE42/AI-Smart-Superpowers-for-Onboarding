...
> Tệp nguồn: ai/English/safety/tool-permissions.md
> Nếu có khác biệt, tệp tiếng Anh là nguồn ưu tiên.

Trang này giải thích cách `safety/tool-permissions.md` phù hợp với AI Agent Operating Manual. Nó dành cho con người và AI agents cần lập kế hoạch, xác minh hoặc lặp lại công việc repository.

## Phạm vi thực tế

Dùng trang này như hướng dẫn vận hành cho chủ đề `safety`. Nó không thay thế bằng chứng repository hoặc hướng dẫn riêng của dự án.
