...
> ໄຟລ໌ຕົ້ນສະບັບ: ai/English/optimization/evolutionary-optimization.md
> ຖ້າມີຄວາມແຕກຕ່າງ ໃຫ້ຍຶດໄຟລ໌ອັງກິດ.

ໜ້ານີ້ອະທິບາຍວ່າ `optimization/evolutionary-optimization.md` ເຂົ້າກັບ AI Agent Operating Manual ແນວໃດ ສໍາລັບຄົນ ແລະ AI agents ທີ່ຕ້ອງວາງແຜນ ກວດສອບ ຫຼືເຮັດຊໍ້າວຽກ repository.

## ຂອບເຂດປະຕິບັດ

ໃຊ້ໜ້ານີ້ເປັນຄູ່ມືປະຕິບັດສໍາລັບ `optimization`. ມັນບໍ່ແທນຫຼັກຖານ repository ຫຼືຄໍາແນະນໍາໂຄງການ.
