...
> ໄຟລ໌ຕົ້ນສະບັບ: ai/English/workflows/model-comparison.md
> ຖ້າມີຄວາມແຕກຕ່າງ ໃຫ້ຍຶດໄຟລ໌ອັງກິດ.

ໜ້ານີ້ອະທິບາຍວ່າ `workflows/model-comparison.md` ເຂົ້າກັບ AI Agent Operating Manual ແນວໃດ ສໍາລັບຄົນ ແລະ AI agents ທີ່ຕ້ອງວາງແຜນ ກວດສອບ ຫຼືເຮັດຊໍ້າວຽກ repository.
