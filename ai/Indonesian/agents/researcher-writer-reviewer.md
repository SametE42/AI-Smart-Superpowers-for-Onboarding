...
> File sumber: ai/English/agents/researcher-writer-reviewer.md
> Jika ada perbedaan, file Inggris menjadi acuan.

Halaman ini menjelaskan bagaimana `agents/researcher-writer-reviewer.md` masuk ke AI Agent Operating Manual. Ditulis untuk manusia dan AI agents yang perlu merencanakan, memverifikasi, atau mengulang pekerjaan repository.

## Cakupan praktis

Gunakan halaman ini sebagai panduan operasional untuk tema `agents`. Ini tidak menggantikan bukti repository atau instruksi khusus proyek.
