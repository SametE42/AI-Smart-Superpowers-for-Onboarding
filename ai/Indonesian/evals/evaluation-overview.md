...
> File sumber: ai/English/evals/evaluation-overview.md
> Jika ada perbedaan, file Inggris menjadi acuan.

Halaman ini menjelaskan bagaimana `evals/evaluation-overview.md` masuk ke AI Agent Operating Manual. Ditulis untuk manusia dan AI agents yang perlu merencanakan, memverifikasi, atau mengulang pekerjaan repository.

## Cakupan praktis

Gunakan halaman ini sebagai panduan operasional untuk tema `evals`. Ini tidak menggantikan bukti repository atau instruksi khusus proyek.
