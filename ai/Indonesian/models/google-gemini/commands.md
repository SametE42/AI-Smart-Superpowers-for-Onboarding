...
> File sumber: ai/English/models/google-gemini/commands.md
> Jika ada perbedaan, file Inggris menjadi acuan.

Halaman ini menjelaskan bagaimana `models/google-gemini/commands.md` masuk ke AI Agent Operating Manual. Ditulis untuk manusia dan AI agents yang perlu merencanakan, memverifikasi, atau mengulang pekerjaan repository.

## Cakupan praktis

Gunakan halaman ini sebagai panduan operasional untuk tema `models`. Ini tidak menggantikan bukti repository atau instruksi khusus proyek.
