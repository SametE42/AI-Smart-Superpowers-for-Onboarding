...
> File sumber: ai/English/context-engineering/context-engineering-overview.md
> Jika ada perbedaan, file Inggris menjadi acuan.

Halaman ini menjelaskan bagaimana `context-engineering/context-engineering-overview.md` masuk ke AI Agent Operating Manual. Ditulis untuk manusia dan AI agents yang perlu merencanakan, memverifikasi, atau mengulang pekerjaan repository.

## Cakupan praktis

Gunakan halaman ini sebagai panduan operasional untuk tema `context-engineering`. Ini tidak menggantikan bukti repository atau instruksi khusus proyek.
