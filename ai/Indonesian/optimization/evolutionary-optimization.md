...
> File sumber: ai/English/optimization/evolutionary-optimization.md
> Jika ada perbedaan, file Inggris menjadi acuan.

Halaman ini menjelaskan bagaimana `optimization/evolutionary-optimization.md` masuk ke AI Agent Operating Manual. Ditulis untuk manusia dan AI agents yang perlu merencanakan, memverifikasi, atau mengulang pekerjaan repository.

## Cakupan praktis

Gunakan halaman ini sebagai panduan operasional untuk tema `optimization`. Ini tidak menggantikan bukti repository atau instruksi khusus proyek.
