...
> File sumber: ai/English/skills/self-evolving-skills.md
> Jika ada perbedaan, file Inggris menjadi acuan.

Halaman ini menjelaskan bagaimana `skills/self-evolving-skills.md` masuk ke AI Agent Operating Manual. Ditulis untuk manusia dan AI agents yang perlu merencanakan, memverifikasi, atau mengulang pekerjaan repository.

## Cakupan praktis

Gunakan halaman ini sebagai panduan operasional untuk tema `skills`. Ini tidak menggantikan bukti repository atau instruksi khusus proyek.
