...
> File sumber: ai/English/examples/gepa-optimization-example.md
> Jika ada perbedaan, file Inggris menjadi acuan.

Halaman ini menjelaskan bagaimana `examples/gepa-optimization-example.md` masuk ke AI Agent Operating Manual. Ditulis untuk manusia dan AI agents yang perlu merencanakan, memverifikasi, atau mengulang pekerjaan repository.

## Cakupan praktis

Gunakan halaman ini sebagai panduan operasional untuk tema `examples`. Ini tidak menggantikan bukti repository atau instruksi khusus proyek.
