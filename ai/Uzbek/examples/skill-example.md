...
> Manba fayl: ai/English/examples/skill-example.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `examples/skill-example.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
