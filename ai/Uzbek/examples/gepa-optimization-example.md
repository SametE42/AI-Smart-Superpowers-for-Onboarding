...
> Manba fayl: ai/English/examples/gepa-optimization-example.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `examples/gepa-optimization-example.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `examples` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
