...
> Manba fayl: ai/English/workflows/documentation-audit.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `workflows/documentation-audit.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `workflows` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
