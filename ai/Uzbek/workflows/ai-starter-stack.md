...
> Manba fayl: ai/English/workflows/ai-starter-stack.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `workflows/ai-starter-stack.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
