...
> Manba fayl: ai/English/workflows/self-evolution-loop.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `workflows/self-evolution-loop.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
