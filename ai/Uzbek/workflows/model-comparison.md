...
> Manba fayl: ai/English/workflows/model-comparison.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `workflows/model-comparison.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
