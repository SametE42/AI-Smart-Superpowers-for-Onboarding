...
> Manba fayl: ai/English/workflows/code-review.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `workflows/code-review.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
