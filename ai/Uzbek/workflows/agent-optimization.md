...
> Manba fayl: ai/English/workflows/agent-optimization.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `workflows/agent-optimization.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
