...
> Manba fayl: ai/English/context-engineering/context-pruning.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `context-engineering/context-pruning.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
