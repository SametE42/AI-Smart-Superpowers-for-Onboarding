...
> Manba fayl: ai/English/context-engineering/context-engineering-overview.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `context-engineering/context-engineering-overview.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `context-engineering` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
