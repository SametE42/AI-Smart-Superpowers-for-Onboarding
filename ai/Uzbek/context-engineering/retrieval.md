...
> Manba fayl: ai/English/context-engineering/retrieval.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `context-engineering/retrieval.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
