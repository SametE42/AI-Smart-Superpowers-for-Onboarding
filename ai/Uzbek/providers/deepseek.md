...
> Manba fayl: ai/English/providers/deepseek.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `providers/deepseek.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
