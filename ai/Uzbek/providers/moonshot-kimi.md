...
> Manba fayl: ai/English/providers/moonshot-kimi.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `providers/moonshot-kimi.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `providers` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
