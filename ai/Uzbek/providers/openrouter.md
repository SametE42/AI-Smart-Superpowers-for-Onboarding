...
> Manba fayl: ai/English/providers/openrouter.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `providers/openrouter.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
