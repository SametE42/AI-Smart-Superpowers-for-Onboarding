...
> Manba fayl: ai/English/providers/fireworks-ai.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `providers/fireworks-ai.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
