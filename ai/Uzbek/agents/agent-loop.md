...
> Manba fayl: ai/English/agents/agent-loop.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `agents/agent-loop.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
