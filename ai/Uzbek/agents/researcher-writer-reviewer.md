...
> Manba fayl: ai/English/agents/researcher-writer-reviewer.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `agents/researcher-writer-reviewer.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `agents` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
