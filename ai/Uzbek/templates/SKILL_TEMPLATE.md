...
> Manba fayl: ai/English/templates/SKILL_TEMPLATE.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `templates/SKILL_TEMPLATE.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
