...
> Manba fayl: ai/English/templates/EVAL_TEMPLATE.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `templates/EVAL_TEMPLATE.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
