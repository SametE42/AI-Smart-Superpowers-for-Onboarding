...
> Manba fayl: ai/English/templates/COMMAND_PROFILE.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `templates/COMMAND_PROFILE.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
