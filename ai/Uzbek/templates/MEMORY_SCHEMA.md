...
> Manba fayl: ai/English/templates/MEMORY_SCHEMA.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `templates/MEMORY_SCHEMA.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
