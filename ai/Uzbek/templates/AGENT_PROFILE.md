...
> Manba fayl: ai/English/templates/AGENT_PROFILE.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `templates/AGENT_PROFILE.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
