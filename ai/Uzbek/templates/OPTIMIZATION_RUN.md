...
> Manba fayl: ai/English/templates/OPTIMIZATION_RUN.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `templates/OPTIMIZATION_RUN.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
