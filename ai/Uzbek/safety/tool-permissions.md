...
> Manba fayl: ai/English/safety/tool-permissions.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `safety/tool-permissions.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `safety` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
