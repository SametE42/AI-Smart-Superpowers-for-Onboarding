...
> Manba fayl: ai/English/safety/README.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `safety/README.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
