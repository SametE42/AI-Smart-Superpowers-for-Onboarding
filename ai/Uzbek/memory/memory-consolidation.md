...
> Manba fayl: ai/English/memory/memory-consolidation.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `memory/memory-consolidation.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `memory` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
