...
> Manba fayl: ai/English/memory/semantic-memory.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `memory/semantic-memory.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
