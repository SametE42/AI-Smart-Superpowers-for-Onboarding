...
> Manba fayl: ai/English/evals/regression-tests.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `evals/regression-tests.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
