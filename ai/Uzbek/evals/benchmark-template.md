...
> Manba fayl: ai/English/evals/benchmark-template.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `evals/benchmark-template.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
