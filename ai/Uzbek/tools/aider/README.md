...
> Manba fayl: ai/English/tools/aider/README.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `tools/aider/README.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
