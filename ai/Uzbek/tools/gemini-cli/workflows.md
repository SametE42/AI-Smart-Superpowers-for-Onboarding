...
> Manba fayl: ai/English/tools/gemini-cli/workflows.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `tools/gemini-cli/workflows.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
