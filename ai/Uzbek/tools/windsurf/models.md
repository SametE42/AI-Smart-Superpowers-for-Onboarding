...
> Manba fayl: ai/English/tools/windsurf/models.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `tools/windsurf/models.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
