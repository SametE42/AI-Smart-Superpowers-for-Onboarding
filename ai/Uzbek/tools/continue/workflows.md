...
> Manba fayl: ai/English/tools/continue/workflows.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `tools/continue/workflows.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
