...
> Manba fayl: ai/English/tools/opencode/models.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `tools/opencode/models.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
