...
> Manba fayl: ai/English/tools/claude-code/models.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `tools/claude-code/models.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
