...
> Manba fayl: ai/English/tools/cursor/README.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `tools/cursor/README.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
