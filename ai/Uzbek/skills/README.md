...
> Manba fayl: ai/English/skills/README.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `skills/README.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
