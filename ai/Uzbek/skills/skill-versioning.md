...
> Manba fayl: ai/English/skills/skill-versioning.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `skills/skill-versioning.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
