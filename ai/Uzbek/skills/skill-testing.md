...
> Manba fayl: ai/English/skills/skill-testing.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `skills/skill-testing.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
