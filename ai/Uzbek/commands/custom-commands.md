...
> Manba fayl: ai/English/commands/custom-commands.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `commands/custom-commands.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
