...
> Manba fayl: ai/English/commands/gemini-cli.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `commands/gemini-cli.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
