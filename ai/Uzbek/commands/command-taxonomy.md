...
> Manba fayl: ai/English/commands/command-taxonomy.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `commands/command-taxonomy.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
