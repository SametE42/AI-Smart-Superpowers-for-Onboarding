...
> Manba fayl: ai/English/commands/cursor.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `commands/cursor.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
