...
> Manba fayl: ai/English/commands/model-specific-notes.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `commands/model-specific-notes.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `commands` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
