...
> Manba fayl: ai/English/optimization/reflection-loops.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `optimization/reflection-loops.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
