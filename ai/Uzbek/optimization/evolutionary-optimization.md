...
> Manba fayl: ai/English/optimization/evolutionary-optimization.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `optimization/evolutionary-optimization.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `optimization` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
