...
> Manba fayl: ai/English/optimization/skill-optimization.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `optimization/skill-optimization.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
