...
> Manba fayl: ai/English/optimization/prompt-optimization.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `optimization/prompt-optimization.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
