...
> Manba fayl: ai/English/optimization/optimization-overview.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `optimization/optimization-overview.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
