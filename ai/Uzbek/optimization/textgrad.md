...
> Manba fayl: ai/English/optimization/textgrad.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `optimization/textgrad.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
