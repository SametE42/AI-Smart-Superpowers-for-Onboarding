...
> Manba fayl: ai/English/models/openai/config.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/openai/config.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
