...
> Manba fayl: ai/English/models/deepseek/evals.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/deepseek/evals.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
