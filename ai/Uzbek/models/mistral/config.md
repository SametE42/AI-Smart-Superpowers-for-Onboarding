...
> Manba fayl: ai/English/models/mistral/config.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/mistral/config.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
