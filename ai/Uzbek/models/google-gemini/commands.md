...
> Manba fayl: ai/English/models/google-gemini/commands.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/google-gemini/commands.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `models` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
