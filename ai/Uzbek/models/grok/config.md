...
> Manba fayl: ai/English/models/grok/config.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/grok/config.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
