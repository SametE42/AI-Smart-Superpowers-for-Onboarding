...
> Manba fayl: ai/English/models/kimi/prompts.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/kimi/prompts.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
