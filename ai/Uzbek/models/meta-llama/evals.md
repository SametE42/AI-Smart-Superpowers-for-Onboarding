...
> Manba fayl: ai/English/models/meta-llama/evals.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/meta-llama/evals.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
