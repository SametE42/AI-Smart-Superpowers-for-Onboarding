...
> Manba fayl: ai/English/models/minimax/evals.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `models/minimax/evals.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
