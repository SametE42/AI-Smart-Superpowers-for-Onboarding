...
> Manba fayl: ai/English/prompts/documentation-update.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `prompts/documentation-update.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.

## Amaliy doira

Bu sahifani `prompts` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
