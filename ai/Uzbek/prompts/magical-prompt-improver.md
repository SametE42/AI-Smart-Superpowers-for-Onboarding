...
> Manba fayl: ai/English/prompts/magical-prompt-improver.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `prompts/magical-prompt-improver.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Amaliy doira

Bu sahifani `prompt improvement` uchun operatsion yo'riqnoma sifatida ishlating. U repository dalillari yoki loyiha ko'rsatmalarini almashtirmaydi.
