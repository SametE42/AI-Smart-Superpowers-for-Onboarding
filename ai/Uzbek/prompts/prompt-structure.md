...
> Manba fayl: ai/English/prompts/prompt-structure.md
> Farq bo'lsa, inglizcha fayl ustuvor.

Bu sahifa `prompts/prompt-structure.md` AI Agent Operating Manual ichida qanday ishlashini tushuntiradi; repository ishini rejalash, tekshirish yoki takrorlash kerak bo'lgan odamlar va AI agents uchun.
