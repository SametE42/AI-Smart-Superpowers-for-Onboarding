...
> ഉറവിട ഭാഷ: ഇംഗ്ലീഷ്
> ഉറവിട ഫയൽ: ai/English/tools/roo-code/README.md
> വ്യത്യാസമുണ്ടെങ്കിൽ ഇംഗ്ലീഷ് ഫയലിനാണ് മുൻഗണന.

ഈ പേജ് `tools/roo-code/README.md` AI Agent Operating Manual-ൽ എങ്ങനെ ചേരുന്നു എന്ന് വിശദീകരിക്കുന്നു; repository ജോലി പദ്ധതിയിടുന്ന, പരിശോധിക്കുന്ന, ആവർത്തിക്കുന്ന ആളുകൾക്കും AI agents-ക്കും വേണ്ടിയുള്ളതാണ്.
