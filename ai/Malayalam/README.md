...
ഈ പേജ് `README.md` AI Agent Operating Manual-ൽ എങ്ങനെ ചേരുന്നു എന്ന് വിശദീകരിക്കുന്നു; repository ജോലി പദ്ധതിയിടുന്ന, പരിശോധിക്കുന്ന, ആവർത്തിക്കുന്ന ആളുകൾക്കും AI agents-ക്കും വേണ്ടിയുള്ളതാണ്.

## പ്രായോഗിക പരിധി

ഈ പേജ് `README.md` വിഷയത്തിനുള്ള പ്രവർത്തന മാർഗ്ഗരേഖയായി ഉപയോഗിക്കുക. ഇത് repository തെളിവുകളെയോ project നിർദ്ദേശങ്ങളെയോ പകരംവയ്ക്കുന്നില്ല.
