...
> Lähdekieli: englanti
> Lähdetiedosto: ai/English/optimization/evolutionary-optimization.md
> Ristiriitatilanteissa englanninkielinen tiedosto on ratkaiseva.

Tämä sivu selittää, miten `optimization/evolutionary-optimization.md` liittyy AI Agent Operating Manual -kokonaisuuteen. Se on tarkoitettu ihmisille ja AI-agenteille, joiden täytyy suunnitella, tarkistaa tai toistaa repository-työtä.

## Käytännön laajuus

Käytä tätä sivua operatiivisena ohjeena aiheelle `optimization`. Se ei korvaa repositoryn näyttöä tai projektikohtaisia ohjeita.
