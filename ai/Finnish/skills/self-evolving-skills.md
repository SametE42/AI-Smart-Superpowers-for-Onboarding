...
> Lähdekieli: englanti
> Lähdetiedosto: ai/English/skills/self-evolving-skills.md
> Ristiriitatilanteissa englanninkielinen tiedosto on ratkaiseva.

Tämä sivu selittää, miten `skills/self-evolving-skills.md` liittyy AI Agent Operating Manual -kokonaisuuteen. Se on tarkoitettu ihmisille ja AI-agenteille, joiden täytyy suunnitella, tarkistaa tai toistaa repository-työtä.

## Käytännön laajuus

Käytä tätä sivua operatiivisena ohjeena aiheelle `skills`. Se ei korvaa repositoryn näyttöä tai projektikohtaisia ohjeita.
