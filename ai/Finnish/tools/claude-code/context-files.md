...
> Lähdekieli: englanti
> Lähdetiedosto: ai/English/tools/claude-code/context-files.md
> Ristiriitatilanteissa englanninkielinen tiedosto on ratkaiseva.

Tämä sivu selittää, miten `tools/claude-code/context-files.md` liittyy AI Agent Operating Manual -kokonaisuuteen. Se on tarkoitettu ihmisille ja AI-agenteille, joiden täytyy suunnitella, tarkistaa tai toistaa repository-työtä.

## Käytännön laajuus

Käytä tätä sivua operatiivisena ohjeena aiheelle `tools`. Se ei korvaa repositoryn näyttöä tai projektikohtaisia ohjeita.
