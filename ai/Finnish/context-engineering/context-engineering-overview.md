...
> Lähdekieli: englanti
> Lähdetiedosto: ai/English/context-engineering/context-engineering-overview.md
> Ristiriitatilanteissa englanninkielinen tiedosto on ratkaiseva.

Tämä sivu selittää, miten `context-engineering/context-engineering-overview.md` liittyy AI Agent Operating Manual -kokonaisuuteen. Se on tarkoitettu ihmisille ja AI-agenteille, joiden täytyy suunnitella, tarkistaa tai toistaa repository-työtä.

## Käytännön laajuus

Käytä tätä sivua operatiivisena ohjeena aiheelle `context-engineering`. Se ei korvaa repositoryn näyttöä tai projektikohtaisia ohjeita.
