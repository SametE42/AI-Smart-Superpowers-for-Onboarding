...
> Lähdekieli: englanti
> Lähdetiedosto: ai/English/examples/gepa-optimization-example.md
> Ristiriitatilanteissa englanninkielinen tiedosto on ratkaiseva.

Tämä sivu selittää, miten `examples/gepa-optimization-example.md` liittyy AI Agent Operating Manual -kokonaisuuteen. Se on tarkoitettu ihmisille ja AI-agenteille, joiden täytyy suunnitella, tarkistaa tai toistaa repository-työtä.

## Käytännön laajuus

Käytä tätä sivua operatiivisena ohjeena aiheelle `examples`. Se ei korvaa repositoryn näyttöä tai projektikohtaisia ohjeita.
