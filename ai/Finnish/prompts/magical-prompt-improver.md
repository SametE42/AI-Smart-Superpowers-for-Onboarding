...
> Lähdekieli: englanti
> Lähdetiedosto: ai/English/prompts/magical-prompt-improver.md
> Ristiriitatilanteissa englanninkielinen tiedosto on ratkaiseva.

Tämä sivu selittää, miten `prompts/magical-prompt-improver.md` liittyy AI Agent Operating Manual -kokonaisuuteen. Se on tarkoitettu ihmisille ja AI-agenteille, joiden täytyy suunnitella, tarkistaa tai toistaa repository-työtä. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Käytännön laajuus

Käytä tätä sivua operatiivisena ohjeena aiheelle `prompt improvement`. Se ei korvaa repositoryn näyttöä tai projektikohtaisia ohjeita.
