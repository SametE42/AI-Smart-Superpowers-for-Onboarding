...
> ภาษาต้นฉบับ: อังกฤษ
> ไฟล์ต้นฉบับ: ai/English/prompts/documentation-update.md
> หากมีความแตกต่าง ให้ยึดไฟล์ภาษาอังกฤษเป็นหลัก

หน้านี้อธิบายว่า `prompts/documentation-update.md` อยู่ใน AI Agent Operating Manual อย่างไร เขียนไว้สำหรับมนุษย์และ AI agents ที่ต้องวางแผน ตรวจสอบ หรือทำซ้ำงานใน repository

## ขอบเขตเชิงปฏิบัติ

ใช้หน้านี้เป็นแนวทางปฏิบัติสำหรับหัวข้อ `prompts` ไม่ใช่สิ่งทดแทนหลักฐานใน repository หรือคำสั่งเฉพาะของโครงการ
