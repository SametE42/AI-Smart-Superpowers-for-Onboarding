...
> ภาษาต้นฉบับ: อังกฤษ
> ไฟล์ต้นฉบับ: ai/English/models/deepseek/prompts.md
> หากมีความแตกต่าง ให้ยึดไฟล์ภาษาอังกฤษเป็นหลัก

หน้านี้อธิบายว่า `models/deepseek/prompts.md` อยู่ใน AI Agent Operating Manual อย่างไร เขียนไว้สำหรับมนุษย์และ AI agents ที่ต้องวางแผน ตรวจสอบ หรือทำซ้ำงานใน repository
