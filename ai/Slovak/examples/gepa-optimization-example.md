...
> Zdrojový súbor: ai/English/examples/gepa-optimization-example.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `examples/gepa-optimization-example.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `examples`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
