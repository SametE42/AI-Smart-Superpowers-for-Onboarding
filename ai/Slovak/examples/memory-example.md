...
> Zdrojový súbor: ai/English/examples/memory-example.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `examples/memory-example.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
