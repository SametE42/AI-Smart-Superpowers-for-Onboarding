...
> Zdrojový súbor: ai/English/commands/codex.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `commands/codex.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
