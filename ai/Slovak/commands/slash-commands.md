...
> Zdrojový súbor: ai/English/commands/slash-commands.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `commands/slash-commands.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
