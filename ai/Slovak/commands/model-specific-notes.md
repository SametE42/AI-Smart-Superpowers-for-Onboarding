...
> Zdrojový súbor: ai/English/commands/model-specific-notes.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `commands/model-specific-notes.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `commands`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
