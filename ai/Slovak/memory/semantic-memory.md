...
> Zdrojový súbor: ai/English/memory/semantic-memory.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `memory/semantic-memory.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
