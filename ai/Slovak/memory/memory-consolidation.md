...
> Zdrojový súbor: ai/English/memory/memory-consolidation.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `memory/memory-consolidation.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `memory`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
