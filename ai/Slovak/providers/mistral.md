...
> Zdrojový súbor: ai/English/providers/mistral.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `providers/mistral.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
