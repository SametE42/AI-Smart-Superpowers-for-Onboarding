...
> Zdrojový súbor: ai/English/providers/ollama.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `providers/ollama.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
