...
> Zdrojový súbor: ai/English/providers/openai.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `providers/openai.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
