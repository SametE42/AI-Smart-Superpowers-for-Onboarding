...
> Zdrojový súbor: ai/English/providers/moonshot-kimi.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `providers/moonshot-kimi.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `providers`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
