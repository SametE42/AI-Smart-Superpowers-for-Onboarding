...
> Zdrojový súbor: ai/English/models/qwen/config.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `models/qwen/config.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
