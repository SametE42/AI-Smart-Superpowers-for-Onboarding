...
> Zdrojový súbor: ai/English/models/kimi/prompts.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `models/kimi/prompts.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
