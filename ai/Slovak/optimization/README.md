...
> Zdrojový súbor: ai/English/optimization/README.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `optimization/README.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
