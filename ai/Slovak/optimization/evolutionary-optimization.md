...
> Zdrojový súbor: ai/English/optimization/evolutionary-optimization.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `optimization/evolutionary-optimization.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `optimization`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
