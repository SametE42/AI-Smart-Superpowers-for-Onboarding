...
> Zdrojový súbor: ai/English/skills/skill-selection.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `skills/skill-selection.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
