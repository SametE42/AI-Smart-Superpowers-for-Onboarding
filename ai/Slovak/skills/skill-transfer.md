...
> Zdrojový súbor: ai/English/skills/skill-transfer.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `skills/skill-transfer.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
