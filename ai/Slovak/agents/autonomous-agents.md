...
> Zdrojový súbor: ai/English/agents/autonomous-agents.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `agents/autonomous-agents.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
