...
> Zdrojový súbor: ai/English/agents/planner-executor.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `agents/planner-executor.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
