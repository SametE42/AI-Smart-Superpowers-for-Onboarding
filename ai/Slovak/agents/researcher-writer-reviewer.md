...
> Zdrojový súbor: ai/English/agents/researcher-writer-reviewer.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `agents/researcher-writer-reviewer.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `agents`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
