...
> Zdrojový súbor: ai/English/agents/coding-agents.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `agents/coding-agents.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
