...
> Zdrojový súbor: ai/English/workflows/documentation-audit.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `workflows/documentation-audit.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `workflows`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
