...
> Zdrojový súbor: ai/English/workflows/self-evolution-loop.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `workflows/self-evolution-loop.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
