...
> Zdrojový súbor: ai/English/workflows/model-comparison.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `workflows/model-comparison.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
