...
> Zdrojový súbor: ai/English/safety/tool-permissions.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `safety/tool-permissions.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `safety`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
