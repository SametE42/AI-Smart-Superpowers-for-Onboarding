...
> Zdrojový súbor: ai/English/prompts/magical-prompt-improver.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `prompts/magical-prompt-improver.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `prompt improvement`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
