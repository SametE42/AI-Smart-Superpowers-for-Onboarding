...
> Zdrojový súbor: ai/English/prompts/accuracy-clause.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `prompts/accuracy-clause.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
