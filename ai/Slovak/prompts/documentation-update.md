...
> Zdrojový súbor: ai/English/prompts/documentation-update.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `prompts/documentation-update.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `prompts`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
