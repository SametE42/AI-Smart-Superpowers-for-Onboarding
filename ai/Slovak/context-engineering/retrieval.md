...
> Zdrojový súbor: ai/English/context-engineering/retrieval.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `context-engineering/retrieval.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
