...
> Zdrojový súbor: ai/English/context-engineering/context-pruning.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `context-engineering/context-pruning.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
