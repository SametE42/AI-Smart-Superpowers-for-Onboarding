...
> Zdrojový súbor: ai/English/templates/README.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `templates/README.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
