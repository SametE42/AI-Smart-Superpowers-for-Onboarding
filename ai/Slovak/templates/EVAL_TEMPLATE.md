...
> Zdrojový súbor: ai/English/templates/EVAL_TEMPLATE.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `templates/EVAL_TEMPLATE.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
