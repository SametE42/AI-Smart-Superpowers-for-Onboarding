...
> Zdrojový súbor: ai/English/templates/WORKFLOW_TEMPLATE.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `templates/WORKFLOW_TEMPLATE.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `templates`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
