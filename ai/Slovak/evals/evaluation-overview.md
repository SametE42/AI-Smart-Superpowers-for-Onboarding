...
> Zdrojový súbor: ai/English/evals/evaluation-overview.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `evals/evaluation-overview.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.

## Praktický rozsah

Použi túto stránku ako operačné vodidlo pre tému `evals`. Nenahrádza dôkazy z repozitára ani projektové inštrukcie.
