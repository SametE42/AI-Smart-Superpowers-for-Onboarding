...
> Zdrojový súbor: ai/English/evals/benchmark-template.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `evals/benchmark-template.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
