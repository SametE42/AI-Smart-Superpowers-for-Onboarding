...
> Zdrojový súbor: ai/English/tools/windsurf/context-files.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `tools/windsurf/context-files.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
