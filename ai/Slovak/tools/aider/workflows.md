...
> Zdrojový súbor: ai/English/tools/aider/workflows.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `tools/aider/workflows.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
