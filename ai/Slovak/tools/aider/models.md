...
> Zdrojový súbor: ai/English/tools/aider/models.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `tools/aider/models.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
