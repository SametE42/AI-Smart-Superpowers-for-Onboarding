...
> Zdrojový súbor: ai/English/tools/opencode/commands.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `tools/opencode/commands.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
