...
> Zdrojový súbor: ai/English/tools/codex/workflows.md
> Pri rozpore má prednosť anglický súbor.

Táto stránka vysvetľuje, ako `tools/codex/workflows.md` zapadá do AI Agent Operating Manual. Je určená ľuďom a AI agentom, ktorí potrebujú plánovať, overovať alebo opakovať prácu v repozitári.
