...
> سرچينه ژبه: انګليسي
> سرچينه فایل: ai/English/models/qwen/config.md
> که توپير وي، انګليسي فایل لومړيتوب لري.

دا پاڼه ښيي چې `models/qwen/config.md` په AI Agent Operating Manual کې څنګه ځای نيسي؛ د هغو خلکو او AI agents لپاره چې repository کار پلانوي، تاييدوي يا تکراروي.
