...
> سرچينه ژبه: انګليسي
> سرچينه فایل: ai/English/commands/model-specific-notes.md
> که توپير وي، انګليسي فایل لومړيتوب لري.

دا پاڼه ښيي چې `commands/model-specific-notes.md` په AI Agent Operating Manual کې څنګه ځای نيسي؛ د هغو خلکو او AI agents لپاره چې repository کار پلانوي، تاييدوي يا تکراروي.

## عملي ساحه

دا پاڼه د `commands` لپاره د عملياتي لارښود په توګه وکاروئ. دا د repository شواهد يا د پروژې ځانګړې لارښوونې نه بدلوي.
