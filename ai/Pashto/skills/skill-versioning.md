...
> سرچينه ژبه: انګليسي
> سرچينه فایل: ai/English/skills/skill-versioning.md
> که توپير وي، انګليسي فایل لومړيتوب لري.

دا پاڼه ښيي چې `skills/skill-versioning.md` په AI Agent Operating Manual کې څنګه ځای نيسي؛ د هغو خلکو او AI agents لپاره چې repository کار پلانوي، تاييدوي يا تکراروي.
