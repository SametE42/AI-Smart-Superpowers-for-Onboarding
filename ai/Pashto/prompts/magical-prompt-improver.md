...
> سرچينه ژبه: انګليسي
> سرچينه فایل: ai/English/prompts/magical-prompt-improver.md
> که توپير وي، انګليسي فایل لومړيتوب لري.

دا پاڼه ښيي چې `prompts/magical-prompt-improver.md` په AI Agent Operating Manual کې څنګه ځای نيسي؛ د هغو خلکو او AI agents لپاره چې repository کار پلانوي، تاييدوي يا تکراروي. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## عملي ساحه

دا پاڼه د `prompt improvement` لپاره د عملياتي لارښود په توګه وکاروئ. دا د repository شواهد يا د پروژې ځانګړې لارښوونې نه بدلوي.
