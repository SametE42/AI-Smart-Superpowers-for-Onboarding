...
> سرچينه ژبه: انګليسي
> سرچينه فایل: ai/English/templates/MODEL_PROFILE.md
> که توپير وي، انګليسي فایل لومړيتوب لري.

دا پاڼه ښيي چې `templates/MODEL_PROFILE.md` په AI Agent Operating Manual کې څنګه ځای نيسي؛ د هغو خلکو او AI agents لپاره چې repository کار پلانوي، تاييدوي يا تکراروي.
