...
> මූලාශ්‍ර ගොනුව: ai/English/tools/claude-code/context-files.md
> වෙනසක් තිබේ නම් ඉංග්‍රීසි ගොනුව ප්‍රමුඛ වේ.

මෙම පිටුව `tools/claude-code/context-files.md` AI Agent Operating Manual තුළ කෙසේ ගැළපෙන්නේද යන්න පැහැදිලි කරයි; repository වැඩ සැලසුම් කරන, සත්‍යාපනය කරන හෝ නැවත කරන පුද්ගලයින් සහ AI agents සඳහායි.

## ප්‍රායෝගික විෂය පථය

මෙම පිටුව `tools` සඳහා මෙහෙයුම් මාර්ගෝපදේශයක් ලෙස භාවිත කරන්න. මෙය repository සාක්ෂි හෝ ව්‍යාපෘති උපදෙස් වෙනුවට නොවේ.
