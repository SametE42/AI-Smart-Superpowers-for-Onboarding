...
> මූලාශ්‍ර ගොනුව: ai/English/models/minimax/evals.md
> වෙනසක් තිබේ නම් ඉංග්‍රීසි ගොනුව ප්‍රමුඛ වේ.

මෙම පිටුව `models/minimax/evals.md` AI Agent Operating Manual තුළ කෙසේ ගැළපෙන්නේද යන්න පැහැදිලි කරයි; repository වැඩ සැලසුම් කරන, සත්‍යාපනය කරන හෝ නැවත කරන පුද්ගලයින් සහ AI agents සඳහායි.
