...
> Ifayela lomthombo: ai/English/models/minimax/prompts.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `models/minimax/prompts.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.
