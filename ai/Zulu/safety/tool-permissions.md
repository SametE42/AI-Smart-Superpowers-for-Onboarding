...
> Ifayela lomthombo: ai/English/safety/tool-permissions.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `safety/tool-permissions.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`safety`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
