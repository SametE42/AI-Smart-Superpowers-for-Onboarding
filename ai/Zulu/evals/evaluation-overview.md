...
> Ifayela lomthombo: ai/English/evals/evaluation-overview.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `evals/evaluation-overview.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`evals`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
