...
> Ifayela lomthombo: ai/English/memory/memory-consolidation.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `memory/memory-consolidation.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`memory`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
