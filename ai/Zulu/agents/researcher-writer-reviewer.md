...
> Ifayela lomthombo: ai/English/agents/researcher-writer-reviewer.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `agents/researcher-writer-reviewer.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`agents`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
