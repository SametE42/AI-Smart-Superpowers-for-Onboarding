...
> Ifayela lomthombo: ai/English/context-engineering/context-engineering-overview.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `context-engineering/context-engineering-overview.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`context-engineering`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
