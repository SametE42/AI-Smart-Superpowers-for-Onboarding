...
> Ifayela lomthombo: ai/English/skills/self-evolving-skills.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `skills/self-evolving-skills.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`skills`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
