...
> Ifayela lomthombo: ai/English/commands/model-specific-notes.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `commands/model-specific-notes.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`commands`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
