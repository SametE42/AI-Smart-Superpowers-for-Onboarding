...
> Ifayela lomthombo: ai/English/examples/gepa-optimization-example.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `examples/gepa-optimization-example.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`examples`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
