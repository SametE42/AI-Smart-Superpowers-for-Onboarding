...
> Ifayela lomthombo: ai/English/providers/moonshot-kimi.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `providers/moonshot-kimi.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`providers`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
