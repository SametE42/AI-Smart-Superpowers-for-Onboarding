...
> Ifayela lomthombo: ai/English/templates/WORKFLOW_TEMPLATE.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `templates/WORKFLOW_TEMPLATE.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`templates`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
