...
> Ifayela lomthombo: ai/English/optimization/evolutionary-optimization.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `optimization/evolutionary-optimization.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`optimization`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
