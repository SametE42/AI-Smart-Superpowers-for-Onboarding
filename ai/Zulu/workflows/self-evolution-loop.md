...
> Ifayela lomthombo: ai/English/workflows/self-evolution-loop.md
> Uma kunomehluko, ifayela lesiNgisi liyalandelwa.

Leli khasi lichaza ukuthi `workflows/self-evolution-loop.md` lingena kanjani ku-AI Agent Operating Manual kubantu nama-AI agents adinga ukuhlela, ukuqinisekisa noma ukuphinda umsebenzi we-repository.

## Ububanzi bokusebenza

Sebenzisa leli khasi njengomhlahlandlela wokusebenza we-`workflows`. Alithathi indawo yobufakazi be-repository noma imiyalelo yephrojekthi.
