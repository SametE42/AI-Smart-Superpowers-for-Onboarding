...
> Brontaal: Engels
> Bronbestand: ai/English/agents/human-in-the-loop.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `agents/human-in-the-loop.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
