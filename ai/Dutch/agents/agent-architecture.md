...
> Brontaal: Engels
> Bronbestand: ai/English/agents/agent-architecture.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `agents/agent-architecture.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
