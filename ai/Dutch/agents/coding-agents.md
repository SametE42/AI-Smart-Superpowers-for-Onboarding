...
> Brontaal: Engels
> Bronbestand: ai/English/agents/coding-agents.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `agents/coding-agents.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
