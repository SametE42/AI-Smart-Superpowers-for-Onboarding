...
> Brontaal: Engels
> Bronbestand: ai/English/templates/OPTIMIZATION_RUN.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `templates/OPTIMIZATION_RUN.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
