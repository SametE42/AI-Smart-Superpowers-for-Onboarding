...
> Brontaal: Engels
> Bronbestand: ai/English/templates/TOOL_PROFILE.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `templates/TOOL_PROFILE.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
