...
> Brontaal: Engels
> Bronbestand: ai/English/templates/WORKFLOW_TEMPLATE.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `templates/WORKFLOW_TEMPLATE.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.

## Praktische scope

Gebruik deze pagina als operationele leidraad voor het thema `templates`. Ze vervangt geen repositorybewijs en geen projectspecifieke instructies.
