...
> Brontaal: Engels
> Bronbestand: ai/English/tools/claude-code/models.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `tools/claude-code/models.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
