...
> Brontaal: Engels
> Bronbestand: ai/English/models/cohere/prompts.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `models/cohere/prompts.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
