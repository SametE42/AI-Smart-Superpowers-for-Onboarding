...
> Brontaal: Engels
> Bronbestand: ai/English/models/google-gemini/commands.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `models/google-gemini/commands.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.

## Praktische scope

Gebruik deze pagina als operationele leidraad voor het thema `models`. Ze vervangt geen repositorybewijs en geen projectspecifieke instructies.
