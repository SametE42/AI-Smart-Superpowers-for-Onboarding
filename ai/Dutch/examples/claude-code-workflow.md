...
> Brontaal: Engels
> Bronbestand: ai/English/examples/claude-code-workflow.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `examples/claude-code-workflow.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
