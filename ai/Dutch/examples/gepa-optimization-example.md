...
> Brontaal: Engels
> Bronbestand: ai/English/examples/gepa-optimization-example.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `examples/gepa-optimization-example.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.

## Praktische scope

Gebruik deze pagina als operationele leidraad voor het thema `examples`. Ze vervangt geen repositorybewijs en geen projectspecifieke instructies.
