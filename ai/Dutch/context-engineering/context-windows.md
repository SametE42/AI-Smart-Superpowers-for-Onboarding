...
> Brontaal: Engels
> Bronbestand: ai/English/context-engineering/context-windows.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `context-engineering/context-windows.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
