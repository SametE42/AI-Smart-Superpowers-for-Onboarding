...
> Brontaal: Engels
> Bronbestand: ai/English/context-engineering/context-engineering-overview.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `context-engineering/context-engineering-overview.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.

## Praktische scope

Gebruik deze pagina als operationele leidraad voor het thema `context-engineering`. Ze vervangt geen repositorybewijs en geen projectspecifieke instructies.
