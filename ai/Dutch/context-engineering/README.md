...
> Brontaal: Engels
> Bronbestand: ai/English/context-engineering/README.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `context-engineering/README.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
