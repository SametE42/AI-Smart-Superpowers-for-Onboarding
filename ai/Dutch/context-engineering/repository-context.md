...
> Brontaal: Engels
> Bronbestand: ai/English/context-engineering/repository-context.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `context-engineering/repository-context.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
