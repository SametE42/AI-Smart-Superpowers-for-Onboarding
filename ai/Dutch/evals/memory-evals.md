...
> Brontaal: Engels
> Bronbestand: ai/English/evals/memory-evals.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `evals/memory-evals.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
