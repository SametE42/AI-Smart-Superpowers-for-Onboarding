...
> Brontaal: Engels
> Bronbestand: ai/English/evals/tool-use-evals.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `evals/tool-use-evals.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.
