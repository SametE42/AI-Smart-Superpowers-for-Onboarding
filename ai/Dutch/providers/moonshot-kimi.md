...
> Brontaal: Engels
> Bronbestand: ai/English/providers/moonshot-kimi.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `providers/moonshot-kimi.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.

## Praktische scope

Gebruik deze pagina als operationele leidraad voor het thema `providers`. Ze vervangt geen repositorybewijs en geen projectspecifieke instructies.
