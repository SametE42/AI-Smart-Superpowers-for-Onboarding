...
> Brontaal: Engels
> Bronbestand: ai/English/skills/self-evolving-skills.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `skills/self-evolving-skills.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen.

## Praktische scope

Gebruik deze pagina als operationele leidraad voor het thema `skills`. Ze vervangt geen repositorybewijs en geen projectspecifieke instructies.
