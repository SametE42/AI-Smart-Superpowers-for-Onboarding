...
> Brontaal: Engels
> Bronbestand: ai/English/prompts/magical-prompt-improver.md
> Bij afwijkingen blijft het Engelse bestand leidend.

Deze pagina legt uit hoe `prompts/magical-prompt-improver.md` past binnen de AI Agent Operating Manual. Ze is geschreven voor mensen en AI-agenten die repositorywerk moeten plannen, controleren of herhalen. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktische scope

Gebruik deze pagina als operationele leidraad voor het thema `prompt improvement`. Ze vervangt geen repositorybewijs en geen projectspecifieke instructies.
