...
> Upprunamál: enska
> Upprunaskrá: ai/English/examples/codex-workflow.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `examples/codex-workflow.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
