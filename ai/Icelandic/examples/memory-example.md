...
> Upprunamál: enska
> Upprunaskrá: ai/English/examples/memory-example.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `examples/memory-example.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
