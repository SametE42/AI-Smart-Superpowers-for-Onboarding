...
> Upprunamál: enska
> Upprunaskrá: ai/English/examples/claude-code-workflow.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `examples/claude-code-workflow.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
