...
> Upprunamál: enska
> Upprunaskrá: ai/English/memory/warm-memory.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `memory/warm-memory.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
