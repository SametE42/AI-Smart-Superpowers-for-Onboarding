...
> Upprunamál: enska
> Upprunaskrá: ai/English/memory/procedural-memory.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `memory/procedural-memory.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
