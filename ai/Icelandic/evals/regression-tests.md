...
> Upprunamál: enska
> Upprunaskrá: ai/English/evals/regression-tests.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `evals/regression-tests.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
