...
> Upprunamál: enska
> Upprunaskrá: ai/English/workflows/self-evolution-loop.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `workflows/self-evolution-loop.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
