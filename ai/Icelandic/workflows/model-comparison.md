...
> Upprunamál: enska
> Upprunaskrá: ai/English/workflows/model-comparison.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `workflows/model-comparison.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
