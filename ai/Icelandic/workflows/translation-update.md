...
> Upprunamál: enska
> Upprunaskrá: ai/English/workflows/translation-update.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `workflows/translation-update.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
