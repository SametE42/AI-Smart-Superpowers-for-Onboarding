...
> Upprunamál: enska
> Upprunaskrá: ai/English/models/google-gemini/commands.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `models/google-gemini/commands.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.

## Hagnýtt umfang

Notaðu þessa síðu sem rekstrarleiðbeiningu fyrir `models`. Hún kemur ekki í stað repository-sönnunargagna eða verkefnaleiðbeininga.
