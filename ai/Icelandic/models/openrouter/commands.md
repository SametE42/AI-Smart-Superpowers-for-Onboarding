...
> Upprunamál: enska
> Upprunaskrá: ai/English/models/openrouter/commands.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `models/openrouter/commands.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
