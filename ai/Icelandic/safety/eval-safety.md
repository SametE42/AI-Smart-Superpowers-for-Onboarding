...
> Upprunamál: enska
> Upprunaskrá: ai/English/safety/eval-safety.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `safety/eval-safety.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
