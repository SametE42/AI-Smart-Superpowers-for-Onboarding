...
> Upprunamál: enska
> Upprunaskrá: ai/English/context-engineering/context-engineering-overview.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `context-engineering/context-engineering-overview.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.

## Hagnýtt umfang

Notaðu þessa síðu sem rekstrarleiðbeiningu fyrir `context-engineering`. Hún kemur ekki í stað repository-sönnunargagna eða verkefnaleiðbeininga.
