...
> Upprunamál: enska
> Upprunaskrá: ai/English/context-engineering/retrieval.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `context-engineering/retrieval.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
