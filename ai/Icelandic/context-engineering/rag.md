...
> Upprunamál: enska
> Upprunaskrá: ai/English/context-engineering/rag.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `context-engineering/rag.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
