...
> Upprunamál: enska
> Upprunaskrá: ai/English/optimization/optimization-overview.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `optimization/optimization-overview.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
