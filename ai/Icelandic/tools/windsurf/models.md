...
> Upprunamál: enska
> Upprunaskrá: ai/English/tools/windsurf/models.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `tools/windsurf/models.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
