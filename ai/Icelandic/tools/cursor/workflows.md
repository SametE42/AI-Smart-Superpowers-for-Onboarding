...
> Upprunamál: enska
> Upprunaskrá: ai/English/tools/cursor/workflows.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `tools/cursor/workflows.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
