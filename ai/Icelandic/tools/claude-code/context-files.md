...
> Upprunamál: enska
> Upprunaskrá: ai/English/tools/claude-code/context-files.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `tools/claude-code/context-files.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.

## Hagnýtt umfang

Notaðu þessa síðu sem rekstrarleiðbeiningu fyrir `tools`. Hún kemur ekki í stað repository-sönnunargagna eða verkefnaleiðbeininga.
