...
> Upprunamál: enska
> Upprunaskrá: ai/English/tools/opencode/workflows.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `tools/opencode/workflows.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
