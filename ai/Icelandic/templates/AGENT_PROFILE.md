...
> Upprunamál: enska
> Upprunaskrá: ai/English/templates/AGENT_PROFILE.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `templates/AGENT_PROFILE.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
