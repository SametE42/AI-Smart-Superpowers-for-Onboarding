...
> Upprunamál: enska
> Upprunaskrá: ai/English/prompts/prompt-refinement.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `prompts/prompt-refinement.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
