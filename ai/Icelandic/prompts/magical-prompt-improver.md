...
> Upprunamál: enska
> Upprunaskrá: ai/English/prompts/magical-prompt-improver.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `prompts/magical-prompt-improver.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Hagnýtt umfang

Notaðu þessa síðu sem rekstrarleiðbeiningu fyrir `prompt improvement`. Hún kemur ekki í stað repository-sönnunargagna eða verkefnaleiðbeininga.
