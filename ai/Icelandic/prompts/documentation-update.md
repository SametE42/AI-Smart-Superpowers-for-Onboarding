...
> Upprunamál: enska
> Upprunaskrá: ai/English/prompts/documentation-update.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `prompts/documentation-update.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.

## Hagnýtt umfang

Notaðu þessa síðu sem rekstrarleiðbeiningu fyrir `prompts`. Hún kemur ekki í stað repository-sönnunargagna eða verkefnaleiðbeininga.
