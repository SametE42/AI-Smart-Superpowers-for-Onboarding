...
> Upprunamál: enska
> Upprunaskrá: ai/English/prompts/master-prompt.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `prompts/master-prompt.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
