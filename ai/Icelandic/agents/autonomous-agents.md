...
> Upprunamál: enska
> Upprunaskrá: ai/English/agents/autonomous-agents.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `agents/autonomous-agents.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
