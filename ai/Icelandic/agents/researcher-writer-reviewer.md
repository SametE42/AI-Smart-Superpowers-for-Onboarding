...
> Upprunamál: enska
> Upprunaskrá: ai/English/agents/researcher-writer-reviewer.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `agents/researcher-writer-reviewer.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
