...
> Upprunamál: enska
> Upprunaskrá: ai/English/providers/xai-grok.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `providers/xai-grok.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
