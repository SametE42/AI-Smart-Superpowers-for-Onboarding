...
> Upprunamál: enska
> Upprunaskrá: ai/English/providers/moonshot-kimi.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `providers/moonshot-kimi.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.

## Hagnýtt umfang

Notaðu þessa síðu sem rekstrarleiðbeiningu fyrir `providers`. Hún kemur ekki í stað repository-sönnunargagna eða verkefnaleiðbeininga.
