...
> Upprunamál: enska
> Upprunaskrá: ai/English/skills/skill-lifecycle.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `skills/skill-lifecycle.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
