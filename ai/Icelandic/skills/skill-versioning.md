...
> Upprunamál: enska
> Upprunaskrá: ai/English/skills/skill-versioning.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `skills/skill-versioning.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.
