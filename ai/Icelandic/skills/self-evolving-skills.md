...
> Upprunamál: enska
> Upprunaskrá: ai/English/skills/self-evolving-skills.md
> Ef munur er til staðar gildir enska skráin.

Þessi síða útskýrir hvernig `skills/self-evolving-skills.md` fellur inn í AI Agent Operating Manual fyrir fólk og AI agents sem þurfa að skipuleggja, sannreyna eða endurtaka repository-vinnu.

## Hagnýtt umfang

Notaðu þessa síðu sem rekstrarleiðbeiningu fyrir `skills`. Hún kemur ekki í stað repository-sönnunargagna eða verkefnaleiðbeininga.
