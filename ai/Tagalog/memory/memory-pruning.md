...
> Pinagmulan na file: ai/English/memory/memory-pruning.md
> Kapag may pagkakaiba, ang English file ang susundin.

Ipinapaliwanag ng pahinang ito kung paano umaangkop ang `memory/memory-pruning.md` sa AI Agent Operating Manual. Para ito sa mga tao at AI agents na kailangang magplano, magberipika o umulit ng repository work.
