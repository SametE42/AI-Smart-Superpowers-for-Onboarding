...
> Pinagmulan na file: ai/English/agents/researcher-writer-reviewer.md
> Kapag may pagkakaiba, ang English file ang susundin.

Ipinapaliwanag ng pahinang ito kung paano umaangkop ang `agents/researcher-writer-reviewer.md` sa AI Agent Operating Manual. Para ito sa mga tao at AI agents na kailangang magplano, magberipika o umulit ng repository work.

## Praktikal na saklaw

Gamitin ang pahinang ito bilang operational na gabay para sa paksang `agents`. Hindi nito pinapalitan ang repository evidence o project-specific instructions.
