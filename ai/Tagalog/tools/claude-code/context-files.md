...
> Pinagmulan na file: ai/English/tools/claude-code/context-files.md
> Kapag may pagkakaiba, ang English file ang susundin.

Ipinapaliwanag ng pahinang ito kung paano umaangkop ang `tools/claude-code/context-files.md` sa AI Agent Operating Manual. Para ito sa mga tao at AI agents na kailangang magplano, magberipika o umulit ng repository work.

## Praktikal na saklaw

Gamitin ang pahinang ito bilang operational na gabay para sa paksang `tools`. Hindi nito pinapalitan ang repository evidence o project-specific instructions.
