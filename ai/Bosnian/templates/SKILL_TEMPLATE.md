...
> Izvorna datoteka: ai/English/templates/SKILL_TEMPLATE.md
> Ako postoje odstupanja, engleska datoteka ima prednost.

Ova stranica objašnjava kako se `templates/SKILL_TEMPLATE.md` uklapa u AI Agent Operating Manual. Namijenjena je ljudima i AI agentima koji trebaju planirati, provjeriti ili ponoviti rad u repositoryju.
