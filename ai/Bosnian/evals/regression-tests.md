...
> Izvorna datoteka: ai/English/evals/regression-tests.md
> Ako postoje odstupanja, engleska datoteka ima prednost.

Ova stranica objašnjava kako se `evals/regression-tests.md` uklapa u AI Agent Operating Manual. Namijenjena je ljudima i AI agentima koji trebaju planirati, provjeriti ili ponoviti rad u repositoryju.
