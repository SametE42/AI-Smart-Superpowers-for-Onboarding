...
> Izvorna datoteka: ai/English/commands/README.md
> Ako postoje odstupanja, engleska datoteka ima prednost.

Ova stranica objašnjava kako se `commands/README.md` uklapa u AI Agent Operating Manual. Namijenjena je ljudima i AI agentima koji trebaju planirati, provjeriti ili ponoviti rad u repositoryju.
