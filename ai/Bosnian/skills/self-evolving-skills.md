...
> Izvorna datoteka: ai/English/skills/self-evolving-skills.md
> Ako postoje odstupanja, engleska datoteka ima prednost.

Ova stranica objašnjava kako se `skills/self-evolving-skills.md` uklapa u AI Agent Operating Manual. Namijenjena je ljudima i AI agentima koji trebaju planirati, provjeriti ili ponoviti rad u repositoryju.

## Praktični opseg

Koristi ovu stranicu kao operativni vodič za temu `skills`. Ne zamjenjuje dokaze iz repositoryja niti projektne instrukcije.
