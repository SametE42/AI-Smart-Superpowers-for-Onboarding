...
> Izvorna datoteka: ai/English/memory/cold-memory.md
> Ako postoje odstupanja, engleska datoteka ima prednost.

Ova stranica objašnjava kako se `memory/cold-memory.md` uklapa u AI Agent Operating Manual. Namijenjena je ljudima i AI agentima koji trebaju planirati, provjeriti ili ponoviti rad u repositoryju.
