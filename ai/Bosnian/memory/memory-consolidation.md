...
> Izvorna datoteka: ai/English/memory/memory-consolidation.md
> Ako postoje odstupanja, engleska datoteka ima prednost.

Ova stranica objašnjava kako se `memory/memory-consolidation.md` uklapa u AI Agent Operating Manual. Namijenjena je ljudima i AI agentima koji trebaju planirati, provjeriti ili ponoviti rad u repositoryju.

## Praktični opseg

Koristi ovu stranicu kao operativni vodič za temu `memory`. Ne zamjenjuje dokaze iz repositoryja niti projektne instrukcije.
