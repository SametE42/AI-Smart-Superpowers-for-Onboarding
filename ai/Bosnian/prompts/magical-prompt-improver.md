...
Ova stranica objašnjava kako se `prompts/magical-prompt-improver.md` uklapa u AI Agent Operating Manual. Namijenjena je ljudima i AI agentima koji trebaju planirati, provjeriti ili ponoviti rad u repositoryju. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Praktični opseg

Koristi ovu stranicu kao operativni vodič za temu `prompt improvement`. Ne zamjenjuje dokaze iz repositoryja niti projektne instrukcije.
