...
> Jatorrizko fitxategia: ai/English/models/google-gemini/commands.md
> Aldeak badaude, ingelesezko fitxategiak du lehentasuna.

Orrialde honek azaltzen du `models/google-gemini/commands.md` nola sartzen den AI Agent Operating Manual barruan. Repository-lana planifikatu, egiaztatu edo errepikatu behar duten pertsonentzat eta AI agenteentzat idatzita dago.

## Eremu praktikoa

Erabili orrialde hau `models` gaiaren gida operatibo gisa. Ez du ordezkatzen repository-ko ebidentzia edo proiektuaren instrukzio espezifikoak.
