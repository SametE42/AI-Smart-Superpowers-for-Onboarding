...
> Jatorrizko fitxategia: ai/English/templates/WORKFLOW_TEMPLATE.md
> Aldeak badaude, ingelesezko fitxategiak du lehentasuna.

Orrialde honek azaltzen du `templates/WORKFLOW_TEMPLATE.md` nola sartzen den AI Agent Operating Manual barruan. Repository-lana planifikatu, egiaztatu edo errepikatu behar duten pertsonentzat eta AI agenteentzat idatzita dago.

## Eremu praktikoa

Erabili orrialde hau `templates` gaiaren gida operatibo gisa. Ez du ordezkatzen repository-ko ebidentzia edo proiektuaren instrukzio espezifikoak.
