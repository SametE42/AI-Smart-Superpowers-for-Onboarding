...
> ಮೂಲ ಭಾಷೆ: ಇಂಗ್ಲಿಷ್
> ಮೂಲ ಫೈಲ್: ai/English/models/grok/config.md
> ಭೇದವಿದ್ದರೆ ಇಂಗ್ಲಿಷ್ ಫೈಲ್‌ಗೆ ಆದ್ಯತೆ.

ಈ ಪುಟವು `models/grok/config.md` AI Agent Operating Manual ನಲ್ಲಿ ಹೇಗೆ ಹೊಂದುತ್ತದೆ ಎಂಬುದನ್ನು ವಿವರಿಸುತ್ತದೆ; repository ಕೆಲಸವನ್ನು ಯೋಜಿಸುವ, ಪರಿಶೀಲಿಸುವ ಅಥವಾ ಮರುಕಳಿಸುವ ಜನರು ಮತ್ತು AI agents ಗಾಗಿ.
