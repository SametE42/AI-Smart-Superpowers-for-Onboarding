...
> மூல மொழி: ஆங்கிலம்
> மூல கோப்பு: ai/English/workflows/memory-update.md
> வேறுபாடு இருந்தால் ஆங்கில கோப்பே முன்னுரிமை பெறும்.

இந்த பக்கம் `workflows/memory-update.md` AI Agent Operating Manual-இல் எப்படி பொருந்துகிறது என்பதை விளக்குகிறது; repository பணியை திட்டமிடும், சரிபார்க்கும் அல்லது மீண்டும் செய்யும் மனிதர்கள் மற்றும் AI agents க்காக.
