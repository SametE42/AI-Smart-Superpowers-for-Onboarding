...
> Изходен файл: ai/English/skills/self-evolving-skills.md
> При разминавания английският файл има предимство.

Тази страница обяснява как `skills/self-evolving-skills.md` се вписва в AI Agent Operating Manual. Тя е за хора и AI агенти, които трябва да планират, проверяват или повтарят работа в repository.

## Практически обхват

Използвайте тази страница като оперативно ръководство за темата `skills`. Тя не заменя доказателствата от repository или проектните инструкции.
