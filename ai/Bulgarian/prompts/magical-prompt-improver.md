...
> Изходен файл: ai/English/prompts/magical-prompt-improver.md
> При разминавания английският файл има предимство.

Тази страница обяснява как `prompts/magical-prompt-improver.md` се вписва в AI Agent Operating Manual. Тя е за хора и AI агенти, които трябва да планират, проверяват или повтарят работа в repository. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Практически обхват

Използвайте тази страница като оперативно ръководство за темата `prompt improvement`. Тя не заменя доказателствата от repository или проектните инструкции.
