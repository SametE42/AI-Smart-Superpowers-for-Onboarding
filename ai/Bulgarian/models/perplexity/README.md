...
> Изходен файл: ai/English/models/perplexity/README.md
> При разминавания английският файл има предимство.

Тази страница обяснява как `models/perplexity/README.md` се вписва в AI Agent Operating Manual. Тя е за хора и AI агенти, които трябва да планират, проверяват или повтарят работа в repository.
