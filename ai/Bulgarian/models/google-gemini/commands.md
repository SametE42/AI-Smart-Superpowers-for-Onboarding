...
> Изходен файл: ai/English/models/google-gemini/commands.md
> При разминавания английският файл има предимство.

Тази страница обяснява как `models/google-gemini/commands.md` се вписва в AI Agent Operating Manual. Тя е за хора и AI агенти, които трябва да планират, проверяват или повтарят работа в repository.

## Практически обхват

Използвайте тази страница като оперативно ръководство за темата `models`. Тя не заменя доказателствата от repository или проектните инструкции.
