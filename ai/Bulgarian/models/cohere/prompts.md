...
> Изходен файл: ai/English/models/cohere/prompts.md
> При разминавания английският файл има предимство.

Тази страница обяснява как `models/cohere/prompts.md` се вписва в AI Agent Operating Manual. Тя е за хора и AI агенти, които трябва да планират, проверяват или повтарят работа в repository.
