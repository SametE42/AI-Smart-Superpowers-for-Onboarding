...
> Изходен файл: ai/English/context-engineering/rag.md
> При разминавания английският файл има предимство.

Тази страница обяснява как `context-engineering/rag.md` се вписва в AI Agent Operating Manual. Тя е за хора и AI агенти, които трябва да планират, проверяват или повтарят работа в repository.
