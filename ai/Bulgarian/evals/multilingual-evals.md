...
> Изходен файл: ai/English/evals/multilingual-evals.md
> При разминавания английският файл има предимство.

Тази страница обяснява как `evals/multilingual-evals.md` се вписва в AI Agent Operating Manual. Тя е за хора и AI агенти, които трябва да планират, проверяват или повтарят работа в repository.
