...
> Idioma font: anglès
> Fitxer font: ai/English/memory/episodic-memory.md
> Si hi ha diferències, el fitxer en anglès té prioritat.

Aquesta pàgina explica com `memory/episodic-memory.md` encaixa dins de l'AI Agent Operating Manual. Està escrita per a persones i agents d'IA que han de planificar, verificar o repetir feina de repositori.
