...
> Idioma font: anglès
> Fitxer font: ai/English/tools/claude-code/context-files.md
> Si hi ha diferències, el fitxer en anglès té prioritat.

Aquesta pàgina explica com `tools/claude-code/context-files.md` encaixa dins de l'AI Agent Operating Manual. Està escrita per a persones i agents d'IA que han de planificar, verificar o repetir feina de repositori.

## Abast pràctic

Fes servir aquesta pàgina com a guia operativa per al tema `tools`. No substitueix l'evidència del repositori ni les instruccions específiques del projecte.
