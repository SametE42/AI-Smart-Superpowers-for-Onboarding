...
> Idioma font: anglès
> Fitxer font: ai/English/tools/cursor/workflows.md
> Si hi ha diferències, el fitxer en anglès té prioritat.

Aquesta pàgina explica com `tools/cursor/workflows.md` encaixa dins de l'AI Agent Operating Manual. Està escrita per a persones i agents d'IA que han de planificar, verificar o repetir feina de repositori.
