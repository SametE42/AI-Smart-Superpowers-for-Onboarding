...
> Idioma font: anglès
> Fitxer font: ai/English/context-engineering/context-engineering-overview.md
> Si hi ha diferències, el fitxer en anglès té prioritat.

Aquesta pàgina explica com `context-engineering/context-engineering-overview.md` encaixa dins de l'AI Agent Operating Manual. Està escrita per a persones i agents d'IA que han de planificar, verificar o repetir feina de repositori.

## Abast pràctic

Fes servir aquesta pàgina com a guia operativa per al tema `context-engineering`. No substitueix l'evidència del repositori ni les instruccions específiques del projecte.
