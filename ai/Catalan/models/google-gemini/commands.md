...
> Idioma font: anglès
> Fitxer font: ai/English/models/google-gemini/commands.md
> Si hi ha diferències, el fitxer en anglès té prioritat.

Aquesta pàgina explica com `models/google-gemini/commands.md` encaixa dins de l'AI Agent Operating Manual. Està escrita per a persones i agents d'IA que han de planificar, verificar o repetir feina de repositori.

## Abast pràctic

Fes servir aquesta pàgina com a guia operativa per al tema `models`. No substitueix l'evidència del repositori ni les instruccions específiques del projecte.
