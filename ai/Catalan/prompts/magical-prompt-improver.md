...
> Idioma font: anglès
> Fitxer font: ai/English/prompts/magical-prompt-improver.md
> Si hi ha diferències, el fitxer en anglès té prioritat.

Aquesta pàgina explica com `prompts/magical-prompt-improver.md` encaixa dins de l'AI Agent Operating Manual. Està escrita per a persones i agents d'IA que han de planificar, verificar o repetir feina de repositori. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Abast pràctic

Fes servir aquesta pàgina com a guia operativa per al tema `prompt improvement`. No substitueix l'evidència del repositori ni les instruccions específiques del projecte.
