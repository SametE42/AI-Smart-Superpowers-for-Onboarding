...
> Idioma font: anglès
> Fitxer font: ai/English/agents/autonomous-agents.md
> Si hi ha diferències, el fitxer en anglès té prioritat.

Aquesta pàgina explica com `agents/autonomous-agents.md` encaixa dins de l'AI Agent Operating Manual. Està escrita per a persones i agents d'IA que han de planificar, verificar o repetir feina de repositori.
