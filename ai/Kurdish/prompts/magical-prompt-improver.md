...
> Pelê çavkanî: ai/English/prompts/magical-prompt-improver.md
> Ger cudahî hebe, pelê Îngilîzî serdest e.

Ev rûpel diyar dike ku `prompts/magical-prompt-improver.md` çawa di AI Agent Operating Manual de cih digire, ji bo mirov û AI agents ku karê repository plan dikin, rastdikin an dubare dikin. Source protocol: [`templates/optional/MAGICAL_PROMPT_IMPROVER.md`](../../../templates/optional/MAGICAL_PROMPT_IMPROVER.md).

## Qada pratîkî

Vê rûpelê wek rêbernameya karî ji bo `prompt improvement` bi kar bîne. Ew delîlên repository an rêwerzên projeyê naguhere.
