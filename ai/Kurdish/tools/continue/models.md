...
> Pelê çavkanî: ai/English/tools/continue/models.md
> Ger cudahî hebe, pelê Îngilîzî serdest e.

Ev rûpel diyar dike ku `tools/continue/models.md` çawa di AI Agent Operating Manual de cih digire, ji bo mirov û AI agents ku karê repository plan dikin, rastdikin an dubare dikin.
