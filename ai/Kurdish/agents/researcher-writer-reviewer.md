...
> Pelê çavkanî: ai/English/agents/researcher-writer-reviewer.md
> Ger cudahî hebe, pelê Îngilîzî serdest e.

Ev rûpel diyar dike ku `agents/researcher-writer-reviewer.md` çawa di AI Agent Operating Manual de cih digire, ji bo mirov û AI agents ku karê repository plan dikin, rastdikin an dubare dikin.

## Qada pratîkî

Vê rûpelê wek rêbernameya karî ji bo `agents` bi kar bîne. Ew delîlên repository an rêwerzên projeyê naguhere.
