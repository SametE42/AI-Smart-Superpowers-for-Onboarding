...
> Pelê çavkanî: ai/English/safety/prompt-injection.md
> Ger cudahî hebe, pelê Îngilîzî serdest e.

Ev rûpel diyar dike ku `safety/prompt-injection.md` çawa di AI Agent Operating Manual de cih digire, ji bo mirov û AI agents ku karê repository plan dikin, rastdikin an dubare dikin.

## Qada pratîkî

Vê rûpelê wek rêbernameya karî ji bo `safety` bi kar bîne. Ew delîlên repository an rêwerzên projeyê naguhere.
