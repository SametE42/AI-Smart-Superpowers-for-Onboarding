...
> Pelê çavkanî: ai/English/memory/memory-consolidation.md
> Ger cudahî hebe, pelê Îngilîzî serdest e.

Ev rûpel diyar dike ku `memory/memory-consolidation.md` çawa di AI Agent Operating Manual de cih digire, ji bo mirov û AI agents ku karê repository plan dikin, rastdikin an dubare dikin.

## Qada pratîkî

Vê rûpelê wek rêbernameya karî ji bo `memory` bi kar bîne. Ew delîlên repository an rêwerzên projeyê naguhere.
